      ...
      <div className={navOpen ? "" : "hide-nav"}>
          ...
          <ul className="nav__list">
            <li>
              ...
              <ul className="nav__list">
                ...
                <li>
                  <ActiveLink href="/app-deploy/nodejs/browser">
                    استقرار با مرورگر
                  </ActiveLink>
                </li>
                <li>
            ...
            <li>
              ...
              <ul className="nav__list">
                ...
                <li>
                  <ActiveLink href="/app-deploy/nextjs/browser">
                    استقرار با مرورگر
                  </ActiveLink>
                </li>
                <li>
            ...
            <li>
              ...
              <ul className="nav__list">
                ...
                <li>
                  <ActiveLink href="/app-deploy/laravel/browser">
                    استقرار با مرورگر
                  </ActiveLink>
                </li>
                <li>
            ...
            <li>
              ...
              <ul className="nav__list">
                ...
                <li>
                  <ActiveLink href="/app-deploy/php/browser">
                    استقرار با مرورگر
                  </ActiveLink>
                </li>
                <li>
            ...
            <li>
              ...
              <ul className="nav__list">
                ...
                <li>
                  <ActiveLink href="/app-deploy/flask/browser">
                    استقرار با مرورگر
                  </ActiveLink>
                </li>
                <li>
            ...
            <li>
              ...
              <ul className="nav__list">
                ...
                <li>
                  <ActiveLink href="/app-deploy/react/browser">
                    استقرار با مرورگر
                  </ActiveLink>
                </li>
                <li>
            ...
            <li>
              ...
              <ul className="nav__list">
                ...
                <li>
                  <ActiveLink href="/app-deploy/static/browser">
                    استقرار با مرورگر
                  </ActiveLink>
                </li>
                <li>
            ...
            <li>
              ...
              <ul className="nav__list">
                ...
                <li>
                  <ActiveLink href="/app-deploy/docker/browser">
                    استقرار با مرورگر
                  </ActiveLink>
                </li>
                <li>
            ...
            <li>
              ...
              <ul className="nav__list">
                ...
                <li>
                  <ActiveLink href="/app-deploy/golang/browser">
                    استقرار با مرورگر
                  </ActiveLink>
                </li>
                <li>
        ...
        <nav className="nav">
          ...
          <ul className="nav__list">
            ...
            <li>
              <ActiveLink href="/instructions/drizzle">
