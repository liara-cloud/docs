Original link: https://docs.liara.ir/ai/openai/

# شروع به کار با هوش مصنوعی OpenAI

هوش مصنوعی [OpenAI](https://openai.com) مجموعه‌ای از مدل‌های پیشرفته است که برای درک و تولید زبان طبیعی، حل مسائل پیچیده، و تعامل انسانی طراحی شده‌است.  
این فناوری با مدل‌ GPT توانسته در حوزه‌هایی مانند تولید محتوا، برنامه‌نویسی، تحلیل داده و ... نقش مؤثری ایفا کند.
