Original link: https://docs.liara.ir/ai/deepseek/

# شروع به کار با هوش مصنوعی DeepSeek

[DeepSeek](https://www.deepseek.com) یک مدل هوش مصنوعی پیشرفته است که توسط تیمی در چین توسعه یافته و به‌عنوان یکی از رقبای جدی مدل‌های زبانی بزرگ مانند GPT و Gemini شناخته می‌شود. این مدل تمرکز ویژه‌ای بر توانایی درک و تولید کدهای برنامه‌نویسی، تحلیل متن و پاسخ‌گویی دقیق به سوالات دارد.

در حال حاضر، لیارا، مدل‌های زیر از DeepSeek را در API خود پشتیبانی می‌کند:

- مدل `{item}`

پس از [ایجاد سرویس هوش مصنوعی](https://docs.liara.ir/ai/quick-start) و دریافت `baseUrl` و [ساخت کلید](https://docs.liara.ir/ai/details/keys/#create)، می‌توانید از مدل‌های DeepSeek استفاده کنید.
