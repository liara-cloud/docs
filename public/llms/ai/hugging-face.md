Original link: https://docs.liara.ir/ai/hugging-face/

# شروع به کار با مدل‌های موجود در Hugging Face

[Hugging Face](https://huggingface.co) یکی از شناخته‌شده‌ترین پلتفرم‌های متن‌باز در حوزه هوش مصنوعی است که بستری برای توسعه، اشتراک‌گذاری و استفاده از مدل‌های مختلف را فراهم می‌کند.  
این پلتفرم هزاران مدل، دیتاست و ابزار متن‌باز ارائه می‌دهد.

در حال حاضر، لیارا، مدل‌های زیر از مدل‌های موجود در Hugging Face را در API خود پشتیبانی می‌کند:

- مدل `{item}`
  

پس از [ایجاد سرویس هوش مصنوعی](https://docs.liara.ir/ai/quick-start) و دریافت `baseUrl` و [ساخت کلید](https://docs.liara.ir/ai/details/keys/#create)، می‌توانید از مدل‌های Hugging Face استفاده کنید.
