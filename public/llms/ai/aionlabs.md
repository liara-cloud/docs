Original link: https://docs.liara.ir/ai/aionlabs/

# شروع به کار با هوش مصنوعی AION Labs

[AION Labs](https://aionlabs.ai) پلتفرمی است که مدل‌های زبانی آماده برای استفاده در کاربردهای عملی و سازمانی ارائه می‌دهد. 

در حال حاضر، لیارا، مدل‌های زیر از AION Labs را در API خود پشتیبانی می‌کند:

- مدل `{item}`

پس از [ایجاد سرویس هوش مصنوعی](https://docs.liara.ir/ai/quick-start) و دریافت `baseUrl` و [ساخت کلید](https://docs.liara.ir/ai/details/keys/#create)، می‌توانید از مدل‌های aion-labs استفاده کنید.
...
```bash
curl https://docs.liara.ir/ai/chat/completions \
