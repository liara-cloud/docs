Original link: https://docs.liara.ir/ai/anthropic-claude/

# شروع به کار با هوش مصنوعی Claude

مدل [Claude](https://claude.ai/)  توسط شرکت Anthropic توسعه یافته که توسط تعدادی از اعضای پیشین OpenAI تأسیس شده است. Claude با هدف ایمنی، اخلاق‌مداری و تعامل طبیعی با کاربران طراحی شده و رقیبی جدی برای مدل‌هایی مانند GPT و Gemini به شمار می‌رود. این مدل بر پایه فلسفه "قابلیت کنترل" توسعه یافته است، به این معنا که رفتار مدل با دقت بیشتری قابل هدایت و پیش‌بینی است. Claude در نسخه‌های مختلفی منتشر شده و به دلیل تمرکز ویژه بر ایمنی، در محیط‌های حساس و سازمانی نیز مورد توجه قرار گرفته است.

در حال حاضر، لیارا، مدل‌های زیر از Claude را در API خود پشتیبانی می‌کند:

- مدل `{item}`

پس از [ایجاد سرویس هوش مصنوعی](https://docs.liara.ir/ai/quick-start) و دریافت `baseUrl` و [ساخت کلید](https://docs.liara.ir/ai/details/keys/#create)، می‌توانید از مدل‌های Claude استفاده کنید.
