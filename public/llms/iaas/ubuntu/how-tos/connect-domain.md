Original link: https://docs.liara.ir/iaas/ubuntu/how-tos/connect-domain/
...
پس از [اتصال به سرور مجازی ابری خود با استفاده از SSH](https://docs.liara.ir/iaas/ubuntu/how-tos/connect-to-server-using-ssh)، کافیست تا با اجرای دستور زیر، Apache را بر روی سرور خود، نصب کنید:
