Original link: https://docs.liara.ir/wordpress/fix-common-errors/too-many-redirects-error/
...
برای رفع این خطا، در برنامه وردپرسی خود، یک [دسترسی FTPS](https://docs.liara.ir/wordpress/how-tos/create-ftps-access/) ایجاد کنید. با این دسترسی وارد فایلی به نام `wp-config.php` شده و قطعه کد زیر را، به آن، اضافه کنید:
