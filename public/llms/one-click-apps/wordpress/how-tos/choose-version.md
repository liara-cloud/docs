Original link: https://docs.liara.ir/one-click-apps/wordpress/how-tos/choose-version/

# تغییر نسخه‌ی برنامه مستقر شده

[Video link](https://media.liara.ir/docs/change-wordpress-version.mp4)
...
```json
{
    "image": "liararepo/wordpress-one-click-app:<your-version>",
    "port": 80,
    "app": "<your-app-name>",
    "disks": [
        {
...
> برای مشاهده نسخه‌های قابل ارائه WordPress و PHP به [https://hub.docker.com/r/liararepo/wordpress-one-click-app/tags?page=&page_size=&name=&ordering=last_updated](https://hub.docker.com/r/liararepo/wordpress-one-click-app/tags?page=&page_size=&name=&ordering=last_updated) مراجعه کنید.
