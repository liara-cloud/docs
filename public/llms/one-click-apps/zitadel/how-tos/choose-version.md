Original link: https://docs.liara.ir/one-click-apps/zitadel/how-tos/choose-version/
...
```json
{
    "image": "ghcr.io/zitadel/zitadel:<your-version>",
    "port": 8080,
    "app": "<your-app-name>",
    "args": [
      "start-from-init",
...
> برای مشاهده تمامی تگ‌های موجود، می‌توانید به [Github Container Registey (ghcr) رسمی برنامه](https://github.com/zitadel/zitadel/pkgs/container/zitadel)، مراجعه کنید.  
> برای اطلاعات بیشتر مربوط به پیکربندی برنامه و اطلاع از متغیرهای محیطی آن، می‌توانید به [مستندات رسمی برنامه](https://zitadel.com/docs/self-hosting/deploy/compose)، مراجعه کنید.
