Original link: https://docs.liara.ir/one-click-apps/openwebui/how-tos/choose-version/
...
```json
{
    "image": "ghcr.io/open-webui/open-webui:<your-version>",
    "port": 8080,
    "app": "<your-app-name>",
    "disks": [
      {
        "name": "data",
        "mountTo": "/app/backend/data"
      }
  ]
}
```

در قطعه کد فوق، بایستی به جای عبارت `{"<your-version>"}` ورژن موردنظر برنامه‌تان را وارد کنید. همچنین باید به جای عبارت `{"<your-app-name>"}` نیز، شناسه برنامه خود را قرار دهید.
