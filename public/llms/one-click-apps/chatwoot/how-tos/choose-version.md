Original link: https://docs.liara.ir/one-click-apps/chatwoot/how-tos/choose-version/
...
> برای مشاهده تمامی تگ‌های موجود، می‌توانید به [داکرهاب رسمی برنامه](https://hub.docker.com/r/chatwoot/chatwoot/tags)، مراجعه کنید.  
> برای اطلاعات بیشتر مربوط به پیکربندی برنامه و اطلاع از متغیرهای محیطی آن، می‌توانید به [مستندات رسمی برنامه](https://www.chatwoot.com/docs/self-hosted/deployment/docker)، مراجعه کنید.
