Original link: https://docs.liara.ir/one-click-apps/supertokens/how-tos/choose-version/
...
```json
{
    "image": "registry.supertokens.io/supertokens/supertokens-mysql:<your-version>",
    "app": "<your-app-name>",
    "port": "3567"
}
```
...
ورژن موردنظر برنامه‌تان را وارد کنید. همچنین باید به جای عبارت  
`{"<your-app-name>"}` نیز،  
