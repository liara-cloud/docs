Original link: https://docs.liara.ir/one-click-apps/wikijs/how-tos/choose-version/
...
```json
{
    "image": "ghcr.io/requarks/wiki:<your-version>",
    "port": 3000,
    "app": "<your-app-name>",
    "disks": [
      {
...
> برای مشاهده تمامی تگ‌های موجود، می‌توانید به [داکرهاب رسمی برنامه](https://github.com/requarks/wiki/pkgs/container/wiki)، مراجعه کنید.  
> برای اطلاعات بیشتر مربوط به پیکربندی برنامه و اطلاع از متغیرهای محیطی آن، می‌توانید به [مستندات رسمی برنامه](https://docs.requarks.io/)، مراجعه کنید.
