Original link: https://docs.liara.ir/one-click-apps/jupyter-notebook/how-tos/choose-version/
...
```json
{
    "image": "quay.io/jupyter/datascience-notebook:<your-version>",
    "app": "<your-app-name>",
    "port": 8888, 
    "disks": [
        {
            "name": "data",
            "mountTo": "/home/jovyan/work"
        }
    ]
}
```
