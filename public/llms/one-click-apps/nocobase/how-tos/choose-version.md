Original link: https://docs.liara.ir/one-click-apps/nocobase/how-tos/choose-version/
...
```json
{
    "image": "nocobase/nocobase:<your-version>",
    "port": 13000,
    "app": "<your-app-name>",
    "disks": [
      {
...
> برای اطلاعات بیشتر مربوط به پیکربندی برنامه و اطلاع از متغیرهای محیطی آن، می‌توانید به [مستندات رسمی برنامه](https://docs.nocobase.com/welcome/introduction)، مراجعه کنید.
