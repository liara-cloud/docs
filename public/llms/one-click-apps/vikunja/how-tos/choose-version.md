Original link: https://docs.liara.ir/one-click-apps/vikunja/how-tos/choose-version/
...
```json
{
    "image": "vikunja/vikunja:<your-version>",
    "port": 3456,
    "app": "<your-app-name>",
    "disks": [
      {
...
> برای مشاهده تمامی تگ‌های موجود، می‌توانید به [داکرهاب رسمی برنامه](https://hub.docker.com/r/vikunja/vikunja/tags)، مراجعه کنید.  
> برای اطلاعات بیشتر مربوط به پیکربندی برنامه و اطلاع از متغیرهای محیطی آن، می‌توانید به [مستندات رسمی برنامه](https://vikunja.io/docs/docker-walkthrough)، مراجعه کنید.
