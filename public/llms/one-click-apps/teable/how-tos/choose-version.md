Original link: https://docs.liara.ir/one-click-apps/teable/how-tos/choose-version/
...
```json
{
    "image": "ghcr.io/teableio/teable:<your-version>",
    "port": 3000,
    "app": "<your-app-name>",
    "disks": [
      {
...
> برای مشاهده تمامی تگ‌های موجود، می‌توانید به [Github Container Registey (ghcr) رسمی برنامه](https://github.com/teableio/teable/pkgs/container/teable)، مراجعه کنید.  
> برای اطلاعات بیشتر مربوط به پیکربندی برنامه و اطلاع از متغیرهای محیطی آن، می‌توانید به [مستندات رسمی برنامه](https://help.teable.io/deployment/environment-variables)، مراجعه کنید.
