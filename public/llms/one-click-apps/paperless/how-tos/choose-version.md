Original link: https://docs.liara.ir/one-click-apps/paperless/how-tos/choose-version/
...
```json
{
    "image": "paperless-ngx:<your-version>",
    "port": 8000,
    "app": "<your-app-name>",
    "disks": [
      {
...
ورژن موردنظر برنامه‌تان را وارد کنید. همچنین باید به جای عبارت `{"<your-app-name>"}` نیز، شناسه برنامه خود را قرار دهید.
