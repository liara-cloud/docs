Original link: https://docs.liara.ir/one-click-apps/postiz/how-tos/choose-version/
...
```json
{
    "image": "ghcr.io/gitroomhq/postiz-app:<your-version>",
    "port": 5000,
    "app": "<your-app-name>",
    "disks": [
      {
...
> برای مشاهده تمامی تگ‌های موجود، می‌توانید به [ghcr رسمی برنامه](https://github.com/gitroomhq/postiz-app/pkgs/container/postiz-app)، مراجعه کنید.  
> برای اطلاعات بیشتر مربوط به پیکربندی برنامه و اطلاع از متغیرهای محیطی آن، می‌توانید به [مستندات رسمی برنامه](https://docs.postiz.com/installation/docker-compose)، مراجعه کنید.
