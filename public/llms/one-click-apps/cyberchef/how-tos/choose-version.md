Original link: https://docs.liara.ir/one-click-apps/cyberchef/how-tos/choose-version/
...
اگر که قصد دارید نسخه برنامه خود را بنا به هر دلیلی تغییر دهید؛ کافیست تا پس از [ساخت برنامه در لیارا](../../quick-start)، در Local یک دایرکتوری با نام دلخواه ایجاد کنید.  
...
```json
{
    "image": "ghcr.io/gchq/cyberchef:<your-version>",
    "port": 80,
    "app": "<your-app-name>"
}
```
...
> برای مشاهده تمامی تگ‌های موجود، می‌توانید به [ghcr رسمی برنامه](https://github.com/gchq/CyberChef/pkgs/container/cyberchef/versions?filters%5Bversion_type%5D=tagged)، مراجعه کنید.  
> برای اطلاعات بیشتر مربوط به پیکربندی برنامه و اطلاع از متغیرهای محیطی آن، می‌توانید به [مستندات رسمی برنامه](https://github.com/gchq/CyberChef?tab=readme-ov-file#cyberchef)، مراجعه کنید.
