Original link: https://docs.liara.ir/dbaas/mysql/how-tos/connect-via-platform/php/

# اتصال به دیتابیس MySQL در برنامه‌های PHP

برای اتصال به دیتابیس MySQL، در ابتدا باید اکستنشن `mysqli` را در PHP نصب کنید. پس از آن، کافیست تا  
