Original link: https://docs.liara.ir/dbaas/mysql/how-tos/connect-via-platform/laravel/

# اتصال به دیتابیس MySQL در برنامه‌های Laravel

برای اتصال به دیتابیس MySQL نیاز به انجام کار خاصی نیست. فقط کافیست تا اطلاعات مربوط به دیتابیس خود را به متغیرهای محیطی برنامه خود، اضافه کنید؛ به عنوان مثال:
