Original link: https://docs.liara.ir/dbaas/mssql/how-tos/connect-via-platform/dotnet/
...
> یک پروژه نمونه در [اینجا](https://github.com/liara-cloud/dotnet-getting-started/tree/ef-core) وجود دارد که می‌توانید از آن، استفاده کنید.
