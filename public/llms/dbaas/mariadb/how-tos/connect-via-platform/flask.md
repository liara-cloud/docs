Original link: https://docs.liara.ir/dbaas/mariadb/how-tos/connect-via-platform/flask/

# اتصال به دیتابیس MariaDB در برنامه‌های Flask

برای اتصال به دیتابیس MariaDB در برنامه‌های Flask، در ابتدا باید ماژول مربوط به آن‌را با اجرای دستور زیر، نصب کنید:
