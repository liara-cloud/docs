Original link: https://docs.liara.ir/dbaas/mariadb/how-tos/connect-via-platform/nodejs/

# اتصال به دیتابیس MariaDB در برنامه‌های NodeJS

روش‌ها و کتابخانه‌های مختلفی برای اتصال به MariaDB در NodeJS وجود دارد. یکی از این راه‌ها، استفاده از پکیج `mysql` است که در ابتدا، با اجرای دستور زیر، باید آن را نصب کنید:
...
برای فعال‌سازی قابلیت Connection Pooling در دیتابیس MariaDB کافیست تا پکیج `mysql2` را با استفاده از دستور زیر در پروژه خود نصب کنید:
