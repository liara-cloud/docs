Original link: https://docs.liara.ir/dbaas/mariadb/how-tos/connect-via-platform/php/

# اتصال به دیتابیس MariaDB در برنامه‌های PHP
...
اکنون، می‌توانید با استفاده از قطعه کد زیر به دیتابیس MariaDB خود متصل شوید:
...
برای استفاده از قابلیت connection pooling در دیتابیس MariaDB، می‌توانید مانند قطعه کد زیر، از اکستنشن `PDO` استفاده کنید:
