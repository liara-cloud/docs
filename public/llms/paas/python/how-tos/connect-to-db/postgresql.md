Original link: https://docs.liara.ir/paas/python/how-tos/connect-to-db/postgresql/

# اتصال به دیتابیس PostgreSQL در برنامه‌های Python

[Video link](https://media.liara.ir/python/python-postgres.mp4)
...
در ادامه، بایستی طبق مستندات [https://docs.liara.ir/paas/details/envs](https://docs.liara.ir/paas/details/envs)، متغیرهای محیطی مربوط به دیتابیس را، به برنامه اضافه کنید؛ به عنوان مثال: 
...
> همچنین بخوانید: [https://docs.liara.ir/dbaas/details/connection-pool](https://docs.liara.ir/dbaas/details/connection-pool)
