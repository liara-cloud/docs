Original link: https://docs.liara.ir/paas/angular/quick-start/
...
> پلتفرم Angular لیارا از SSR پشتیبانی نمی‌کند و شما تنها قادر خواهید بود که پروژه‌های CSR خود را مستقر کنید.  
> برای استقرار پروژه‌های SSR می‌توانید از [پلتفرم NodeJS](https://docs.liara.ir/paas/nodejs/getting-started/)، استفاده کنید.

## Liara Console

[Video link](https://media.liara.ir/angular/angular-desktop.mp4)
...
۳. ایجاد برنامه  
برنامه Angular خود را با شناسه، [شبکه خصوصی](../details/private-network) و [منابع سخت‌افزاری و بسته امکانات](../details/plans/about) مدنظرتان ایجاد کنید.
...
۵. بررسی فایل `package.json` استاندارد  
در نظر داشته باشید که در پروژه‌های استاندارد Angular، یک فایل به نام `package.json` وجود دارد که برای استقرار حائز اهمیت است و این فایل نباید حذف یا دستکاری شود.  
...
[Video link](https://media.liara.ir/angular/angular-cli.mp4)
...
۴. ایجاد برنامه  
با اجرای دستور زیر، برنامه Angular خود را ایجاد کنید:
...
در ادامه اجرای این دستور، باید به ترتیب، شناسه، نوع پلتفرم (که باید بر روی angular تنظیم شود)، شبکه خصوصی و [منابع سخت‌افزاری و بسته امکانات برنامه](../details/plans/about)، مشخص شوند.
...
۶. بررسی فایل `package.json` استاندارد  
در نظر داشته باشید که در پروژه‌های استاندارد Angular، یک فایل به نام `package.json` وجود دارد که برای استقرار حائز اهمیت است و این فایل نباید حذف یا دستکاری شود.  
قطعه کد زیر یک نمونه استاندارد از فایل `package.json` است:    
...
```bash
liara deploy --app=myapp --platform=angular
```
...
```bash
liara deploy --app=myapp --platform=angular --team-id=your-unique-team-id
```

## Github

[Video link](https://media.liara.ir/docs/angular-github.mp4)
