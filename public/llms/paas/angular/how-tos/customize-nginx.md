Original link: https://docs.liara.ir/paas/angular/how-tos/customize-nginx/

# تنظیم Nginx در برنامه‌های Angular
...
در برنامه‌های Angular لیارا، از وب‌سرور Nginx استفاده می‌شود و پیکربندی پیش‌فرض این وب‌سرور به‌شکل زیر است:
