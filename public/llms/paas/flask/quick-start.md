Original link: https://docs.liara.ir/paas/flask/quick-start/

# استقرار سریع برنامه‌های Flask

## Liara Console

[Video link](https://media.liara.ir/flask/flask-desktop.mp4)
...
۳. ایجاد برنامه  
برنامه Flask خود را با شناسه، [شبکه خصوصی](../details/private-network) و [منابع سخت‌افزاری و بسته امکانات](../details/plans/about) مدنظرتان ایجاد کنید.
...
[Video link](https://media.liara.ir/flask/flask-cli.mp4)
...
۴. ایجاد برنامه  
با اجرای دستور زیر، برنامه Flask خود را ایجاد کنید:
```bash
liara create
```

> اگر که از قبل برنامه خود را ایجاد کرده‌اید؛ نیازی به انجام این کار نیست.  
در ادامه اجرای این دستور، باید به ترتیب، شناسه، نوع پلتفرم (که باید بر روی flask تنظیم شود)، شبکه خصوصی و [منابع سخت‌افزاری و بسته امکانات برنامه](../details/plans/about)، مشخص شوند.
...
[Video link](https://media.liara.ir/docs/flask-github.mp4)
...
> همچنین بخوانید: [استقرار قدم به قدم برنامه‌های Flask در لیارا](./how-tos/create-app)
