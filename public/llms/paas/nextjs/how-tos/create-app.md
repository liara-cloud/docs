Original link: https://docs.liara.ir/paas/nextjs/how-tos/create-app/

# ساخت برنامه NextJS در لیارا

## Liara Console

برای ساخت برنامه، کافیست تا پس از ورود به [پنل کاربری](https://console.liara.ir) وارد [تیم مدنظرتان](https://docs.liara.ir/references/team/about/) یا حساب شخصی‌تان، شوید؛ سپس

وارد منوی [پلتفرم](https://console.liara.ir/apps) شوید؛ بر روی گزینه [ایجاد برنامه](https://console.liara.ir/apps/create) کلیک کرده و پلتفرم را بر روی **NextJS** تنظیم کنید.  
...
{/* ![create app using console](https://media.liara.ir/docs/how-to-create-a-nextjs-app.gif) */}
...
با اجرای دستور فوق، شما باید اکانت شخصی یا تیم، شناسه، نوع پلتفرم (که باید بر روی next باشد)، شبکه خصوصی و [منابع سخت‌افزاری و بسته امکانات](https://docs.liara.ir/paas/details/plans/about) برنامه خود را انتخاب کنید.
...
![a ready to use nodejs app](https://media.liara.ir/docs/created-nextjs-app.png)
