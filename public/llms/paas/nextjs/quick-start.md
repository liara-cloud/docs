Original link: https://docs.liara.ir/paas/nextjs/quick-start/

# استقرار سریع برنامه‌های NextJS

توجه داشته باشید؛ تنها برنامه‌هایی که با دستور `create-next-app` ساخته شده باشند، در پلتفرم Next لیارا قابل اجرا خواهند بود.

## Liara Console

[Video link](https://media.liara.ir/nextjs/nextjs-desktop.mp4)
...
۳. ایجاد برنامه  
برنامه NextJS خود را با شناسه، [شبکه خصوصی](../details/private-network) و [منابع سخت‌افزاری و بسته امکانات](../details/plans/about) مدنظرتان ایجاد کنید.
...
در نظر داشته باشید که در پروژه‌های استاندارد NextJS، یک فایل به نام `package.json`  
...
[Video link](https://media.liara.ir/nextjs/nextjs-cli.mp4)
...
۴. ایجاد برنامه  
با اجرای دستور زیر، برنامه NextJS خود را ایجاد کنید:
```bash
liara create
```

> اگر که از قبل برنامه خود را ایجاد کرده‌اید؛ نیازی به انجام این کار نیست.  
در ادامه اجرای این دستور، باید به ترتیب، شناسه، نوع پلتفرم (که باید بر روی next تنظیم شود)، شبکه خصوصی و [منابع سخت‌افزاری و بسته امکانات برنامه](../details/plans/about)، مشخص شوند.
...
در نظر داشته باشید که در پروژه‌های استاندارد Angular، یک فایل به نام `package.json`  
وجود دارد که برای استقرار حائز اهمیت است و این فایل نباید حذف یا دستکاری شود.  
قطعه کد زیر یک نمونه استاندارد از فایل `package.json` است:
...
[Video link](https://media.liara.ir/docs/nextjs-github.mp4)
...
> لیارا به صورت خودکار، در فرایند استقرار برنامه‌های NextJS اسکریپت `build` را برای شما اجرا می‌کند.

> همچنین بخوانید: [استقرار قدم به قدم برنامه‌های NextJS در لیارا](./how-tos/create-app)
