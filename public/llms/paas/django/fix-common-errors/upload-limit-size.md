Original link: https://docs.liara.ir/paas/django/fix-common-errors/upload-limit-size/

# رفع خطای محدودیت آپلود فایل با حجم بیش از 1MB

از آنجایی که در لیارا، برای اجرای برنامه‌های Django، از [وب‌سرور Nginx](https://docs.liara.ir/how-tos/customize-nginx) استفاده می‌شود.  
