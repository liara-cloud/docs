Original link: https://docs.liara.ir/paas/django/how-tos/connect-to-db/redis/
...
در ادامه، بایستی طبق مستندات [تنظیم متغیرهای محیطی](https://docs.liara.ir/paas/details/envs)، متغیر مربوط به دیتابیس خود را، به برنامه، اضافه کنید؛ به عنوان مثال:
...
اکنون می‌توانید برنامه‌تان را در لیارا مستقر کرده و در صفحه `redis/` وضعیت اتصال به دیتابیس خود را بررسی کنید.
