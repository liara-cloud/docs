Original link: https://docs.liara.ir/paas/django/how-tos/connect-to-db/postgresql/

# اتصال به دیتابیس PostgreSQL در برنامه‌های Django

[Video link](https://media.liara.ir/django/django-postgresql.mp4)
...
در ادامه، بایستی طبق مستندات [تنظیم متغیرهای محیطی](https://docs.liara.ir/paas/details/envs)، متغیرهای مربوط به دیتابیس خود را، به برنامه، اضافه کنید؛ به عنوان مثال:
...
اکنون می‌توانید برنامه‌تان را در لیارا مستقر کرده و در صفحه `postgresql/` وضعیت اتصال به دیتابیس خود را بررسی کنید.
...
اکنون می‌توانید مجدداً برنامه‌تان را در لیارا مستقر کرده و در صفحه `postgresql/` وضعیت اتصال به دیتابیس خود را بررسی کنید.
