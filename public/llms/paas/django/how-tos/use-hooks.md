Original link: https://docs.liara.ir/paas/django/how-tos/use-hooks/
...
|---|---|---|---|
| liara_pre_build.sh | قبل از بیلد فایل‌های قسمت فرانت برنامه | ندارد | نصب پکیج‌های سیستمی لازم با apt-get |
| liara_post_build.sh | بعد از بیلد فایل‌های قسمت فرانت برنامه	 | ندارد | اجرای دستورات مرتبط با cache و بهینه‌سازی |
...
> توجه داشته باشید که در [نسخه‌های بدون به‌روزرسانی Python](../choose-version)، این قابلیت پشتیبانی نمی‌شود.
