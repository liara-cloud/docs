Original link: https://docs.liara.ir/paas/django/how-tos/create-app/

# ساخت برنامه Django در لیارا

## Liara Console

<!-- [Video link](https://media.liara.ir/django/django-desktop.mp4) -->
...
وارد منوی [پلتفرم](https://console.liara.ir/apps) شوید؛ بر روی گزینه [ایجاد برنامه](https://console.liara.ir/apps/create) کلیک کرده و پلتفرم را بر روی **Django** تنظیم کنید.  
...
<!-- ![create app using console](https://media.liara.ir/docs/create-django-app-using-console.gif) -->

## Liara CLI

<!-- [Video link](https://media.liara.ir/django/django-cli.mp4) -->
...
liara app:create
```
با اجرای دستور فوق، شما باید تیم یا اکانت شخصی‌تان، شناسه، نوع پلتفرم (که باید بر روی django باشد)، شبکه خصوصی و [منابع سخت‌افزاری و بسته امکانات](https://docs.liara.ir/paas/details/plans/about) برنامه خود را انتخاب کنید.
...
![a ready to use nodejs app](https://media.liara.ir/docs/created-django-app.png)
