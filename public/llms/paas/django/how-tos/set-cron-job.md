Original link: https://docs.liara.ir/paas/django/how-tos/set-cron-job/
...
![set cron jobs on liara](https://media.liara.ir/docs/django-cronjob.png)


## Liara CLI

برای تنظیم یک Cron Job در Django کافیست تا در مسیر اصلی پروژه، یک فایل به نام `liara.json` ایجاد کنید و Cron Jobهای مد نظر خود را در آرایه‌ای به نام `cron`، تنظیم و پیکربندی کنید. به عنوان مثال: 
