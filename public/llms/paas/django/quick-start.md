Original link: https://docs.liara.ir/paas/django/quick-start/
...
۳. ایجاد برنامه  
برنامه Django خود را با شناسه، [شبکه خصوصی](../details/private-network) و [منابع سخت‌افزاری و بسته امکانات](../details/plans/about) مدنظرتان ایجاد کنید.
...
۵. تنظیم فایل‌ requirements.txt  
حتماً باید در مسیر اصلی پروژه، فایل `requirements.txt` وجود داشته باشد؛  
...
۴. ایجاد برنامه  
با اجرای دستور زیر، برنامه Django خود را ایجاد کنید:
...
در ادامه اجرای این دستور، باید به ترتیب، شناسه، نوع پلتفرم (که باید بر روی django تنظیم شود)، شبکه خصوصی و [منابع سخت‌افزاری و بسته امکانات برنامه](../details/plans/about)، مشخص شوند.
...
[Video link](https://media.liara.ir/docs/django-github.mp4)
...
> همچنین بخوانید: [استقرار قدم به قدم برنامه‌های Django در لیارا](./how-tos/create-app)
