Original link: https://docs.liara.ir/paas/laravel/how-tos/customize-php-ini/

# تنظیم اختصاصی فایل php.ini در Laravel

`php.ini` یکی از فایل‌های مهم در سرور PHP است که نقش مهمی در عملکرد و رفتار آن، ایفا می‌کند. شما می‌توانید در برنامه‌های  
Laravel خود در لیارا، پارامترهای درون این فایل را، شخصی‌سازی کنید.
