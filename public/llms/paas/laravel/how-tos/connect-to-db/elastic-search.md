Original link: https://docs.liara.ir/paas/laravel/how-tos/connect-to-db/elastic-search/
...
اکنون می‌توانید برنامه‌تان را در لیارا مستقر کرده و در صفحه `check-elasticsearch/` وضعیت اتصال به دیتابیس خود را بررسی کنید.
