Original link: https://docs.liara.ir/paas/laravel/how-tos/connect-to-db/mariadb/

# اتصال به دیتابیس MariaDB در برنامه‌های Laravel

[Video link](https://media.liara.ir/laravel/laravel-mariadb.mp4)

برای اتصال به دیتابیس MariaDB نیاز به انجام کار خاصی نیست. فقط کافیست تا طبق [https://docs.liara.ir/paas/details/envs](https://docs.liara.ir/paas/details/envs)، متغیرهای مربوط به دیتابیس خود را به برنامه اضافه کنید؛ برای نمونه:
