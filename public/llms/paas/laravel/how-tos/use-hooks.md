Original link: https://docs.liara.ir/paas/laravel/how-tos/use-hooks/
...
|---|---|---|---|
| liara_pre_build.sh | npm run build قبل از اجرای دستور | ندارد | نصب پکیج‌های سیستمی لازم با apt-get |
| liara_post_build.sh | npm run build بعد از اجرای دستور | ندارد | اجرای دستورات مرتبط با cache و بهینه‌سازی |
...
> توجه داشته باشید که در [نسخه‌های بدون به‌روزرسانی PHP](https://docs.liara.ir/choose-version)، این قابلیت پشتیبانی نمی‌شود.
