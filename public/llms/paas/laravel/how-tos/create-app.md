Original link: https://docs.liara.ir/paas/laravel/how-tos/create-app/

# ساخت برنامه Laravel در لیارا

## Liara Console

<!-- [Video link](https://media.liara.ir/laravel/laravel-desktop.mp4) -->

برای ساخت برنامه، کافیست تا پس از ورود به [پنل کاربری](https://console.liara.ir) وارد [تیم مدنظرتان](https://https://docs.liara.ir/references/team/about/) یا حساب شخصی‌تان، شوید؛ سپس

وارد منوی [پلتفرم](https://console.liara.ir/apps) شوید؛ بر روی گزینه [ایجاد برنامه](https://console.liara.ir/apps/create) کلیک کرده و پلتفرم را بر روی **Laravel** تنظیم کنید.  
...
<!-- ![create app using console](https://media.liara.ir/docs/create-laravel-app.gif) -->

## Liara CLI

<!-- [Video link](https://media.liara.ir/laravel/laravel-cli.mp4) -->
...
با اجرای دستور فوق، شما باید تیم یا اکانت شخصی‌تان، شناسه، نوع پلتفرم (که باید بر روی laravel باشد)، شبکه خصوصی و [منابع سخت‌افزاری و بسته امکانات](https://docs.liara.ir/paas/details/plans/about) برنامه خود را انتخاب کنید.
...
![a ready to use nodejs app](https://media.liara.ir/docs/created-laravel-app.png)
