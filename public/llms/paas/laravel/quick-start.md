Original link: https://docs.liara.ir/paas/laravel/quick-start/
...
۳. ایجاد برنامه  
برنامه Laravel خود را با شناسه، [شبکه خصوصی](../details/private-network) و [منابع سخت‌افزاری و بسته امکانات](../details/plans/about) مدنظرتان ایجاد کنید.

۴. حذف فایل‌های اضافی  
پوشه‌ها و فایل‌های درون پروژه که قصد ندارید در لیارا آپلود شوند (به عنوان مثال پوشه‌های node_modules و vendor) را پاک کنید.

۵. تنظیم فایل‌های composer  
حتماً باید در مسیر اصلی پروژه، فایل `composer.json` وجود داشته باشد؛ همچنین بهتر است  
...
۴. ایجاد برنامه  
با اجرای دستور زیر، برنامه Laravel خود را ایجاد کنید:
...
در ادامه اجرای این دستور، باید به ترتیب، شناسه، نوع پلتفرم (که باید بر روی laravel تنظیم شود)، شبکه خصوصی و [منابع سخت‌افزاری و بسته امکانات برنامه](../details/plans/about)، مشخص شوند.
...
[Video link](https://media.liara.ir/docs/laravel-github.mp4)
...
> لیارا با اجرای دستور `composer install` تمامی ماژول‌های موجود در فایل `composer.json` را نصب می‌کند. پس حتماً اسامی آن‌ها باید در این فایل باشد.

> همچنین بخوانید: [استقرار قدم به قدم برنامه‌های Laravel در لیارا](./how-tos/create-app)
