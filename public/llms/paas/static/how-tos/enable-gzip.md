Original link: https://docs.liara.ir/paas/static/how-tos/enable-gzip/

# فعال‌سازی Gzip و Browser Caching در Static
...
Browser caching نیز در Static به فرآیند ذخیره‌سازی منابع وب (مانند فایل‌های HTML، CSS، JavaScript) در مرورگر کاربران اشاره دارد تا بارگذاری مجدد صفحات سریع‌تر و مصرف پهنای باند کاهش یابد.
