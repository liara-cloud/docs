Original link: https://docs.liara.ir/paas/react/quick-start/
...
[Video link](https://media.liara.ir/react/react-desktop.mp4)
...
۳. ایجاد برنامه  
برنامه React خود را با شناسه، [شبکه خصوصی](../details/private-network) و [منابع سخت‌افزاری و بسته امکانات](../details/plans/about) مدنظرتان ایجاد کنید.
...
در نظر داشته باشید که در پروژه‌های استاندارد React، یک فایل به نام `package.json`  
وجود دارد که برای استقرار حائز اهمیت است و این فایل نباید حذف یا دستکاری شود.  
...
[Video link](https://media.liara.ir/react/react-cli.mp4)
...
۴. ایجاد برنامه  
با اجرای دستور زیر، برنامه React خود را ایجاد کنید:  
```bash
liara create
```

> اگر که از قبل برنامه خود را ایجاد کرده‌اید؛ نیازی به انجام این کار نیست.  
در ادامه اجرای این دستور، باید به ترتیب، شناسه، نوع پلتفرم (که باید بر روی react تنظیم شود)، شبکه خصوصی و [منابع سخت‌افزاری و بسته امکانات برنامه](../details/plans/about)، مشخص شوند.
...
```bash
liara deploy --app=myapp --platform=react --team-id=your-unique-team-id
```

## Github

[Video link](https://media.liara.ir/docs/react-github.mp4)
...
> همچنین بخوانید: [استقرار قدم به قدم برنامه‌های React در لیارا](./how-tos/create-app)
