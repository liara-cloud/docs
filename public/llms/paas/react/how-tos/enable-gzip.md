Original link: https://docs.liara.ir/paas/react/how-tos/enable-gzip/
...
Browser caching نیز در React به فرآیند ذخیره‌سازی منابع وب (مانند فایل‌های HTML، CSS، JavaScript) در مرورگر کاربران اشاره دارد تا بارگذاری مجدد صفحات سریع‌تر و مصرف پهنای باند کاهش یابد.
...
gzip_proxied     any;
gzip_comp_level  6;
gzip_types       text/plain text/css application/json application/javascript application/x-javascript text_xml application_xml application_xml+rss text_javascript image/svg+xml;
