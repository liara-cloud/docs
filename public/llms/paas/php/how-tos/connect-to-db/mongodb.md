Original link: https://docs.liara.ir/paas/php/how-tos/connect-to-db/mongodb/

# اتصال به دیتابیس MongoDB در برنامه‌های PHP

برای اتصال به دیتابیس MongoDB می‌توانید از اکستنشن نصب شده آن استفاده کنید.  
اما طبق **نسخه آخرین اکستنشن نصب شده**، فقط امکان استفاده از ورژن `"1.15"` پکیج `"mongodb/mongodb"`و یا نسخه‌های پایین‌تر را، خواهید داشت. در صورتی که قصد دارید از نسخه‌های جدیدتر این پکیج، استفاده کنید.  
بایستی از [Hookها](https://docs.liara.ir/paas/php/how-tos/use-hooks) استفاده کنید.

در ابتدا، بایستی تا طبق مستندات [تنظیم متغیرهای محیطی](https://docs.liara.ir/paas/details/envs)، متغیرهای مربوط به دیتابیس MongoDB را به برنامه خود، اضافه کنید. به عنوان مثال:
