Original link: https://docs.liara.ir/paas/php/how-tos/use-hooks/

# استفاده از Hooks در برنامه‌های PHP
...
در لیارا، شما می‌توانید دو فایل زیر را در مسیر اصلی پروژه خود ایجاد کنید؛ و با توجه به زمان مشخص اجرای هر فایل‌،  
