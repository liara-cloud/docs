...
export default () => (
  <Layout>
    ...
    <p>
      ...
      کد‌های ناسالم به مخزن کدها گرفته می‌شود و در CD با هر push کردن در مخزن کد،
      برنامه‌‌ی شما در سرور به‌روز می‌شود.
    </p>
    <p>
      در صورتی که از لیارا برای استقرار یا Deploy برنامه‌های‌تان استفاده
      کرده‌اید می‌توانید به راحتی بین مخزن‌ کد‌هایتان و بستر ابری لیارا ارتباط
      برقرار کنید و سازوکارهای CI/CD را اجرا کنید.
    </p>

    <Notice variant="info">
      مستندات لیارا در بخش CI/CD به شما در بخش CD یا همان آپدیت کردن و به
      روزکردن برنامه‌ها کمک می‌کند و این که چطور می‌توانید بین لیارا و مخازن کد
    ...
    <Notice variant="info">
      ...
      توصیه می‌کنیم برای تجربه بهتر و حرفه‌ای تر حتما این بخش را نیز مطالعه کنید.
    </Notice>
  </Layout>
);
