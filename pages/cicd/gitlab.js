...
`}
    ...
    <Notice variant="info">
      ...
      برای دیپلوی در موقعیت آلمان نیازی به‌پروکسی نیست. همچنین اگر از GitLab.com
      استفاده نمی‌کنید و GitLab را به‌صورت خصوصی در شرکت خودتان راه‌اندازی کرده‌اید، نیازی به‌پروکسی ندارید.
    </Notice>
    <Notice variant="info">
