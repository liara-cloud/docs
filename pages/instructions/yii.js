...
export default () => (
    <Layout>
        ...
        <p>
            ...
            آن در لیارا باید یک{' '}
            <Link href="/app-deploy/php/getting-started">برنامه‌ی PHP</Link>{' '}
        ...
        <p>
            ساختار فریم‌ورک Yii به‌گونه‌ای است که فایل‌های وب برنامه در پوشه‌ی
            web قرار داده می‌شوند بنابراین باید طبق{' '}
            <Link href="/app-deploy/php/envs">مستندات تنظیم متغیرها</Link>،
        ...
        <p>
            حال برای مواجه نشدن با خطای The directory is not writable باید طبق
            مستندات{' '}
            <Link href="/app-deploy/php/disks#create-new-disk">
                استفاده از دیسک‌ها
            </Link>
            ، یک دیسک با نام و اندازه دلخواه ایجاد کرده و در قدم بعد دیسک ایجاد
            شده را در فایل{' '}
            <Link href="/app-deploy/php/disks#mount-disks">liara.json</Link> به
            مسیر assetManager basePath مونت کنید.
            <Highlight>
                {`{
  "platform": "php",
  "disks": [
    {
      ...
      "mountTo": "web/assets"
        ...
        <p>
            ...
            <Link href="/app-deploy/php/deploy">استقرار برنامه‌های PHP</Link>{' '}
            عمل کرده و دستور زیر را در مسیر اصلی پروژه اجرا کنید.
        </p>
