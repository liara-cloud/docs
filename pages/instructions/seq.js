...
export default () => (
    <Layout>
        ...
        <p>
            ...
            <Link href="/app-deploy/netcore/getting-started">ASP.Net Core</Link>
            ، Java و{' '}
            <Link href="/app-deploy/nodejs/getting-started">NodeJS</Link> دانست
            که برای استقرار آن در لیارا باید یک{' '}
  ...
  "disks": [
    {
      ...
      "mountTo": "/data"
        ...
        <Notice variant="warning">
            توجه داشته باشید که مقدار <span className="code">disk-name</span> را
            با نام دیسک ایجاد شده در مرحله‌ی قبل، جایگزین کنید.
        </Notice>
        <h3>۳) استقرار Seq</h3>
        <p>
            در قدم آخر برای استقرار Seq بر روی لیارا کافیست دستور زیر را در مسیر
