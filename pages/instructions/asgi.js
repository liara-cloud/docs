...
export default () => (
  <Layout>
    ...
    <p>
      ASGI (Asynchronous Server Gateway Interface) را می‌توان جایگزینی برای WSGI
      دانست که به ما امکان می‌دهد تا علاوه‌بر برنامه‌های وب Synchronous، قادر به
      اجرای برنامه‌های وب Asynchronous در زبان Python باشیم.
    </p>
    ...
    <p>
      برای مثال برنامه‌ی Asynchronous زیر را درنظر بگیرید که Route فعلی را در
      مرورگر چاپ می‌کند.
    </p>
...
async def app(scope, receive, send):
    ...
    <p>
      ...
      <Link href="/app-deploy/docker/getting-started">Docker</Link> تهیه کرده و
      در کنار فایل <span className="code">routeprinter.py</span> که قطعه کد فوق
      را دربرمی‌گیرد، فایلی با نام <span className="code">Dockerfile</span>{" "}
...
CMD [ "daphne","-b","0.0.0.0","-p","80","routeprinter:app" ]`}
    ...
    <p>
      ...
      مستندات <Link href="/app-deploy/docker/deploy">اولین استقرار</Link> عمل
      کرده و دستور زیر را در مسیر اصلی پروژه اجرا کنیم.
    </p>
