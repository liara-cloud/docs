...
export default () => (
  <Layout>
    ...
    <Notice variant="warning">
      در حال حاضر ArangoDB به‌صورت مستقیم در لیارا پشتیبانی نمی‌شود اما شما
      می‌توانید این دیتابیس را طبق دستورالعمل زیر در لیارا مستقر کنید.
    </Notice>
    ...
    <p>
      ...
      یک دیتابیس متن باز و native multi-model است که برای استقرار آن در لیارا
      باید یک{" "}
    ...
    <h3>
      ۱) ایجاد دیسک و تنظیم <span className="code">ARANGO_ROOT_PASSWORD</span>
    </h3>
    <p>
  ...
  "disks": [
    ...
    <Notice variant="warning">
      توجه داشته باشید که مقادیر <span className="code">disk-name</span> را با
      نام دیسک‌های ایجاد شده در مرحله‌ی قبل، جایگزین کنید.
    </Notice>
    <h3>۳) استقرار ArangoDB</h3>
    <p>
      در قدم آخر برای استقرار ArangoDB بر روی لیارا کافیست دستور زیر را در مسیر
    ...
    <p>
      ...
      <Link href="/app-features/private-network">شبکه‌ی خصوصی</Link> بر روی پورت{" "}
      <span className="code">8592</span> به دیتابیس خود دسترسی داشته باشید.
    </p>
    <h3>استقرار سریع</h3>
    <p>
