...
export default () => (
    <Layout>
        ...
        <Notice variant="warning">
            در حال حاضر Prestashop به‌صورت مستقیم در لیارا پشتیبانی نمی‌شود اما
            شما می‌توانید این پلتفرم فروشگاهی را را طبق دستورالعمل زیر در لیارا
            مستقر کنید.
        </Notice>

        <p>
            پرستاشاپ یک سامانه فروشگاه ساز اینترنتی است که به صورت رایگان در
            دسترس قرار گرفته است. این سیستم با برنامه نویسی PHP و دیتابیس MySQL
            طراحی و برنامه‌نویسی شده است که با نصب آن می‌توانید فروشگاه خود را
            در زمانی کوتاه ایجاد کنید.
        </p>

        <p>
            برای استقرار این برنامه، ابتدا لازم است که از بخش «برنامه‌ها» یک
            برنامه از نوع{' '}
            <Link href="/app-deploy/docker/getting-started">Docker</Link> با نام
            و پلن دلخواه‌تان بسازید.
        </p>
        <p>
            در مرحله بعد یک پایگاه داده MySQL یا MariaDB طبق مستندات «
        ...
        <p>
            ...
            <Link href="/app-deploy/docker/disks">استفاده از دیسک‌ها</Link>»
            بسازید.
        </p>
        <p>
            سپس طبق مستندات «
...
PRESTASHOP_DATABASE_PASSWORD=[گذرواژه دیتابیس]`}
        ...
        <p>
            در مرحله بعد یک فایل<span className="code">liara.json</span> طبق
            راهنمایی زیر بسازید و مشخصات مربوطه را در این فایل وارد نمایید.
            <Highlight>
                {`{
    ...
    },
    {
      ...
      "mountTo": "/bitnami"
        ...
        <ul>
            ...
            <li>
                برای اطلاع از تنظیمات بیشتر و نسخه‌های مختلف می‌توانید از
                مستندات مربوطه در{' '}
                <Link href="https://hub.docker.com/r/bitnami/prestashop">
                    Bitnami Prestashop
                </Link>{' '}
                استفاده کنید.
            </li>
