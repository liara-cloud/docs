...
export default () => (
  <Layout>
    ...
    <Notice variant="warning">
      در حال حاضر Prestashop به‌صورت مستقیم در لیارا پشتیبانی نمی‌شود اما شما
      می‌توانید این پلتفرم فروشگاهی را طبق دستورالعمل زیر در لیارا مستقر کنید.
    </Notice>

    <p>
      پرستاشاپ یک سامانه فروشگاه ساز اینترنتی است که به صورت رایگان در دسترس
      قرار گرفته است. این سیستم با برنامه نویسی PHP و دیتابیس MySQL طراحی و
      برنامه‌نویسی شده است که با نصب آن می‌توانید فروشگاه خود را در زمانی کوتاه
      ایجاد کنید.
    </p>
  ...
  "disks": [
    ...
    <ul>
      <li>
        ...
        میکروسرویس‌ها، ارتباط درون‌شبکه‌ای و استفاده از Prestashop، بسیار
        کاربردی است.
      </li>
      <li>
