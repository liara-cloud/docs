...
export default () => (
    <Layout>
        ...
        <p>
            گرافانا پلتفرمی بسیار محبوب و ساده برای تحلیل و نمایش داده‌های به
            دست آمده از پایگاه‌های داده خصوصا دیتابیس‌های سری زمانی (Time-series
            Databases) است. گرافانا از دیتابیس‌های مختلفی از جمله InfluxDB و
      ...
      "mountTo": "/var/lib/grafana"
        ...
        <ul>
            <li>
                ...
                استقرار میکروسرویس‌ها، ارتباط درون‌شبکه‌ای و استفاده از Grafana،
                بسیار کاربردی است.
            </li>
            <li>
            ...
            <li>
                ...
                مستندات مربوطه در{' '}
                <Link href="https://hub.docker.com/r/grafana/grafana">
                    Grafana
                </Link>{' '}
                استفاده کنید.
            </li>
