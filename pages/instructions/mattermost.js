...
export default () => (
  <Layout>
    ...
    <Notice variant="warning">
      در حال حاضر Mattermost به‌صورت مستقیم در لیارا پشتیبانی نمی‌شود اما شما
    ...
    <p>
      ...
      نرم‌افزاری برای چت و گفتگوی درون تیمی یا سازمانی است که می‌تواند جایگزین
      خوبی برای Slack باشد. برای استقرار Mattermost باید یک برنامه{" "}
...
MM_PASSWORD=[گذرواژه دیتابیس]`}
    ...
    <p>
      در قدم آخر برای استقرار Mattermost بر روی لیارا کافیست دستور زیر را در
    ...
    <ul>
      <li>
        ...
        میکروسرویس‌ها، ارتباط درون‌شبکه‌ای و استفاده از Mattermost، بسیار
        کاربردی است.
      </li>
      <li>
