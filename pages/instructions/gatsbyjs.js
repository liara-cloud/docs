...
export default () => (
  <Layout>
    <Head>
      <title>استقرار برنامه‌های GatsbyJS - سرویس ابری لیارا</title>
    </Head>
    ...
    <p>
      Gatsby یک فریم‌ورک SSG مبتنی بر GraphQL و React است که این امکان را برای
      شما فراهم می‌کند تا وبسایت‌های خود را سریع‌تر، ایمن‌تر و قدرتمندتر از
      گذشته توسعه دهید. حال برای استقرار برنامه‌های GatsbyJS در لیارا تنها کافی
