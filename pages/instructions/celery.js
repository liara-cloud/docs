...
export default () => (
  <Layout>
    <Head>
      <title>مستندات شروع به کار Celery در برنامه‌های Django - لیارا</title>
    </Head>
    ...
    <p>
      ...
      یک Distributed Task Queue ساده و انعطاف‌‌پذیر است که ارتباط بین Producer و
      Consumer را با استفاده از یک Message Broker مانند{" "}
  ...
  - proj/
    ...
    <p>
      توصیه می‌شود در ابتدا یک ماژول جدید با نام <strong>celery.py</strong> در
      مسیر <strong>proj/proj</strong> ایجاد کنید:
    </p>
...
def debug_task(self):
    ...
    <p>
      حال برای اطمینان از import شدن ماژول <strong>celery.py</strong> در زمان
      اجرای
      <span className="code">shared_task</span> توسط فریم‌ورک Django، ماژول{" "}
      <strong>__init__.py</strong> را در مسیر <strong>proj/proj</strong> ایجاد
...
__all__ = ('celery_app',)`}
    ...
    <p>
      در قدم بعد باید پیکربندی‌های مورد نیاز برای راه‌اندازی Celery را در انتهای
      فایل <strong>settings.py</strong> پروژه وارد کنید:
    </p>
...
CELERY_TIMEZONE = 'Asia/Tehran'`}
    ...
    <p>
      ...
      <strong>proj/proj/celery.py</strong> این امکان برای شما فراهم است که
      taskهای مورد نظر خود را در فایل <strong>tasks.py</strong> هر App به‌صورت
      جداگانه تعریف کنید:
    </p>
...
- app2/
    ...
    <p>
      ...
      <span className="code">@shared_task</span> به‌شکل زیر taskهای خود را تعریف
      کنید:
    </p>
