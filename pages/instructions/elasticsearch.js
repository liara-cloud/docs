...
export default () => (
    <Layout>
        ...
        <Notice variant="danger">
            در حال حاضر استقرار Elasticsearch در لیارا امکان‌پذیر نیست و ما در
            حال بررسی و رفع مشکل استقرار این موتور جستجو و تحلیلگر توزیع شده در
            لیارا هستیم.
        </Notice>

        <p>
            Elasticsearch یک موتور جستجو و تحلیلگر توزیع شده است که با رابط
            کاربری وب (HTTP) و الگوی استاندارد JSON برای انتقال داده ها کار
            می‌کند.
        </p>
