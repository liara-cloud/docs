...
export default () => (
    <Layout>
        <Head>
            <title>
                استقرار Kibana - سرویس ابری لیارا
            </title>
        </Head>
        ...
        <p>
            سپس طبق مستندات «<Link href="/app-deploy/docker/envs">تنظیم متغیرها (Environment Variables)</Link>» متغیر
            زیر را تنظیم کنید.
            <Highlight>
      ...
      "mountTo": "/bitnami"
        ...
        <ul>
            <li>
                ...
                میکروسرویس‌ها، ارتباط درون‌شبکه‌ای و استفاده از Kibana، بسیار کاربردی است.
            </li>
            <li>
