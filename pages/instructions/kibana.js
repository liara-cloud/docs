...
export default () => (
    <Layout>
        ...
        <p>
            ...
            ... را در اختیار داشت. داده‌های kibana از طریق beats جمع آوری شده و
            با logstash به elasticsearch منتقل می‌شود سپس kibana امکان رصد و
            مانیتورینگ را می‌دهد.
        </p>
        <p>
      ...
      "mountTo": "/bitnami"
        ...
        <ul>
            <li>
                ...
                استقرار میکروسرویس‌ها، ارتباط درون‌شبکه‌ای و استفاده از Kibana،
                بسیار کاربردی است.
            </li>
            <li>
