...
export default () => (
    <Layout>
        ...
        <Notice variant="warning">
            ...
            شما می‌توانید این نرم‌افزار را طبق دستورالعمل زیر در لیارا مستقر
            کنید.
        </Notice>
        ...
        <p>
            ...
            یک نرم افزار برای انتقال پیام بین سیستم‌ها یا به عبارتی Message
            broker software است که با استفاده از آن می‌توانیم بین سیستم های
            مختلف پیام ارسال کنیم و عملیات صف‌بندی را به‌خوبی انجام دهیم.
        </p>
  ...
  "disks": [
    ...
    },
    {
      ...
      "mountTo": "/bitnami"
        ...
        <p>
            در قدم آخر برای استقرار RabbitMQ بر روی لیارا کافیست دستور زیر را در
