...
export default () => (
    <Layout>
        ...
        <p>
            NestJS یک فریم‌ورک قابل اعتماد و مقیاس‌پذیر با NodeJS است که بسیاری
            از قابلیت‌ها را برای شما به ارمغان می‌آورد و شما می‌توانید
            برنامه‌های NestJS خود را با ایجاد برنامه‌های{' '}
    ...
    "start": "node dist/main"
        ...
        <p>
            ...
            را اجرا می‌کند و نیازی نیست که تغییر خاصی برای اجرای این دستور اعمال
            کنید. در نهایت دستور
