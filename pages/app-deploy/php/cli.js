...
export default () => (
  <Layout>
    <Head>
      <title>
        مستندات استقرار برنامه‌های PHP با استفاده از ابزار Liara CLI - سرویس
        ابری لیارا
      </title>
    </Head>
    ...
    <video
      src="https://files.liara.ir/tutorials/PHP/php-CLI.mp4"
      controls="controls"
    ...
    <p>
      ...
      برنامه آزمایشی‌مان، شناسه php-starter را انتخاب کردیم. همچنین شما
    ...
    <p>
      ...
      یک برنامه‌ی PHP اجرا کند و عملیات استقرار را آغاز خواهد کرد. اما اگر مشکلی
    ...
    <Link href="/app-deploy/php/envs" className="next-page">
