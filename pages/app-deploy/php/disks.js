...
export default () => (
  <Layout>
    ...
    <div className="page-head">
      ...
      <div className="page-title">
        <h1>استفاده از دیسک‌ها در برنامه‌های PHP</h1>
    ...
    <p>
      برای اتصال دیسک ایجاد شده در مرحله‌ی قبل به مسیر <span className="code">‌uploads</span> باید قطعه کد زیر را در فایل ‌<span className="code">liara.json</span> قرار داده و با اجرای دستور <span className="code">liara deploy</span> سورس‌کد خود را بر روی برنامه‌ی تهیه شده مستقر کنید.
    </p>
  ...
  "disks": [
    ...
    <Notice variant="info">
      توجه داشته باشید که فایل‌های ذخیره شده در دیسک‌ها با استقرار نسخه‌های جدید برنامه به‌رزورسانی نخواهند شد و باید با استفاده از <Link href="/storage/disks/ftp">دسترسی FTP</Link> یا به‌صورت نرم‌افزاری فایل‌های مورد نظر خود را بر روی دیسک مربوطه آپلود کنید.
    </Notice>
