...
export default () => (
  <Layout>
    ...
    <p>
      ...
      files برنامه‌ی‌تان ذخیره کنید در استقرار بعدی یا ری‌استارت شدن برنامه، آن
      فایل ویدیویی‌ای از بین میرود. به همین دلیل از قابلیتی تحت عنوان{" "}
      <b>دیسک‌ها</b> در اینجا استفاده می‌کنیم تا اطلاعات را بتوانیم به صورت
      دائمی ذخیره کنیم.
    </p>
    <p>
  ...
  "disks": [
    ...
    <Notice variant="info">
      همانطور که در فایل‌های بالا می‌بینید آدرس دهی‌ها از ریشه هر برنامه PHP
      داده شده است.
    </Notice>
    <br />
