...
export default () => (
  <Layout>
    ...
    <p>
      ...
      <b>دیسک‌ها</b> در اینجا استفاده می‌کنیم تا اطلاعات را بتوانیم به صورت دائمی
      ذخیره کنیم.
    </p>
    <p>
  ...
  "disks": [
    ...
    <p>
      ...
      برنامه متصل شده‌است. از حالا به بعد هر چیزی داخل دایرکتوری files قرار بگیرد
  ...
  "disks": [
    ...
    <Notice variant="info">
      همانطور که در فایل‌های بالا می‌بینید آدرس دهی‌ها از ریشه هر برنامه PHP داده
      شده است.
    </Notice>
    <br />
