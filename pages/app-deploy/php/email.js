...
export default () => (
    <Layout>
        <Head>
            <title>
                مستندات سرویس ایمیل در برنامه‌های PHP - سرویس ابری لیارا
            </title>
        </Head>
        ...
        <p>
            ...
            ، در ابتدا کتابخانه{' '}
            <Link href="https://github.com/PHPMailer/PHPMailer">PHPMailer</Link>{' '}
        ...
        <p>
            ...
            مستندات <Link href="/app-deploy/php/envs">تنظیم متغیرها</Link> در
...
MAIL_PASSWORD=87b9307a-dae9-410e-89a2-e77de60e4885`}
        ...
        <p>
            در نهایت می‌توانید در پروژه‌ی خود مانند مثال زیر عمل کرده و با
            استفاده از دسترسی SMTP سرویس ایمیل لیارا و تنظیم{' '}
            <span className="code">MAIL_SECURITY=tls</span>، به‌صورت امن اقدام
            به ارسال ایمیل‌های تراکنشی کنید.
        </p>

        <Notice variant="warning">
            توجه داشته باشید که مقدار From باید یکی از نشانی‌های اضافه شده در
            سرویس ایمیل باشد.
        </Notice>
