...
export default () => (
  <Layout>
    ...
    <Notice variant="info">
      ...
      استقرار برنامه‌های PHP در سیستم‌عامل لینوکس و مک می‌توانید از ابزار{" "}
      <Link href="/app-deploy/php/cli">Liara CLI</Link> استفاده کنید.
    </Notice>
    ...
    <Link href="/app-deploy/php/cli">متوجه شدم، برو گام بعدی!</Link>
  </Layout>
);
