...
export default () => (
  <Layout>
    <Head>
      <title>مستندات شروع به کار برنامه‌های NextJS - لیارا</title>
    </Head>
    ...
    <p>
      ...
      <Link href="/app-deploy/nextjs/browser">مرورگر</Link>، بر روی لیارا مستقر
    ...
    <Link href="/app-deploy/nextjs/browser" className="next-page">
