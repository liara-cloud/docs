...
export default () => (
  <Layout>
    ...
    <p>
      ...
      <Link href="/app-deploy/flask/browser">مرورگر</Link>، بر روی لیارا مستقر
    ...
    <p>
      ...
      ساده‌تر کنیم؛ آموزش صفر تا صد استقرار برنامه Flask در لیارا را برای شما
    ...
    <Link href="/app-deploy/flask/browser" className="next-page">
