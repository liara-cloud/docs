...
export default () => (
  <Layout>
    ...
    <p>
      اگر باکت شما خصوصی باشد، برای دسترسی به باکت، نیازداریم که کلید بسازیم.
      برای ساخت کلید، به صفحه ذخیره‌سازی ابری میرویم و طبق عکس ها کلید خود را
      میسازیم.
    </p>
    <p>به قسمت کلید ها رفته:</p>
    <ZoomableImage src="/static/flask/get_key1.png" />
    <p>یک کلید جدید میسازیم.</p>
    <ZoomableImage src="/static/flask/get_key2.png" />
    <p>
      کلید های ساخته شده را کپی میکنیم. توجه داشته باشید که SECRET_KEY تنها یک
      بار نمایش داده میشود و پس از آن باید کلید را درجایی مطمئن ذخیره کنیم.
    </p>
    <ZoomableImage src="/static/flask/get_key3.png" />
    <h3 id="set-env">تنظیم متغیر های محیطی</h3>
    <p>
      در این مرحله باید کلید ها، نام باکت و endpoint لیارا را در فایل .env ذخیره
      کنیم
    </p>
