...
export default () => (
  <Layout>
    ...
    <p>
      ...
      بروید و با انتخاب پلتفرم REACT و نوشتن شناسه برنامه‌موردنظرتان و در نهایت
      انتخاب پلن، برنامه خود را ایجاد کنید. برای نمونه، ما در این آموزش برای
      پروژه تست‌مون، شناسه react-starter را انتخاب کردیم.
    </p>
    <p>
    ...
    <Link href="/app-deploy/react/logs">متوجه شدم، برو بعدی!</Link>
  </Layout>
);
