...
export default () => (
  <Layout>
    ...
    <Notice variant="info">
      ...
      استقرار برنامه‌های React در سیستم‌عامل لینوکس و مک می‌توانید از ابزار{" "}
      <Link href="/app-deploy/react/cli">Liara CLI</Link> استفاده کنید.
    </Notice>
    ...
    <Link href="/app-deploy/react/cli">متوجه شدم، برو گام بعدی!</Link>
  </Layout>
);
