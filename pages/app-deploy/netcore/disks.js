...
export default () => (
  <Layout>
    <Head>
      <title>
        مستندات استفاده از دیسک‌ها در برنامه‌های .Net Core - سرویس ابری
        لیارا
      </title>
    </Head>
    ...
    <p>
      ...
      <span className="code">MyStaticFiles</span> باید قطعه کد زیر را در
      فایل ‌<span className="code">liara.json</span> قرار داده و با اجرای
      دستور <span className="code">liara deploy</span> سورس‌کد خود را بر
      روی برنامه‌ی تهیه شده مستقر کنید.
    </p>
