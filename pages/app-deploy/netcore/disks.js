  ...
  <Layout>
    ...
    <div className="page-head">
      ...
      <div className="page-title">
        <h1>استفاده از دیسک‌ها در برنامه‌های ASP.Net Core</h1>
    ...
    <p>
      برای اتصال دیسک ایجاد شده در مرحله‌ی قبل به مسیر <span className="code">MyStaticFiles</span> باید قطعه کد زیر را در فایل ‌<span className="code">liara.json</span> قرار داده و با اجرای دستور <span className="code">liara deploy</span> سورس‌کد خود را بر روی برنامه‌ی تهیه شده مستقر کنید.
    </p>
