...
export default () => (
  <Layout>
    <Head>
      <title>
        مستندات اتصال به فضای ذخیره‌سازی ابری در برنامه‌های .Net - سرویس ابری
        لیارا
      </title>
    </Head>
    ...
    <div className="page-head">
      ...
      <div className="page-title">
        <h1>برنامه‌های .Net</h1>
        <span className="page-description">(.Net Apps)</span>
      </div>
    </div>
    ...
    <p>
      ...
      فضای ذخیره‌سازی ابری در .Net باید با اجرای دستور زیر، پکیج{" "}
      <a
