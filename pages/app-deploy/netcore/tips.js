...
https://aka.ms/dotnet-download`}
  ...
  "netcore": {
    ...
    <h3>رفع خطای 502 Bad Gateway</h3>
    <p>
      در صورتی که فرایند استقرار برنامه‌ی‌تان موفقیت‌آمیز بوده اما خطای 502
      را در خروجی مشاهده می‌کنید، به‌احتمال زیاد مشکل از URL ای است
      که داخل سورس‌کدتان تنظیم و شخصی‌سازی کرده‌اید.
    </p>
    <p>
      به‌صورت پیش‌فرض، برنامه‌های ASP.Net Core
      روی آدرس
    ...
    <p>
      در این صفحه‌ی
      {' '}
      <a href="https://stackoverflow.com/a/37349873/6390238" target="_blank">StackOverflow</a>
      ، می‌توانید راه‌حل‌های متنوعی که برای حل این مسئله گفته شده را مشاهده کنید.
      به‌طور خلاصه، باید در فایل
      <span className="code">Program.cs</span>،
      از متد
    ...
    <p>
      همان‌طور که مشاهده می‌کنید، localhost را باید به 0.0.0.0 تغییر دهید.
      حالا برای استقرار این برنامه، باید از دستور
      <span className="code">liara deploy --port 5000</span>
      استفاده کنید تا لیارا بداند که برنامه‌ی شما قرار است روی پورت 5000 اجرا شود.
    </p>
  </Layout>
);
