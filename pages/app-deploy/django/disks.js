...
export default () => (
  <Layout>
    <Head>
      <title>
        مستندات استفاده از دیسک‌ها در برنامه‌های Django - سرویس ابری
        لیارا
      </title>
    </Head>
  ...
  "disks": [
    ...
    <Highlight className="bash">{`$ liara deploy --disks data:media`}</Highlight>
  ...
  "disks": [
    ...
    <Highlight className="bash">{`$ liara deploy --disks data:media --disks uploads:pdfs`}</Highlight>
