...
export default () => (
  <Layout>
    <Head>
      <title>مستندات استفاده از دیسک‌ها در برنامه‌های Django - لیارا</title>
    </Head>
    ...
    <video
      src="https://files.liara.ir/tutorials/Django/Django-Disks.mp4"
      controls="controls"
...
$ liara deploy --disks data:/app/data \\
    ...
    <Link href="/app-deploy/django/object-storage" className="next-page">
