...
export default () => (
  <Layout>
    ...
    <p>
      ...
      برای پروژه تست‌مون، شناسه angular-starter را انتخاب کردیم.
    </p>
    <p>
    ...
    <Notice variant="info">
      میتوانید <span className="code">--platform=angular</span> را در دستور وارد
    ...
    <Link href="/app-deploy/angular/logs">متوجه شدم، برو بعدی!</Link>
  </Layout>
);
