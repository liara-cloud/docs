...
export default () => (
  <Layout>
    ...
    <p>
      ...
      کرده باشید. اما پلتفرم Angular نکات و توضیحات بیشتری نیز دارد که در بخش
    ...
    <p>
      همچنین می‌توانید در{" "}
      <a
        href="https://github.com/liara-cloud/angular-getting-started"
        target="_blank"
      >
        این آدرس،
      </a>{" "}
      نمونه کد‌های یک برنامه Angular قابل استقرار را مشاهده کنید.
    </p>
