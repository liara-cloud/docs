...
export default () => (
  <Layout>
    ...
    <Notice variant="info">
      ...
      استقرار برنامه‌های Angular در سیستم‌عامل لینوکس و مک می‌توانید از ابزار{" "}
      <Link href="/app-deploy/angular/cli">Liara CLI</Link> استفاده کنید.
    </Notice>
    ...
    <Link href="/app-deploy/angular/cli">متوجه شدم، برو گام بعدی!</Link>
  </Layout>
);
