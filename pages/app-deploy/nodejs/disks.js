...
export default () => (
  <Layout>
    <Head>
      <title>مستندات استفاده از دیسک‌ها در برنامه‌های NodeJS - لیارا</title>
    </Head>
    ...
    <Notice variant="info">
      ...
      <Link href="https://github.com/liara-cloud/nodejs-getting-started/tree/diskSetup">
        اینجا
      </Link>{" "}
...
$ liara deploy --disks data:uploads \\
    ...
    <Link href="/app-deploy/nodejs/object-storage" className="next-page">
