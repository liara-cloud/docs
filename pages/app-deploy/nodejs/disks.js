...
export default () => (
  <Layout>
    <Head>
      <title>
        مستندات استفاده از دیسک‌ها در برنامه‌های NodeJS - سرویس ابری
        لیارا
      </title>
    </Head>
    ...
    <p>
      ...
      <span className="code">‌uploads</span> باید قطعه کد زیر را در فایل ‌
  ...
  "disks": [
    ...
    <Highlight className="bash">{`$ liara deploy --disks data:uploads`}</Highlight>
  ...
  "disks": [
    ...
    <Highlight className="bash">{`$ liara deploy --disks data:uploads --disks static:files`}</Highlight>
...
$ liara deploy --disks data:uploads \\
               --disks static:files \\
               --disks temp:/tmp`}
    </Highlight>
