...
export default () => (
  <Layout>
    <Head>
      <title>
        مستندات استفاده از دیسک‌ها در پلتفرم NodeJS - سرویس ابری لیارا
      </title>
    </Head>
    ...
    ></video>
    <p>
      <Link href="/app-features/file-system">فایل سیستم پلتفرم‌های لیارا</Link>{" "}
      Read-Only است یعنی بعد از استقرار پروژه تنها می‌توانیم فایل‌ها و
    ...
    <p>
      ...
      ذخیره‌ی فایل‌هایی مانند فایل‌های رسانه در کنار سورس‌کد پروژه در مسیری مشخص
      باید از دیسک‌ها استفاده کرد که آموزش ایجاد دیسک و نحوه‌ی اتصال آن به مسیر
      مورد نظر به شرح زیر است:
    </p>

    <Notice variant="warning">
      توجه داشته باشید که با وجود Read-Only بودن فایل‌سیستم پلتفرم‌های لیارا،
    ...
    <p>
      ...
      پروژه به‌روزرسانی نخواهند شد و باید با استفاده از{" "}
    ...
    <p>
      ...
      <span className="code">liara deploy</span> سورس‌کد خود را بر روی پلتفرم
      تهیه شده مستقر کنید.
    </p>
  ...
  "disks": [
    ...
    <p>
      ...
      <span className="code">/tmp</span> پلتفرم اختصاص داده شده است اما شما
