...
export default () => (
  <Layout>
    <Head>
      <title>مستندات شروع به کار پلتفرم NodeJS - سرویس ابری لیارا</title>
    </Head>
    ...
    <p>
      شما می‌توانید در سریع‌ترین زمان ممکن یک پروژه‌ی NodeJS را با استفاده از
      ...
      <Link href="/cicd/about">راه‌اندازی CI/CD</Link>، مسئولیت استقرار پروژه‌ی
      ...
      در هر گام، با یک ویژگی پلتفرم NodeJS لیارا آشنا خواهید شد و می‌توانید از
      آن‌ها در پروژه‌تان استفاده کنید.
    </p>

    <p>
      در حال حاضر، این نسخه‌ها از NodeJS در پلتفرم NodeJS لیارا پشتیبانی می‌شود:
    </p>
