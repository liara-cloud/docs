...
export default () => (
  <Layout>
    <Head>
      <title>مستندات اتصال پلتفرم NodeJS به دیتابیس - سرویس ابری لیارا</title>
    </Head>
    ...
    <p>
      {" "}
      روش‌ها و کتابخانه‌های مختلفی برای اتصال به MySQL در NodeJS وجود دارد. برای
      نمونه اگر از کتابخانه‌{" "}
      <a href="https://www.npmjs.com/package/mysql" target="_blank">
        mysqljs
      </a>{" "}
      برای اتصال به دیتابیس و اجرای کوئری‌ها استفاده باشید، کافیست ابتدا ENV های
      لازم را وارد کنید:
    </p>
...
`}
    ...
    <p>و در پروژه‌تان به این صورت اطلاعات را خوانده و به دیتابیس متصل شوید:</p>
