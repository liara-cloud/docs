...
export default () => (
    <Layout>
        <Head>
            <title>
                مستندات سرویس ایمیل در برنامه‌های NodeJS - سرویس ابری لیارا
            </title>
        </Head>
        ...
        <p>
            ...
            ، در ابتدا پکیج{' '}
            <Link href="https://www.npmjs.com/package/nodemailer">
                nodemailer
            </Link>{' '}
...
MAIL_PASSWORD=87b9307a-dae9-410e-89a2-e77de60e4885`}
        ...
        <Notice variant="warning">
            توجه داشته باشید که فیلد from باید یکی از نشانی‌های اضافه شده در
            سرویس ایمیل باشد.
        </Notice>
