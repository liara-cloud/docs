...
export default () => (
  <Layout>
    <Head>
      <title>
        مستندات استفاده از دیسک‌ها در برنامه‌های Laravel - سرویس ابری
        لیارا
      </title>
    </Head>
    ...
    <p>
      توجه داشته باشید که فایل‌های ذخیره شده در دیسک‌ها با استقرار
      نسخه‌های جدید برنامه به‌روزرسانی نخواهند شد و باید با استفاده از{' '}
    ...
    <p>
      ...
      <span className="code">storage</span> باید قطعه کد زیر را در فایل ‌
      <span className="code">liara.json</span> قرار داده و با اجرای دستور{' '}
      <span className="code">liara deploy</span> سورس‌کد خود را بر روی
      برنامه‌ی تهیه شده مستقر کنید.
    </p>
  ...
  "disks": [
    ...
    <Highlight className="bash">{`$ liara deploy --disks data:storage`}</Highlight>
  ...
  "disks": [
    ...
    <Highlight className="bash">{`$ liara deploy --disks data:storage --disks uploads:public/uploads`}</Highlight>
