...
export default () => (
  <Layout>
    ...
    <ul className="mt-0">
      ...
      <li>
        <a href="#storage-link">لینک‌کردن پوشه‌ی storage به پوشه‌ی public</a>
      </li>
    </ul>
    ...
    <Notice variant="info">
      ...
      <Link href="https://github.com/liara-cloud/laravel-getting-started/tree/diskSetup">
        اینجا
      </Link>{" "}
...
$ liara deploy --disks data:storage \\
    ...
    <Link href="/app-deploy/laravel/email" className="next-page">
