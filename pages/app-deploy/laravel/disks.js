...
export default () => (
  ...
  "disks": [
    ...
    <p>
      ...
      پوشه‌ی <span className="code">public</span> لینک شود. برای این‌کار، در
      کامپیوتر خودتان اگر قبلا لینک را ایجاد کرده‌اید آن را حذف کرده و از دستور
      زیر برای ایجاد دوباره‌ی آن استفاده کنید:
    </p>
    <pre>
      <code>php artisan storage:link --relative</code>
    </pre>
    <p>
      این لینک به‌صورت نسبی ساخته خواهد شد و به‌این معناست که هم در کامپیوتر
      خودتان و هم بعد از استقرار در لیارا، عملکرد صحیحی خواهد داشت. بعد از اجرای
      دستور بالا، دستور دیپلوی را اجرا کنید.
    </p>
