...
export default () => (
  <Layout>
    <Head>
      <title>
        مستندات اتصال به فضای ذخیره‌سازی ابری در برنامه‌های Laravel - سرویس ابری
        لیارا
      </title>
    </Head>
    ...
    <p>
      ...
      داده‌های آپلود شده توسط کاربران که درنهایت باعث اطمینان خاطر صاحبان کسب و
      کار و بهبود عملکرد برنامه‌ می‌شود را باید یکی از اولویت‌های مهم دانست.
    </p>
    ...
    <ul className="mt-0">
      ...
      <li>
        <a href="#set-env-variable">تنظیم مشخصات فضای ذخیره‌سازی ابری</a>
      </li>
      <li>
    ...
    <p>
      فضای ذخیره‌سازی ابری لیارا یک Object Storage است که ساختار آن توسط کمپانی
      آمازون طراحی شده و S3 نام دارد بنابراین در برنامه‌ی Laravel خود به یک
      Driver برای ارتباط با فضای ذخیره‌سازی ابری نیاز خواهید داشت که با اجرای
      دستور زیر نصب خواهد شد:
    </p>
...
'minio' => [
    ...
    <h3 id="set-env-variable">تنظیم مشخصات فضای ذخیره‌سازی ابری</h3>
...
BUCKET_NAME=<Name of you're bucket>`}
    ...
    <p>
      برای تنظیم مشخصات فضای ذخیره‌سازی ابری در برنامه‌ی Laravel خود باید وارد
      تنظیمات برنامه شده و در بخش{" "}
      <Link href="/app-features/environment-variables">متغیرها</Link> با کلیک
      کردن بر روی دکمه‌ی افزودن متغیر، مشخصات فضای ذخیره‌سازی ابری را وارد کنید.
    </p>
