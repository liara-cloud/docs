...
export default () => (
    <Layout>
        ...
        <h4>فهرست عناوین:</h4>
        <ul className="mt-0">
            <li><a href="#install-s3-driver">نصب Amazon S3 Driver</a></li>
            <li><a href="#filesystem-config">پیکربندی FileSystem</a></li>
            <li><a href="#set-env-variable">تنظیم مشخصات سرویس فایل</a></li>
            <li><a href="#how-to-use">نحوه‌ی استفاده</a></li>
        </ul>
...
'minio' => [
    ...
    'bucket' => env('BUCKET_NAME'),
        ...
        <h4>در فایل <span className="code">.env</span> پروژه</h4>
        <p>
...
BUCKET_NAME=<Name of you're bucket>`}
        ...
        <p>
            برای تنظیم مشخصات سرویس فایل در برنامه‌ی Laravel خود باید وارد تنظیمات برنامه شده و در بخش <Link href="/app-features/environment-variables">متغیرها</Link> با کلیک کردن بر روی دکمه‌ی افزودن متغیر، مشخصات سرویس فایل را وارد کنید.
        </p>
