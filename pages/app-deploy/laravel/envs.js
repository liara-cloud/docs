...
{' '}
<Link href="/app-features/environment-variables">توضیحات بیشتر</Link> Laravel
      نیز به وسیله فایل‌های <span className="code">.env</span> متغیرهای محیطی
      خود را نگهداری می‌کند. یکی از این env های مهم در Laravel متغیر APP_KEY
      است که لاراول به وسیله آن رمزنگاری‌های مختلفی را انجام می‌دهد. برای ساخت
      این کلید و انتقال آن به لیارا این اقدامات را انجام دهید:
    </p>
    <Notice variant="info">
      در پتلفرم Laravel لیارا، متغیر APP_KEY به صورت خودکار با ساخت برنامه ایجاد
      می‌شود و شما می‌توانید از این مراحل صرف نظر کنید و صرفاً برای یادگیری مدیریت
    ...
    <p>
      بعد از این تغییرات برنامه‌ی‌ شما به صورت خودکار ریستارت می‌شود و در استقرار
      جدید این متغیر‌های محیطی در داخل برنامه قابل استفاده می‌شوند. به این شیوه
      که APP_KEY را اضافه کردید می‌توانید هر ENV دیگری را نیز به برنامه اضافه
      کنید.
    </p>
