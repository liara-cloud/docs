...
export default () => (
  <Layout>
    <Head>
      <title>مستندات استفاده از دیسک‌ها در برنامه‌های Docker - لیارا</title>
    </Head>
    ...
    <p>
      توجه داشته باشید که در این مثال پوشه‌ی <span className="code">/app</span>{" "}
      همان پوشه‌ی <span className="code">working directory</span> است و شما
      می‌توانید هر مسیر دیگری را وارد کنید. همچنین درنظر داشته باشید که فایل‌های
      ذخیره شده در دیسک‌ها با استقرار نسخه‌های جدید برنامه به‌روزرسانی نخواهند
      شد و باید با استفاده از <Link href="/storage/disks/ftp">دسترسی FTP</Link>{" "}
      یا به‌صورت نرم‌افزاری فایل‌های مورد نظر خود را بر روی دیسک مربوطه آپلود
      کنید
    </p>
    <h4>
    ...
    <p>
      ...
      <Link href="/app-deploy/docker/liarajson">liara.json</Link> قرار داده و با
      اجرای دستور <span className="code">liara deploy</span> سورس‌کد خود را بر
...
$ liara deploy --disks data:/app/data \\
    ...
    <Link href="/app-deploy/docker/domain" className="next-page">
