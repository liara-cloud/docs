...
export default () => (
  <Layout>
    ...
    <p>
      ...
      پورت معمولا برابر با همان پورت EXPOSE است. بعد از انتخاب پورت، کافیست تا
      بخش‌های زیر را نیز بر اساس نیازهای برنامه خود، تنظیم کنید:
    </p>

    <ul>
      <li>
        <b>تنظیمات دیسک‌ها: </b>اگر که در برنامه خود،{" "}
        <a href="/app-deploy/docker/disks">دیسک</a> تعریف کردید؛ می‌توانید در
        این بخش، آن را به برنامه خود متصل کنید. در نظر داشته باشید که دیسک‌ها،
        همانند volumeها در داکر عمل می‌کنند که باید آن را به برنامه خود mount
        کنید.
      </li>
      <li>
