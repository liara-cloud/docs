...
export default () => (
  <Layout>
    ...
    <Notice variant="info">
      ...
      استقرار برنامه‌های Docker در سیستم‌عامل لینوکس و مک می‌توانید از ابزار{" "}
      <Link href="/app-deploy/docker/cli">Liara CLI</Link> استفاده کنید.
    </Notice>
    ...
    <Link href="/app-deploy/docker/cli">متوجه شدم، برو گام بعدی!</Link>
  </Layout>
);
