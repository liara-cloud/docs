...
export default () => (
  <Layout>
    ...
    <p>
      ...
      نوشته شوند. مثلا اگر در برنامه NodeJS تان با
      ...
      بخواهید از بخش{" "}
      <a href="/app-features/console" target="_blank">
        خط فرمان
      </a>{" "}
      استفاده کنید. که البته توصیه‌ی ما این است که از همان stdout و یا stderr
      استفاده کنید و لاگ‌های مهم‌تر را در فایلی مشخص نیز نگهداری کنید.
    </p>
