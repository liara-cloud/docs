...
export default () => (
    <Layout>
        ...
        ></video>
        <p>
            برای استقرار مستقیم imageهای build شده از DockerHub یا هر
            رجیستری‌های عمومی دیگر در لیارا می‌توانید از پارامتر{' '}
            <span className="code">--image</span> در زمان اجرای دستور{' '}
            <span className="code">liara deploy</span> استفاده کنید.
            روش دیگر این است
            که یک فایل با نام{' '}
            <Link href="/app-deploy/docker/liarajson">liara.json</Link> در مسیر
            اصلی پروژه ایجاد کرده و پس از تنظیم مشخصه‌های مورد نیاز مانند قطعه
            کد زیر، دستور <span className="code">liara deploy</span>
            را اجرا کنید:
        </p>
...
`}
        ...
        <Notice variant="warning">
            ...
            چون با تغییر نسخه‌ی image ممکن است برنامه‌ی شما دچار مشکل شود.
        </Notice>
