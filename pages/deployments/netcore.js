...
export default () => (
  <Layout>
    <Head>
      <title>سرویس ابری لیارا | مستندات استقرار پروژه‌های DotNetCore - ASP.Net Core deployment</title>
    </Head>

    <h1>استقرار پروژه‌های ASP.Net Core</h1>
    <p>
    ...
    <p>
      به‌صورت پیش‌فرض، پروژه‌ی شما روی نسخه‌ی ۳.۱ این پلتفرم اجرا می‌شود.
...
{`{
  "netcore": {
    ...
    <p>
      لیارا به صورت خودکار پکیج‌های پروژه‌ی شما را نصب می‌کند.
