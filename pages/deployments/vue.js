...
export default () => (
  <Layout>
    <Head>
      <title>سرویس ابری لیارا | مستندات استقرار برنامه‌های Vue - Vue deployment</title>
    </Head>

    <h1>استقرار برنامه‌های Vue</h1>
    ...
    <h3>تنظیمات Nginx</h3>
    <p>
      استقرار برنامه‌های Vue، توسط وب‌سرور
      ...
      ایجاد کنید. به‌صورت پیش‌فرض، برای برنامه‌های Vue، این فایل به شکل زیر تعریف شده‌است:
    </p>
    <pre>
      <code>
{`location / {
