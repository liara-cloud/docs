...
export default () => (
  <Layout>
    <Head>
      <title>سرویس ابری لیارا | مستندات استقرار پروژه‌های Vue - Vue deployment</title>
    </Head>

    <h1>استقرار پروژه‌های Vue</h1>
    <p>
      پروژه‌هایی که با
    ...
    <h3>تنظیمات Nginx</h3>
    <p>
      استقرار پروژه‌های Vue، توسط وب‌سرور
      ...
      ایجاد کنید. به‌صورت پیش‌فرض، برای پروژه‌های Vue، این فایل به شکل زیر تعریف شده‌است:
    </p>
    <pre>
      <code>
{`location / {
