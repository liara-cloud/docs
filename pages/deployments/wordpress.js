...
وردپرس با زبان برنامه‌نویسی پی اچ پی نوشته شده و توسط MySQL پشتیبانی می‌شود.
    ...
    <Notice variant="info">
      ...
      برای یک برنامه‌ی وردپرسی تازه طی کنید.
    ...
    <p>
      لیارا به صورت خودکار، تشخیص خواهد داد که برنامه‌ی شما را باید به عنوان یک برنامه‌ی وردپرسی
    ...
    <p>
      و حالا، از طریق بخش برنامه‌ها، روی برنامه‌ی‌تان کلیک کرده و در پنل تنظیمات، موارد زیر را وارد کنید:
    </p>
    <pre>
      <code>
...
{`CREATE DATABASE wordpress;`}
    ...
    <p>
      لیارا به صورت خودکار برای برنامه‌های وردپرسی،
      {' '}
      <Link href="/apps/volumes" title="مستندات Volume">Volume</Link>
      {' '}
      تعریف می‌کند.
...
max_execution_time = 600`}
    ...
    <p>
      ...
      در برنامه‌ی‌تان بسازید و محتویات زیر را داخل آن قرار دهید:
    </p>
    <pre>
      <code>
{`# BEGIN WordPress
