...
location / {
  try_files $uri @django_app;
    ...
    <p>
      ...
      Media
      برنامه‌ی‌تان را به ۲ شیوه ذخیره کنید. اول این که می‌توانید از پوشه‌ی media
      در ریشه‌ی برنامه‌ی‌تان استفاده کنید. ما این روش را برای برنامه‌های بزرگ توصیه نمی‌کنیم، چون مقیاس‌پذیر نیست. اما برای برنامه‌های کوچک و متوسط قابل استفاده است.
      <br />
...
{`{
  "volume": "/usr/src/app/media"
    ...
    <Notice variant="info">
      ریشه‌ی برنامه‌های جنگو در لیارا
