...
export default () => (
  <Layout>
    ...
    <h1>لاگ‌ها</h1>
    <p>
      لاگ‌ها بخش مهمی را در هر برنامه‌ای به عهده دارند. لیارا این امکان را برای‌تان
      فراهم کرده‌است که بعد از مستقر کردن برنامه‌های‌تان بتوانید لاگ‌های آن‌ها را مشاهده و دنبال کنید.
    </p>
    <p>
    ...
    <p>
      ...
      هر لحظه‌ای که برنامه‌ی شما لاگ جدیدی تولید کند، همان لحظه در پنل لیارا آن را مشاهده خواهید کرد.
    </p>
