...
export default () => (
  <Layout>
    ...
    <p>
      ...
      قصد داریم کل دایرکتوری files در Flask را به یک دیسک متصل کنیم تا داده‌های
  ...
  "disks": [
    ...
    <p>
      ...
      فلسک متصل کرده‌ایم. از حالا به بعد هر فایلی داخل دایرکتوری files قرار
  ...
  "disks": [
    ...
    <br />
    <Link href="/apps/flask/domain">متوجه شدم، برو بعدی!</Link>
  </Layout>
);
