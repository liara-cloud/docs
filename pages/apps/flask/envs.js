...
export default () => (
  <Layout>
    ...
    <p>
      شما با ابزارهای مختلفی میتوانید در فریم‌ورک Flask مقادیر ENV ها را مدیریت
...
`}
    ...
    <Notice variant="info">
      البته زبان پایتون و فریم‌ورک Flask برای مدیریت ENV ها ابزارهای بهتری نیز
      دارد که ما در مثال بالا به ساده‌ترین شکل ممکن از آن استفاده کردیم.
    </Notice>
    <br />

    <Link href="/apps/flask/logs">متوجه شدم، برو بعدی!</Link>
  </Layout>
);
