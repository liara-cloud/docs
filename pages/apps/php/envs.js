...
export default () => (
  <Layout>
    ...
    <p>
      ...
      ولی به صورت خیلی ساده و برای نمونه یک ENV از طریق پنل لیارا اضافه میکنیم و
      در سایت نمایش میدهیم. به همین شیوه شما میتوانید از ENV ها در پروژه‌ی‌تان
      استفاده کنید.
    </p>
    <p>
...
`}
    ...
    <p>
      بعد از کلیک روی دکمه <b>ثبت تغییرات</b> برنامه‌ی‌ شما به صورت خودکار ریستارت میشود و در استقرار
      جدید این متغیر‌های محیطی در داخل برنامه قابل استفاده میشوند. به این شیوه
      که LIARA_URL را اضافه کردید میتوانید هر ENV دیگری را نیز به پروژه اضافه
      کنید.
    </p>
    <Link href="/apps/php/logs">متوجه شدم، برو بعدی!</Link>
  </Layout>
);
