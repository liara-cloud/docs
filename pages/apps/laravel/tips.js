...
export default () => (
  <Layout>
    ...
    <p>
      در این بخش تمام نکات تکمیلی برای راه‌اندازی برنامه‌های لاراولی روی لیارا
      آورده شده است. در صورتی که موضوعی وجود دارد که در مستندات به آن اشاره
      نکرده بودیم حتما آن را با ما درمیان بگذارید.
    </p>
  ...
  "laravel": {
    ...
    "routeCache": true
      ...
      <Notice variant="info">
        ...
        <span className="code">"configCache": true</span> استفاده کنید و فیلد
        دیگر را قرار ندهید.
      </Notice>
  ...
  "cron": [
    ...
    <p>
      ...
      <Notice variant="info">
        ...
        Log ها را به چند درایور ارسال کنید. مثلا هم داخل فایل نگه‌داری شود و هم
        به Console ریخته شود تا در پنل لیارا قابل مشاهده باشد. درباره این درایور
        در{" "}
        <a
      ...
      <Notice variant="info">
        در پروژه تستی آموزش راه‌اندازی Laravel در لیارا، از درایور stack برای
        لاگ همزمان داخل فایل و کنسول استفاده شده است. میتوانید{" "}
        <a
