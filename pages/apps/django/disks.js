...
export default () => (
  <Layout>
    ...
    <p>
      ...
      files در Django ذخیره کنید در استقرار بعدی یا ریستارت شدن برنامه، آن فایل
    ...
    <p>
      ...
      قصد داریم کل دایرکتوری files در Django را به یک دیسک متصل کنیم تا داده‌های
      آن همیشه محفوظ باقی‌بماند.
    </p>
    <p>
  ...
  "disks": [
    ...
    <p>
      همانطور که در فایل بالا میبینید، دیسک با شناسه disk1 رو به دایرکتوری files
      در Django متصل کرده‌ایم. از حالا به بعد هر فایلی داخل دایرکتوری files قرار
