...
export default () => (
  <Layout>
    <Head>
      <title>سرویس ابری لیارا | مستندات استقرار برنامه‌های React - React deployment</title>
    </Head>
    ...
    <h3>تنظیمات Nginx</h3>
    <p>
      استقرار برنامه‌های React، توسط وب‌سرور
      ...
      ایجاد کنید. به‌صورت پیش‌فرض، برای برنامه‌های React، این فایل به شکل زیر تعریف شده‌است:
    </p>
    <pre>
      <code>
{`location / {
