...
export default () => (
  <Layout>
    ...
    <h1>ذخیره‌ی داده‌ها</h1>
    <span className="pageDescription">(Volumes)</span>

    <p>
      فایل‌سیستم در لیارا زودگذر و فانی است، این یعنی هر فایلی که در کنار پوشه‌های
      برنامه‌یهای‌تان ذخیره کنید، بعد از یک عملیات استقرار و یا یک ری‌استارت، از بین خواهند رفت.
    ...
    <p>
      ...
      این عمل باعث می‌شود که برنامه‌ی شما مقیاس‌پذیر نباشد و در آینده در صورتی که ترافیک سایت‌تان بالا رفت، ممکن با مشکلاتی مواجه شوید.
      ...
      استفاده کنید تا امکانات بیشتری داشته باشید و همین‌طور برنامه‌ی‌تان آماده‌ی رویارویی با مقیاس و ترافیک بالا باشد.
    </p>
...
{`{
  "volume": "/var/www/html/storage"
    ...
    <p>
      ...
      نگه‌داری می‌کند، پس اگر برنامه‌ی شما دارای پوشه‌ی uploads
