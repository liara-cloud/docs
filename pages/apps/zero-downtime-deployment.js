...
export default () => (
  <Layout>
    <Head>
      <title>سرویس ابری لیارا | مستندات استقرار بدون اختلال - Zero Downtime Deployment</title>
    </Head>
    ...
    <p>
      به صورت پیش‌فرض، همه‌ی برنامه‌هایی که در لیارا ساخته می‌شوند، از قابلیت «استقرار بدون اختلال» بهره می‌برند.
      و این قابلیت به این معناست که برنامه‌ی شما همیشه بالا و در حال اجرا خواهد بود، حتی اگر
      بعد از این که تغییراتی در سورس‌کدتان دادید و استقرار جدیدی برای انتقال آن‌ها به برنامه ایجاد کردید،
    ...
    <p>
      ...
      برنامه تایید می‌شود و ترافیک به روی آن منتقل می‌گردد. در غیر این‌صورت،‌ عملیات استقرار لغو می‌شود.
    </p>

    <p>
      همچنین، لیارا این امکان را فراهم کرده است که به طور زنده، وضعیت برنامک‌های برنامه‌ی‌تان را
      مشاهده کنید. در واقع بعد از این که استقرار جدیدی ایجاد می‌کنید، می‌توانید وارد صفحه‌ی
      «<Link href="/apps/applets">برنامک‌ها</Link>»
    ...
    <p>
      ...
      چک می‌کند تا بتواند «استقرار بدون اختلال» را محقق کند. برای مثال، اگر استقرار جدیدی انجام دهید
    ...
    <p>
      قابلیت «استقرار بدون اختلال» به صورت پیش‌فرض برای برنامه‌های جدید فعال است.
      اگر برنامه‌ی شما قبل از ارائه‌ی این قابلیت ساخته شده است، می‌توانید از صفحه‌ی تنظیمات برنامه فعال‌اش کنید.
    </p>
    <p>
    ...
    <p>
      ...
      استفاده می‌کنید و صلاح می‌دانید که در هر نقطه از زمان، باید تنها یک برنامک از برنامه‌ی‌تان در حال اجرا باشد.
      اگر دیتابیس دلخواهی را در بخش «برنامه‌ها» مستقر کرده‌اید،
      ...
      Docker Image
      این سرویس را از بخش برنامه‌ها دیپلوی کنید و استفاده کنید.
      برای چنین سرویسی، بهتر است که قابلیت «استقرار بدون اختلال» را غیر فعال کنید
