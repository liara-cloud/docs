...
export default () => (
  <Layout>
    ...
    <p>
      به صورت پیش‌فرض، همه‌ی برنامه‌هایی که در لیارا ساخته می‌شوند، از قابلیت «استقرار بدون داون‌تایم» بهره می‌برند.
    ...
    <p>
      قابلیت «استقرار بدون داون‌تایم» به صورت پیش‌فرض برای برنامه‌های جدید فعال است.
