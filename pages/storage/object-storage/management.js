...
export default () => (
  <Layout>
    ...
    <p>
      هر باکت در سرویس فایل دارای سطح دسترسی است. برای مثال، میتوانید برای
    ...
    <ul>
      <li>
        <p>
          ...
          حالت پیشفرض None است. در این حالت تمام ارتباطات برای دانلود یا
          آپلود فایل به باکت‌ها از طریق access key و secret key است.
        </p>
      </li>
