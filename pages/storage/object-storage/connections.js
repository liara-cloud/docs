...
export default () => (
  <Layout>
    <Head>
      <title>مستندات اتصال به آبجکت استوریج - لیارا</title>
    </Head>
...
class Program
{
  ...
  private static async Task MainAsync()
  {
    ...
    <Notice variant="info">
      ...
      اکثر آن‌ها کتابخانه‌های رسمی Amazon S3 است. شما می‌توانید از هر
      کتابخانه‌‌ای که S3 compatible باشد استفاده کنید. همچنین خود تیم MinIO نیز
      SDK هایی برای کار با S3 ارائه کرده است که می‌توانید در مستندات آن‌ها و در
      بخش{" "}
