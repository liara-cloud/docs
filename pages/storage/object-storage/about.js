...
export default () => (
  <Layout>
    <Head>
      <title>مستندات آبجکت استوریج - سرویس ابری لیارا</title>
    </Head>
    ...
    <p>
      ...
      ها می‌توانیم رفتاری شبیه پوشه و دایرکتوری داشته باشیم. مثلا باکت تصاویر
      درست کنیم یا باکت برنامه دانشگاه. هیچ محدودیتی وجود ندارد. باکت‌ها به ما
      کمک می‌کنند که اطلاعات را در ساختاری منسجم‌تر و قابل تفکیک‌تر از نظر
      خودمان ذخیره کنیم.
    </p>
    <p>
