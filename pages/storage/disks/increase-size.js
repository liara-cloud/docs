...
export default () => (
  <Layout>
    <Head>
      <title>مستندات افزایش حجم دیسک‌ها - سرویس ابری لیارا</title>
    </Head>
    ...
    <p>
      در لیارا به سادگی می‌توانید حجم دیسک‌های موجود را افزایش دهید. فرض کنید
      پلن برنامه شما دارای <span className="code">5 GB</span> فضا است. و شما یک
      ...
      <b>تغییر اندازه</b> می‌توانید حجم دلخواه خود را وارد کنید. در لیارا شما
