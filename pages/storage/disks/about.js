...
export default () => (
  <Layout>
    ...
    <p>
      فایل سیستم برنامه‌های لیارا، به طور پیش‌فرض،{" "}
      ...
      وجود ندارد. البته شما می‌توانید فایل‌سیستم لیارا را در قسمت تنظیمات برنامه
      از حالت Read-Only به Writable تغییر بدهید؛ اما تمامی این تغییرات موقتی
      هستند و پس از متوقف شدن برنامه به هردلیلی و اجرای مجدد آن، از بین می‌روند.
    </p>
    <p>
      لیارا امکانی با عنوان «دیسک» دارد که می‌تواند فایل‌های درون پوشه‌هایی که
      شما آن‌ها را مشخص می‌کنید را به صورت دائمی و برای همیشه نگه‌داری کند.
    </p>
    <p>
