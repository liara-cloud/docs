...
export default () => (
  <Layout>
    ...
    <ul className="mt-0">
      ...
      <li>
        <a href="#delete-email">حذف ایمیل</a>
      </li>
      <li>
    ...
    <p>
      ...
      تمام سرورهای ایمیل اعمال شده است. در صورت نیاز، به تعداد ایمیل‌های بیشتر،
      یک گزارش در بخش مالی ایجاد کنید.
    </p>
    ...
    <h3 id="delete-email">حذف ایمیل</h3>

    <p>
    حذف ایمیل‌های غیرضروری، به منظم بودن و جلوگیری از شلوغی و پراکندگی صندوق ورودی و ارسالی کمک می‌کند.
    جهت حذف یک ایمیل، روی آن کلیک کنید، در بالای صفحه دکمه حذف ایمیل مشاهده می‌شود. ایمیل‌های حذف شده به بخش حذف ‌شده‌ها اضافه می‌شوند. 
   همچنین می‌توانید در بخش حذف شده‌ها، یک ایمیل را برای همیشه پاک کنید. درنظر داشته باشید که این عملیات بازگشت ناپذیر است.
   توجه داشته باشید که با حذف یک ایمیل، فقط از صندوق شما حذف می‌شود، ایمیل‌های ارسال شده، در سمت صندوق کاربران قابل حذف نخواهند بود.
    </p>
    ...
    <p>
      ۱. آدرس ایمیل نادرست: پارامتر <span className="code">From</span>
      باید یکی از نشانی‌هایی باشد که در کنسول ایجاد کرده‌اید. اگر آدرس{" "}
      <span className="code">From</span> وارد شده نادرست باشد، پیام تحویل داده
      نخواهد شد.
    </p>
    ...
    <p>
      ...
      است. اگر پيوست شما بيش از حداکثر حجم باشد، پيام شما تحويل داده نخواهد شد.
    </p>
