  ...
  <Layout>
    ...
    <p>
     از تگ‌ها برای دسته‌بندی نوع ایمیل ارسالی و ایجاد گزارشات به کار می‌رود.
      برای مثال، می‌توانید برای ایمیل‌ها، تگ‌‌ خوش‌آمدگویی، کنسل خرید، درخواست بازگشت پول، تمدید حساب کاربری و ... تنظیم کنید و در بخش گزارشات، تعداد ارسال این ایمیل‌ها را بررسی کنید.
      این اطلاعات به کسب‌وکار شما کمک می‌کند تا آمار دقیق‌تری از رفتار مشتریان خود به دست بیاورید. در ادامه نحوه استفاده از تگ در سرویس ایمیل لیارا را بررسی خواهیم کرد.
    </p>

     <h3 id="tag-via-smtp">ارسال تگ با SMTP</h3>

    <p>
    برای تگ گذاری در SMTP client، باید <span className="code">x-liara-tag</span> را در بخش headers تنظیم کنید. در نمونه‌ی زیر، نحوه‌ی تنظیم این هدر را می‌بینید:
    </p>
...
transporter
  ...
  .catch(console.error);`}
    ...
    <p>
    برای ارسال تگ از طریق کنسول لیارا، در بخش تگ، نام تگ مورد نظرتان  را وارد کنید.
    </p>
    ...
    <p>
   در بخش گزارشات ایمیل، می‌توانید تعداد تگ‌های ارسالی در روزهای اخیر را مشاهده کنید. در بخش پایین نمودار، می‌توانید نمایش یک تگ را بسته و یا باز کنید. </p>
