...
export default () => (
  <Layout>
    <Head>
      <title>
        مستندات مدیریت حساب‌های کاربری با استفاده از لیارا CLI - سرویس ابری
        لیارا
      </title>
    </Head>
    ...
    <Asciinema id="452924" />
    <p>
      با اجرای این دستور می‌توانید دستورات مرتبط با مدیریت حساب‌های کاربری را
      مشاهده کنید.
    </p>
    ...
    <Asciinema id="452928" />
    <p>
      این دستور از شما نام انتخابی، موقعیت مکانی، ایمیل و رمز عبور حساب ایجاد
      شده را می‌پرسد.
    </p>

    <h5>
      دستور <span className="code">liara account:add</span> این پارامتر‌ها را
      می‌پذیرد:
    </h5>
    ...
    <Asciinema id="452933" />
    <h5>
      دستور <span className="code">liara account:list</span> یا به اختصار{" "}
      <span className="code">liara account:ls</span> این پارامتر‌ها را می‌پذیرد:
    </h5>
    ...
    <Asciinema id="452934" />
    <h5>
      دستور <span className="code">liara account:remove</span> یا به اختصار{" "}
      <span className="code">liara account:rm</span> این پارامتر‌ها را می‌پذیرد:
    </h5>
    ...
    <Asciinema id="452932" />
    <h5>
      دستور <span className="code">liara account:use</span> این پارامتر‌ها را
      می‌پذیرد:
    </h5>
