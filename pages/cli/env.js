...
export default () => (
    <Layout>
        <Head>
            <title>
                مستندات مدیریت متغیرهای محیطی با استفاده از لیارا CLI -
                سرویس ابری لیارا
            </title>
        </Head>
        ...
        <h5>دستور <span className="code">liara env:list</span> یا به اختصار <span className="code">liara env:ls</span> این پارامتر‌ها را می‌پذیرد:</h5>
        ...
        <h5>دستور <span className="code">liara env:set</span> این پارامتر‌ها را می‌پذیرد:</h5>
        ...
        <h5>دستور <span className="code">liara env:unset</span> این پارامتر‌ها را می‌پذیرد:</h5>
