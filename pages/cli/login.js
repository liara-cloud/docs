...
export default () => (
  <Layout>
    <Head>
      <title>
        مستندات ورود به حساب کاربری با استفاده از لیارا CLI - سرویس ابری لیارا
      </title>
    </Head>
    ...
    <p>
      این دستور از شما موقعیت جغرافیایی، ایمیل و رمز عبوری که با آن در لیارا ثبت
      نام کرده‌اید را می‌پرسد.
    </p>
