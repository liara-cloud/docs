...
export default () => (
  <Layout>
    ...
    <p>
      این دستور از شما نام کاربری و رمز عبوری که با آن در لیارا ثبت نام کرده‌اید
      را می‌پرسد.{" "}
    </p>
    <h5>
    ...
    <ol dir="ltr">
      ...
      <li>&nbsp;&nbsp;--platform</li>
      <p dir="rtl" className="commandDescription">
        ۱۰. مشخص کردن پلتفرم [node, laravel, php, django, flask, dotnet, react,
    ...
    <ol dir="ltr">
      <li>&nbsp;&nbsp;account:add</li>
      <p dir="rtl" className="commandDescription">
        ۱. <Link href="/cli/account/#add">اضافه کردن یک حساب کاربری جدید</Link>
      </p>
      ...
      <p dir="rtl" className="commandDescription">
        ۳.{" "}
        <Link href="/cli/account/#remove">حذف یکی از حساب‌های اضافه شده</Link>
      </p>
