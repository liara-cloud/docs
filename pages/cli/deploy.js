...
export default () => (
    <Layout>
        <Head>
            <title>
                مستندات استقرار برنامه با استفاده از لیارا CLI - سرویس
                ابری لیارا
            </title>
        </Head>
        ...
        <ol dir="ltr">
            ...
            <li>&nbsp;&nbsp;--detach</li>
            <p dir="rtl" className="commandDescription">
                ۷. عدم نمایش لاگ‌ها بعد از هر استقرار
            </p>

            <li>&nbsp;&nbsp;--path</li>
            <p dir="rtl" className="commandDescription">
                ۸. آدرس ریشه پروژه‌ای که قصد استقرار آن را دارید
            </p>

            <li>&nbsp;&nbsp;--platform</li>
            <p dir="rtl" className="commandDescription">
                ۹. مشخص کردن پلتفرم [node, laravel, php, django, flask,
                netcore, react, angular, vue, static, docker]
            </p>

            <li>&nbsp;&nbsp;--port=port</li>
            <p dir="rtl" className="commandDescription">
                ۱۰. مشخص کردن port ای که برنامه شما به آن گوش می‌دهد.
            </p>
