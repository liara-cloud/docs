...
{`Authorization: Bearer TOKEN`}
    ...
    <p>
      برای مثال، برای دریافت لیست برنامه‌ها، ورژن به شکل زیر مشخص می‌شود:
    </p>
    <pre>
      <code>
...
{`{
  "projects": [
    ...
    <p>
      ...
      برابر با صفر باشد، به معنای خاموش‌بودن برنامه است.
    </p>

    <h4>ساخت برنامه‌ی جدید</h4>
    <pre>
      <code>
...
{`{
  ...
  "planID": "nano"
    ...
    <p>
      برنامه‌ها دارای پلن‌های مشخصی هستند که هر کدام از این پلن‌ها، شناسه‌ی یکتای خود را دارد. لیست پلن‌های قابل انتخاب:
    </p>
    ...
    <h4>خاموش یا روشن‌کردن برنامه</h4>
    <pre>
      <code>
...
{`{
  "scale": 1
    ...
    <p>
      برای مثال، اگر قصد خاموش‌کردن برنامه‌ای را با شناسه‌ی
...
{`{
  "scale": 0
    ...
    <p>
      ...
      را اگر برابر صفر قرار دهید، برنامه خاموش‌شده و اگر برابر یک قرار دهید، برنامه روشن می‌شود.
    </p>
...
{`DELETE https://api.liara.ir/v1/projects/:project_id`}
    ...
    <p>
      برای مثال، اگر قصد حذف برنامه‌ای را با شناسه‌ی
      <span className="code">my-app</span>
      دارید، به این صورت باید درخواست دهید:
    </p>
    <pre>
