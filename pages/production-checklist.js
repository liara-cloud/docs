...
export default () => (
    <Layout>
        <Head>
            <title>
                مستندات چک‌لیست Production - سرویس ابری لیارا
            </title>
        </Head>
        ...
        <ul>
            ...
            <li><a href="#useful-features">فعال کردن ویژگی‌های کاربری</a></li>
            <li><a href="#databases">دیتابیس‌ها</a></li>
            <li><a href="#nodejs">برنامه‌های NodeJS</a></li>
            <li><a href="#laravel">برنامه‌های Laravel</a></li>
            <li><a href="#django">برنامه‌های Django</a></li>
            <li><a href="#wordpress">برنامه‌های WordPress</a></li>
        </ul>

        <h3 id="notifications">اعلان‌ها</h3>
        <p>
            در صفحه‌ی <a href="https://console.liara.ir/settings/notifications">تنظیم اعلان</a>، مسیرهای اطلاع رسانی مختلف را برای دریافت اعلان‌ها فعال کرده و همچنین مقدار حداقل اعتبار را نسبت به هزینه‌ی سرویس‌های فعلی خود، افزایش دهید.
        </p>
        ...
        <h3 id="useful-features">فعال کردن ویژگی‌های کاربری</h3>
        <p>
        ...
        <p>
            به‌منظور بالا بردن سطح امنیت کسب و کار خود می‌توانید دسترسی به دیتابیس از طریق شبکه‌ی عمومی را غیرفعال کرده و از مزایای <Link href="/app-features/private-network">شبکه‌ی خصوصی</Link> بهره‌مند شوید.
        </p>

        <h3 id="nodejs">برنامه‌های NodeJS</h3>
        <p>
            توجه داشته باشید که مقدار <span className="code">NODE_ENV</span> در متغیرهای محیطی برنامه‌‌های <Link href="/app-deploy/nodejs/getting-started">NodeJS</Link> برابر با <span className="code">production</span> باشد.
        </p>
        ...
        <p>
            توجه داشته باشید که مقدار <span className="code">DEBUG</span> در متغیرهای محیطی برنامه‌‌های <Link href="/app-deploy/django/getting-started">Django</Link> برابر با <span className="code">false</span> باشد.
        </p>
