...
export default () => (
  <Layout>
    ...
    <code>
      {`$ mysqldump -u root -pL6pcNH1fhgQXdlN --host s3.liara.ir --port 34595 --single-transaction --quick --add-drop-database --lock-tables=false --databases liaraDB > liaraDB.sql`}
    </code>
  </Layout>
);
