...
export default () => (
  <Layout>
    <Head>
      <title>مستندات تهیه فایل پشتیبان از دیتابیس‌های MySQL - لیارا</title>
    </Head>
    ...
    <ZoomableImage
      src="https://files.liara.ir/docs/mysql/backup.gif"
      alt="mysql backup page"
    />

    <br />

    <Link href="/databases/mysql/restore" className="next-page">
