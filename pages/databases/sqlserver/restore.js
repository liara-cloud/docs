...
export default () => (
  <Layout>
    ...
    <p>
      ...
      در <Link href="/buckets/about">ذخیره‌سازی ابری</Link> آپلود کرده و درنهایت
      آدرس مستقیم فایل پشتیبان را در این قسمت وارد کنید. لیارا به‌صورت خودکار
      فایل پشتیبان را در مسیر <span className="code">/var/opt/mssql/data</span>{" "}
      قرار می‌دهد و شما می‌توانید با استفاده از ابزار SSMS (SQL Server
