...
export default () => (
  <Layout>
    <Head>
      <title>مستندات نصب و راه‌اندازی دیتابیس‌های MariaDB - لیارا</title>
    </Head>
    ...
    <video
      src="https://files.liara.ir/liara/mariadb/create-mariadb.mp4"
      controls="controls"
    ...
    <p>
      برای راه‌اندازی دیتابیس MariaDB باید در بخش{" "}
      ...
      پس از انتخاب دیتابیس MariaDB، نسخه‌ی مورد نظر خود را انتخاب کرده و همچنین
    ...
    <Link href="/databases/mariadb/connections" className="next-page">
