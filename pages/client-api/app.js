...
export default () => (
    <Layout>
        ...
        <h4>فهرست عناوین:</h4>
        <ul className="mt-0">
            <li><a href="#create-app">ایجاد برنامه</a></li>
            <li><a href="#remove-app">حذف برنامه</a></li>
            <li><a href="#start-app">روشن کردن برنامه</a></li>
            <li><a href="#stop-app">خاموش کردن برنامه</a></li>
            <li><a href="#update-environment-variable">به‌روزرسانی متغیرهای برنامه</a></li>
            <li><a href="#resize-app">تغییر اندازه برنامه</a></li>
            <li><a href="#get-app-details">دریافت مشخصات یک برنامه مشخص</a></li>
            <li><a href="#get-apps-list">دریافت مشخصات تمام برنامه‌ها</a></li>
        </ul>
        ...
        <div className="endpoint">
            ...
            <span className="endpoint__path">/v1/projects/<span className="endpoint__param">{`{app-name}`}</span></span>
        </div>
        ...
        <div className="endpoint">
            <Label variant="blue">POST</Label>
            <span className="endpoint__path">/v1/projects/<span className="endpoint__param">{`{app-name}`}</span>/actions/scale</span>
        </div>
        ...
        <div className="endpoint">
            <Label variant="blue">POST</Label>
            <span className="endpoint__path">/v1/projects/<span className="endpoint__param">{`{app-name}`}</span>/actions/restart</span>
        </div>
        ...
        <div className="endpoint">
            <Label variant="blue">POST</Label>
            <span className="endpoint__path">/v1/projects/<span className="endpoint__param">{`{app-name}`}</span>/resize</span>
        </div>
