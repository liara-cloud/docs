...
export default () => (
  <Layout>
    ...
    <ul className="mt-0">
      <li>
        <a href="#create-database">راه‌اندازی دیتابیس</a>
      </li>
      <li>
        <a href="#remove-database">حذف دیتابیس</a>
      </li>
      <li>
        <a href="#start-database">روشن کردن دیتابیس</a>
      </li>
      <li>
        <a href="#stop-database">خاموش کردن دیتابیس</a>
      </li>
      <li>
        <a href="#resize-database">تغییر اندازه دیتابیس</a>
      </li>
      <li>
        <a href="#create-backup">ایجاد فایل پشتیبان</a>
      </li>
      <li>
        <a href="#backups-list">لیست تمام فایل‌های پشتیبان</a>
      </li>
      <li>
        <a href="#download-backup">دریافت فایل پشتیبان</a>
      </li>
      <li>
        <a href="#get-database-details">دریافت مشخصات یک دیتابیس مشخص</a>
      </li>
      <li>
        <a href="#databases-list">دریافت مشخصات تمام دیتابیس‌ها</a>
      </li>
    </ul>
    ...
    <div className="endpoint">
      ...
      <span className="endpoint__path">
        /v1/databases/<span className="endpoint__param">{`{database-id}`}</span>
        /backups/<span className="endpoint__param">{`{backups-name}`}</span>
        /download
      </span>
    </div>
