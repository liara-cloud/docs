...
export default () => (
    <Layout>
        ...
        <h4>فهرست عناوین:</h4>
        <ul className="mt-0">
            <li><a href="#add-domain">افزودن دامنه</a></li>
            <li><a href="#remove-domain">حذف دامنه</a></li>
            <li><a href="#get-domain-details">دریافت مشخصات یک دامنه</a></li>
            <li><a href="#point-domain-to-an-app">اتصال دامنه به یک برنامه مشخص</a></li>
            <li><a href="#ssl-activation">صدور گواهی SSL</a></li>
            <li><a href="#ssl-deactivation">غیرفعال کردن گواهی SSL</a></li>
            <li><a href="#domains-list">مشاهده‌ی تمام دامنه‌ها</a></li>
        </ul>
        ...
        <div className="endpoint">
            ...
            <span className="endpoint__path">/v1/domains/<span className="endpoint__param">{`{domain-id}`}</span></span>
        </div>
        ...
        <div className="endpoint">
            ...
            <span className="endpoint__path">/v1/domains/<span className="endpoint__param">{`{domain-name}`}</span></span>
        </div>
        ...
        <div className="endpoint">
            <Label variant="blue">POST</Label>
            <span className="endpoint__path">/v1/domains/<span className="endpoint__param">{`{domain-id}`}</span>/ssl/disable</span>
        </div>
