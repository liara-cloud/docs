...
export default () => (
  <Layout>
    ...
    <p>
      هر برنامه‌ای ممکن است در محیط‌های مختلفی اجرا شود.
      برای مثال برنامه‌ی شما علاوه بر این که در حالت
      development
    ...
    <p>
      اگر چه که همه‌ی این محیط‌ها یک برنامه را اجرا می‌کنند، اما معمولا هر کدام از آن‌ها دارای متغیرهایی برای
      کانفیگ برنامه در آن محیط هستند.
      برای نمونه، برنامه‌ی شما در کامپیوتر‌تان ممکن است به دیتابیس لوکال‌تان متصل شود
    ...
    <p>
      ...
      جهت ذخیره‌ی متغیرها باشد، اما در لیارا نیازی به این فایل نیست و از بخش تنظیمات هر برنامه
      می‌توانید متغیرهای موردنظرتان را تعریف کنید.
      (اگرچه میتوانید با آپلود فایل<span className="code">.env</span> پروژه‌ی‌تان همه‌ی ENV ها را به لیارا منتقل کنید.)
     </p>
