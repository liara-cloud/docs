...
export default () => (
  ...
  "healthCheck": {
    ...
    <Notice>
      ...
      استفاده کرده‌ایم. این دستور به این صورت عمل می‌کند که یا وب‌سرور شما
      Status 200 برمیگرداند و در نتیجه curl با کد 0 خارج می‌شود (عملیات
      موفقیت‌آمیز) و یا این که وب‌سرور شما Status 200 برنمیگرداند و curl با کد 0
      خارج نمی‌شود و قسمت بعد از || یا همان exit 1 اجرا می‌شود. (عملیات
      غیرموفقیت‌آمیز)
    </Notice>
    ...
    <p>
      ...
      مقدار برابر با ۳۰ ثانیه است، و این یعنی اولین تست سلامت در ثانیه‌ی ۳۵
      انجام می‌گردد. (۵ + ۳۰ = ۳۵)
    </p>
    <p>
