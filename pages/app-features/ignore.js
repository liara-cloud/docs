...
export default () => (
  <Layout>
    ...
    <p>
      ...
      Liara CLI بدون در نظر گرفتن این‌که شما پوشه‌های زیر را در{" "}
      <span className="code">.gitignore</span>
      قرار داده‌اید یا خیر، از آن‌ها صرف نظر می‌کند و این پوشه‌ها و فایل‌ها به
      سرور آپلود نمی‌شوند:
    </p>
    ...
    <p>
      در پلتفرم ASP.Net Core، پوشه‌های زیر علاوه‌بر پوشه‌های بالا، به‌صورت
    ...
    <p>
      ...
      قصد دارید که Liara CLI پوشه‌ی{" "}
      <span className="code">bower_components</span>
      را حتما آپلود کند، باید چنین خطی را به{" "}
      <span className="code">.gitignore</span>
      اضافه کنید:
    </p>
    <pre>
    ...
    <p>
      در واقع، علامت تعجبی که در ابتدای نام پوشه قرار دارد، عملکرد ignore را عکس
      می‌کند و آن پوشه را حتما به لیست آپلود اضافه می‌کند و از لیست ignore
      پیش‌فرض خارج می‌کند.
    </p>
    <Notice variant="warning">
      پیشنهاد می‌کنیم هیچ‌وقت <span className="code">node_modules</span>
      را به‌سرور آپلود نکنید. چرا که سرعت استقرار را بسیار کند خواهد کرد و ممکن
      است حتی عملیات استقرار با خطا مواجه شود.
    </Notice>
  </Layout>
);
