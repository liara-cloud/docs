...
export default () => (
  <Layout>
    ...
    <ZoomableImage src="/static/console-2.png" alt="صفحه‌ی خط فرمان" />
    <p>
    ...
    <ZoomableImage src="/static/console-1.png" alt="صفحه‌ی ترمینال" />

    <h3>چرا اتصال من به خط فرمان مدام قطع می‌شود؟</h3>
    <p>
      برای این‌که بتوانید به‌خط فرمان وصل شوید، برنامه‌ی شما باید روشن و در حال
      اجرا باشد. حتما بخش <Link href="/app-features/applets">برنامک‌ها</Link> را
      بررسی کنید. چنانچه برنامه‌ی شما مدام در حال crash کردن و ری‌استارت‌شدن
    ...
    <p>
      ...
      پلتفرم <Link href="/app-deploy/docker/getting-started">Docker</Link>،
      هرگونه شخصی‌سازی‌ای که نیاز دارید را انجام دهید و پکیج‌های مدنظرتان را نصب
      کنید.
    </p>
  </Layout>
);
