...
export default () => (
  <Layout>
    ...
    <p>
      ...
      لیارا ترافیک ورودی برنامه‌ی‌تان را به سمت برنامک‌های در حال اجرا هدایت می‌کند.
    </p>
    <p>
      در صورتی که یک برنامک خاموش شود و یا کرش کند، لیارا به صورت خودکار برنامک جدیدی را
      ایجاد می‌کند تا همیشه برنامه‌ی شما در حال سرویس‌دهی باشد.
      خاموش‌کردن یک برنامه در پنل لیارا، باعث می‌شود که تمام برنامک‌های آن برنامه خاموش و حذف شوند. 
      ری‌استارت‌کردن یک برنامه، باعث می‌شود که برنامک «در حال اجرای» فعلی حذف شده و برنامک جدیدی ایجاد شود.
      روشن‌کردن یک برنامه، باعث می‌شود که دست کم یک برنامک «در حال اجرا» ساخته شود.
    </p>
    <p>
    ...
    <p>
      همان‌طور که در تصویر بالا مشاهده کنید، هر برنامک، حاوی نسخه‌ای از برنامه‌ی شما می‌باشد.
