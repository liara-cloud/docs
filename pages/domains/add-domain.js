...
export default () => (
  <Layout>
    ...
    <p>
      برای خرید دامنه، در حال حاضر سرویس‌های مختلفی وجود دارند که با قیمت مناسبی
      امکان خرید دامنه را برای‌تان فراهم می‌کنند. برای سرویس DNS هم همین‌طور.
      در حال حاضر، برنامه‌ی ما این است که سرویس‌هایی را ارائه دهیم که کمبود آن‌ها احساس می‌شود.
