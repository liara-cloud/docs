...
export default () => (
  <Layout>
    ...
    <ul>
      ...
      <p>
        لیست IP ها: (میتوانید از هر IP که تمایل دارید برای ساخت رکورد A استفاده
        کنید.)
      </p>
      <pre>
        <code>
      ...
      <Notice variant="info">
        ...
        میکند یا خیر. مثلا Cloudflare پشتیبانی میکند. برای کسب اطلاعات بیشتر از
    ...
    <p>
      ...
      اختصاصی استفاده کنید میتوانید طبق مراحل بالا یک دامنه به لیارا اضافه کنید
    ...
    <p>
      ...
      <span className="code">.ir</span> به‌روز می‌شوند. در صورتی که بعد از طی این
      مدت، باز هم مورد رفع نشد، با پشتیبانی لیارا ارتباط بگیرید.
    </p>
    <Notice variant="info">
      برای مشاهده وضعیت DNS های دامنه‌ی‌تان در سراسر جهان، میتوانید از وبسایت{" "}
