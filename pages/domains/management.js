...
export default () => (
  <Layout>
    ...
    <ul>
      ...
      <p>
        سپس در صفحه‌ای که باز می‌شود کافیست نامه دامنه را وارد کنید و انتخاب
        کنید که آیا میخواهید به سرویس فایل وصل شود یا به برنامه. فرض می‌کنیم
      ...
      <Notice variant="info">
        در صورتی که از رکوردهای A استفاده می‌کنید می‌توانید از قابلیت Round
        Robin DNS یا همان تقسیم بار بین سرور‌ها در لایه DNS بهره ببرید. البته
        این موضوع وابسته به این است که سرویس دهنده DNS شما این قابلیت را
        پشتیبانی می‌کند یا خیر. برای مثال، Cloudflare پشتیبانی می‌کند. برای کسب
        اطلاعات بیشتر از تاثیرات مثبت و منفی این قابلیت، در وبلاگ Cloudflare{" "}
        <a
      ...
      <p>
        بعد از انجام مراحل بالا، داخل پنل مدیریت دامنه‌های لیارا شوید و روی دکمه
