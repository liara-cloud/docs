...
export default () => (
    <Layout>
        ...
        <p>
            ...
            <Link href="/app-features/email#settings">دسترسی SMTP</Link> وجود
            دارد که پیشنهاد ما استفاده از{' '}
            <a
        ...
        <Notice variant="warning" style={{marginBottom: 8}}>
            قابل ذکر است که فیلد <span className="code">From Email</span> باید
            یکی از نشانی‌های اضافه شده در سرویس ایمیل باشد.
        </Notice>
        ...
        <p>
            و در نهایت اطلاعات دسترسی SMTP را در تنظیمات وارد کرده و
