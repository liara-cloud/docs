...
export default () => (
    <Layout>
        <Head>
            <title>مستندات اتصال دامنه به برنامه‌های WordPress - سرویس ابری لیارا</title>
        </Head>
        ...
        <p>
            اما در مواردی که نیاز است دامنه‌ی اختصاصی خود را به برنامه متصل کنید باید طبق مستندات <Link href="/domains/management#add-domain">اضافه‌کردن دامنه‌</Link> عمل کرده و سپس در تنظیمات عمومی سیستم مدیریت محتوای WordPress مقادیر <b>نشانی وردپرس (URL)</b> و <b>نشانی سایت (URL)</b> را با آدرس دامنه‌ی اختصاصی خود جایگزین کنید.
        </p>
    </Layout>
);
