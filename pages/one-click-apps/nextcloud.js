...
export default () => (
    <Layout>
        ...
        <p>
            Nextcloud ابزاری متن باز است که با استفاده از آن می‌توانید یک فضای ذخیره‌سازی ابری مانند Google Drive و Dropbox را راه‌اندازی و مدیریت کنید.
        ...
        <h3>نصب و اجرا</h3>
        <p>
            برای راه‌اندازی فضای ابری Nextcloud کافیست این برنامه را از بخش برنامه‌های آماده انتخاب کرده و شناسه مورد نظرتان را وارد کنید. درنهایت زمانیکه بر روی دکمه‌ی <b>ایجاد برنامه</b> کلیک کردید، لیارا به‌طور خودکار یک دیتابیس MySQL راه‌اندازی و برنامه‌ی شما را به آن متصل می‌کند بنابراین نیازی نیست که شما درگیر نصب و پیکربندی دیتابیس شوید.
        </p>
        ...
        <Notice variant="info">
            ...
            مراجعه کرده و طبق مستندات، دامنه‌ اختصاصی مورد نظرتان را به برنامه متصل کنید.
        </Notice>
    </Layout>
);
