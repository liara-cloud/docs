...
export default () => (
  <Layout>
    ...
    <h4>
      تنظیم متغیرهای <span className="code">DEFAULT_APP_ID</span>،{" "}
      <span className="code">DEFAULT_APP_KEY</span>،{" "}
      <span className="code">DEFAULT_APP_SECRET</span>
    </h4>
    <p>
      شما در قدم اول به دو متغیر ایمن برای مقداردهی متغیرهای{" "}
      <span className="code">DEFAULT_APP_KEY</span> و{" "}
      <span className="code">DEFAULT_APP_SECRET</span> نیاز دارید بنابراین وارد
      صفحه‌ی{" "}
    ...
    <p>
      در مرحله‌ی بعد وارد تب برنامه‌ها شده و برنامه‌ی Pusher خود را انتخاب کنید.
      اکنون باید متغیرهای کپی شده را در بخش <b>تنظیمات متغیرها</b> در فیلدهای
      مربوطه قرار دهید و درنهایت بر روی دکمه‌ی <b>ثبت تغییرات</b> کلیک کنید.
    </p>
