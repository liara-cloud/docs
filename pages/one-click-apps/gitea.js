...
export default () => (
  <Layout>
    ...
    <p>
      ...
      می‌توانید انتخاب کنید که به صورت خودکار دیتابیس توسط لیارا ایجاد شود یا این
      ...
      را بسیار ساده و سریع‌تر می‌کند و همچنین به صورت خودکار برنامه Gitea شما به
      دیتابیس‌ متصل می‌شود و شما می‌توانید به صورت مستقیم بدون درگیری با بخش‌های
