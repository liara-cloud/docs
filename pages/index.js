...
const Index = () => (
  <Layout>
    ...
    <Seo
      ...
      desc="راهنمای استفاده از خدمات سرویس ابری لیارا"
      keyWords="استقرار پروژه نود جی اس، استقرار پروژه لاراول، استقرار پروژه جنگو، استقرار پروژه ری‌اکت، استقرار پروژه نکست جی اس"
    />
