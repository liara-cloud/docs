...
const Index = () => (
  <Layout>
    ...
    <p>
      ...
      تنظیمات، با نهایت سرعت، آسودگی و راحتی، پروژه‌ی خود را روی سرور اجرا کنید.
    </p>

    <h3>پلتفرم‌هایی که پشتیبانی می‌کنیم</h3>
    <p>
      برای مطالعه‌ی راهنمای اجرای پروژه در هر پلتفرم، صفحه‌ی مربوط به آن را
      دنبال کنید.
    </p>
    ...
    <h3>پلتفرم‌های آماده‌ای که ارائه می‌کنیم</h3>
    <p>
      برای مطالعه‌ی راهنمای نصب و راه‌اندازی هر پلتفرم آماده، صفحه‌ی مربوط به آن
      را دنبال کنید.
    </p>
    <div className="platforms">
