...
export default () => (
  <Layout>
    <Head>
      <title>
        انتقال فایل‌ها از سرویس فایل به فضای ذخیره‌سازی ابری - سرویس ابری لیارا
      </title>
    </Head>
    ...
    <p>
      ...
      می‌توانید به داده‌ها و فایل‌های‌تان در فضای ذخیره‌سازی ابری دسترسی پیدا
      کنید.
    </p>
  </Layout>
);
