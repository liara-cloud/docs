...
برای انتقال فایل‌های درون یک باکت به یک باکت دیگر در یک اکانت، در ابتدا کافیست تا برنامه Rclone را از صفحه <a href="https://rclone.org/downloads/" className="blue-link">Downloads</a> متناسب با سیستم عامل خود، دانلود کنید. در قدم بعد باید با اجرای دستور <Important>rclone config</Important> یک <Important>remote</Important> جدید را پیکربندی کنید:
