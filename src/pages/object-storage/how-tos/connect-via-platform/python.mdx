...
<video
  src="https://media.liara.ir/python/object-storage.mp4"
  controls="controls"
...
<p>
پروژه و کدهای مورد استفاده در ویدیوی فوق در <a href="https://github.com/liara-cloud/python-getting-started/tree/object-storage" className="text-[#2196f3] ">اینجا</a> قابل مشاهده و دسترسی هستند.
</p>
</Alert>
