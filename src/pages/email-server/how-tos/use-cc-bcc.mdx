...
<HighlightTabs
  tabs={[
    ...
    {
      label: "Laravel",
      icon: <PlatformIcon platform="laravel" style={{ width: 32, height: 32 }} />,
      language: "laravel",
      code: `// routes/web.php
<?php
...
`
    ...
    {
      label: "Django",
      icon: <PlatformIcon platform="django" style={{ width: 32, height: 32 }} />,
      language: "py",
      code: `# views.py
...
`
    ...
    {
      label: "Flask",
      icon: <PlatformIcon platform="flask" style={{ width: 32, height: 32 }} />,
      language: "py",
