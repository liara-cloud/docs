...
<p>
پروژه و کدهای مورد استفاده در ویدیوی فوق در <a href="https://github.com/liara-cloud/laravel-getting-started/tree/emailserver" className="text-[#2196f3] ">اینجا</a> قابل مشاهده و دسترسی هستند.
</p>
</Alert>
