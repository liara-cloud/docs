...
<Layout>
<Head>
<title>مستندات استقرار سریع برنامه‌های Laravel - لیارا</title>
<meta property="og:title" content="مستندات خدمات رایانش ابری لیارا" />
<meta property="og:description" content="مستندات مربوط به استقرار سریع برنامه‌های Laravel در لیارا"  />
</Head>

# استقرار سریع برنامه‌های Laravel
<hr className="mb-2" />
...
<Tabs 
  ...
  content={[
   <>
  <video
  src="https://media.liara.ir/laravel/laravel-desktop.mp4"
  controls="controls"
  ...
  <Step  steps={[
{
  ...
  <>
    <h3>ایجاد برنامه</h3>
    <p>برنامه Laravel خود را با شناسه، <Link className="text-[#2196f3] " href="../details/private-network">شبکه خصوصی</Link> و <Link className="text-[#2196f3] " href="../details/plans/about">منابع سخت‌افزاری و بسته امکانات</Link> مدنظرتان ایجاد کنید.</p>
  </>
  )
  },
  {
  ...
  <>
    ...
    <p>پوشه‌ها و فایل‌های درون پروژه که قصد ندارید در لیارا آپلود شوند (به عنوان مثال پوشه‌های node_modules و vendor) را پاک کنید.</p>  
  </>
  )
  },
  {
  ...
  <>
    ...
    <p>حتماً باید در مسیر اصلی پروژه، فایل <Important>composer.json</Important> وجود داشته باشد؛ همچنین بهتر است
  ...
  <>
  <video
  src="https://media.liara.ir/laravel/laravel-cli.mp4"
  controls="controls"
  className="block w-full"
  width="100%"
  ></video>
  ...
  <Step  steps={[
{
  ...
  <>
    <h3>ایجاد برنامه</h3>
    <p>با اجرای دستور زیر، برنامه Laravel خود را ایجاد کنید:</p>
    <div dir='ltr'>
    <Highlight className="bash">
      {`liara create`}
    </Highlight>
    ...
    <p>در ادامه اجرای این دستور، باید به ترتیب، شناسه، نوع پلتفرم (که باید بر روی laravel تنظیم شود)، شبکه خصوصی و <Link className="text-[#2196f3] " href="../details/plans/about">منابع سخت‌افزاری و بسته امکانات برنامه</Link>، مشخص شوند.</p>
  </>
  )
  },
  {
...
/public/storage`}
  ...
  <>
    ...
    <div dir='ltr'>
    <Highlight className="bash">
      {`liara deploy --app=myapp --platform=laravel`}
    </Highlight>
    </div>
    <div className="h-2" />
    <p>
    ...
    <div dir='ltr'>
    <Highlight className="bash">
      {`liara deploy --app=myapp --platform=laravel --team-id=your-unique-team-id`}
    </Highlight>
    </div>
  </>
  )
  ...
  <>
    <video
  src="https://media.liara.ir/docs/laravel-github.mp4"
  controls="controls"
  className="block w-full"
  width="100%"
  ></video>
...
<Alert variant="info">
<p>
لیارا با اجرای دستور <Important>composer install</Important> تمامی ماژول‌های موجود در فایل <Important>composer.json</Important> را نصب می‌کند. پس حتماً اسامی آن‌ها باید در این فایل باشد.
</p>
</Alert>
<div className="h-1" />
...
<Alert variant="success">
<p>
همچنین بخوانید: <Link className="text-[#2196f3] " href="./how-tos/create-app">استقرار قدم به قدم برنامه‌های Laravel در لیارا</Link>
</p>
</Alert>
</Layout>