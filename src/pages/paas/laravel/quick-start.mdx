  ...
  <Step  steps={[
{
  ...
  <>
    <h3>ایجاد برنامه</h3>
    <p>برنامه Laravel خود را با شناسه، <Link className="blue-link" href="../details/private-networks.md">شبکه خصوصی</Link> و <Link className="blue-link" href="../details/plans/about">پلن‌های نرم‌افزاری و سخت‌افزاری</Link> مدنظرتان ایجاد کنید.</p>
  </>
  )
  },
  {
  ...
  <Step  steps={[
{
  ...
  <>
    ...
    <p>در ادامه اجرای این دستور، باید به ترتیب، شناسه، نوع پلتفرم (که باید بر روی laravel تنظیم شود)، شبکه خصوصی و <Link className="blue-link" href="../details/plans/about">پلن‌های نرم‌افزاری و سخت‌افزاری برنامه</Link>، مشخص شوند.</p>
  </>
  )
  },
  {
...
<p>
همچنین بخوانید: <Link className="blue-link" href="./how-tos/create-app">استقرار قدم به قدم برنامه‌های Laravel در لیارا</Link>
</p>
</Alert>
</Layout>