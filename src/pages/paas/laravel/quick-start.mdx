  ...
  <Step  steps={[
{
  ...
  <>
    ...
    <p>در ادامه اجرای این دستور، باید به ترتیب، شناسه، نوع پلتفرم (که باید بر روی next تنظیم شود)، شبکه خصوصی و <Link className="blue-link" href="../details/plans/about">پلن‌های نرم‌افزاری و سخت‌افزاری برنامه</Link>، مشخص شوند.</p>
  </>
  )
  },
  {
