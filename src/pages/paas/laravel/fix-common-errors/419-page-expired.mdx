...
برای رفع این مشکل، یکی از راه حل‌ها این است که طبق <a href="/paas/details/envs/about" className="text-[#2196f3] ">مستندات تنظیم متغیرهای محیطی</a> ،متغیر <Important>SESSION_DRIVER</Important> را با مقدار زیر، به برنامه خود اضافه کنید:
<div className="h-2" />
<div dir='ltr'>
    <Highlight className="bash">
