...
<meta property="og:description" content="مستندات مربوط به نحوه استقرار برنامه Laravel در لیارا"  />
</Head>
...
`}
        ...
        {/* <div className="h-4" />
        <img src="https://media.liara.ir/docs/deploy-laravel-app-using-console.gif" alt="build app on liara" />
        <div className="h-4" /> */}
        <p>
...
`}
    ...
    "composerMirror": false
       ...
       <Section id="liara-json-version" title="تعیین نسخه PHP" />
    ...
    "laravel": {
      "phpVersion": "8.3"
        ...
        <div className='h-4' />
        <Alert variant='success'>همچنین بخوانید:  <a className="text-[#2196f3] " href="../choose-version">نسخه‌های قابل ارائه php و Laravel در لیارا</a></Alert>
    ...
    "laravel": {
      "timezone": "America/Los_Angeles"
        ...
        <Section id="liara-json-buildassets" title="پارامتر buildAssets" />
        <p>
    ...
    "laravel": {
       "buildAssets": false
        ...
        <Section id="liara-json-require-dev" title="نصب devDependencies" />
        <p>
  ...
  "laravel": {
    "installDevDependencies": true
        ...
        <Section id="liara-json-cache" title="اعمال کش" />
        <p>
...
`}
    ...
    <>
    <p>
            پس از <a className='text-[#2196f3] ' href="../create-app">ساخت برنامه</a>، باید در مسیر اصلی پروژه، یک فایل به نام <Important>gitignore.</Important> ایجاد کنید و درون آن، اسامی تمامی فایل‌ها یا پوشه‌هایی که قصد ندارید در لیارا آپلود شوند را، وارد کنید؛ به عنوان مثال، نیازی به آپلود دایرکتوری‌های node_modules و vendor به همراه محتوای آن‌ها نیست؛ چرا که لیارا در حین استقرار برنامه، آن‌ها را برای شما می‌سازد؛ پس بایستی اسامی این دایرکتوری‌ها در فایل فوق، نوشته شود؛ قطعه کد قرار گرفته در لینک زیر، یک <Important>gitignore.</Important> عالی برای برنامه‌های Laravel است که می‌توانید از آن، استفاده کنید:
        </p>
        <div className="h-2" />
        <Link href="https://github.com/liara-cloud/gitignore-templates/blob/master/laravel/.gitignore" target="_blank">
            <Card className="flex cursor-pointer w-full items-center justify-between">
