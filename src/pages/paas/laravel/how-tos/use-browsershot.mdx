    ...
    step: "۶",
        content: (
            <>
                ...
                <p>
                    در نهایت، با استفاده ازاجرای دستور زیر، برنامه لاراولی خود را در پلتفرم لاراول لیارا مستقر کنید (حتماْ موقعیت بیلد را بر روی <Important>germany</Important> تنظیم کنید):
                </p> 
                <div className="h-2" />
                <div dir='ltr'>
                    <Highlight className="js">
