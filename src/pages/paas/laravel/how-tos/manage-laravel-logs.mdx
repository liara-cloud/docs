...
<div className="h-2" />
در لیارا، لاراول به صورت خودکار برای مدیریت لاگ‌ها از درایور <Important>errorlog</Important> استفاده می‌کند. اگر که قصد تغییر این درایور را دارید؛ کافیست تا متغیر محیطی <Important>LOG_CHANNEL</Important> را طبق مستندات <a href="../../details/envs" className="text-[#2196f3] ">تنظیم متغیرهای محیطی</a> تغییر دهید. به عنوان مثال:
<div className="h-2" />
<div dir='ltr'>
...
<a href="../../details/envs" className="text-[#2196f3] ">مستندات تنظیم متغیرهای محیطی</a>، متغیر <Important>LOG_CHANNEL</Important> را به شکل زیر، تغییر دهید:
<div className="h-2" />
<div dir='ltr'>
        <Highlight className="bash">
            {`LOG_CHANNEL=stack`}
