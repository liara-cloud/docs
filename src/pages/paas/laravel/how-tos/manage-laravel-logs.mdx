...
<div className="h-2" />
در لیارا، لاراول به صورت خودکار برای مدیریت لاگ‌ها از درایور <Important>errorlog</Important> استفاده می‌کند. اگر که قصد تغییر این درایور را دارید؛ کافیست تا متغیر محیطی <Important>LOG_CHANNEL</Important> را طبق مستندات <a href="../../details/envs" className="blue-link">تنظیم متغیرهای محیطی</a> تغییر دهید. به عنوان مثال:
<div className="h-2" />
<div dir='ltr'>
