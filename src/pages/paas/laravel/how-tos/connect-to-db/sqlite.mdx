...
<Step  steps={[
    ...
    <>
            ...
            <p>
              در ابتدا، بایستی طبق <a href="../../../details/envs" className="text-[#2196f3] ">مستندات تنظیم متغیرهای محیطی</a>، متغیرهای محیطی مربوط به دیتابیس خود را، به برنامه اضافه کنید؛ به عنوان مثال:
            </p>
            <div dir='ltr'>
...
DB_DATABASE=/var/www/html/database/database.sqlite`}
    ...
    <>
            ...
            <p>همچنین بخوانید: <a href="../use-hooks" className="text-[#2196f3] ">استفاده از Hookها در لاراول</a></p>
            </Alert>
