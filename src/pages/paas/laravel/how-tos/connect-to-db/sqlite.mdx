...
<Step  steps={[
    ...
    <>
            ...
            <p>
              در ابتدا، بایستی طبق <a href="../../../details/envs" className="blue-link">مستندات تنظیم متغیرهای محیطی</a>، متغیرهای محیطی مربوط به دیتابیس خود را، به برنامه اضافه کنید؛ به عنوان مثال:
            </p>
            <div dir='ltr'>
