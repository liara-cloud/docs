...
<Layout>
<Head>
<title>مستندات اتصال به دیتابیس در Laravel - لیارا</title>
<meta property="og:title" content="مستندات خدمات رایانش ابری لیارا" />
<meta property="og:description" content="مستندات مربوط به نحوه اتصال به دیتابیس‌های مختلف در پلتفرم Laravel در لیارا"  />
