...
درصورتی که پس از نصب و پیکربندی پکیج <a href="https://pypi.org/project/Flask-Cors/" className="blue-link">Flask-Cors</a> با خطای CORS مواجه شده‌اید باید صحت resources را مورد بررسی قرار دهید:
