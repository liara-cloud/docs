...
<Tabs 
    ...
    <>
        ...
        <img src="https://files.liara.ir/liara/docs/create-flask-app-using-console.gif" alt="create app using console" />
        <div className="h-4" />
    </>,
    <>
    <video
    ...
    <p>
        با اجرای دستور فوق، شما باید شناسه، نوع پلتفرم (که باید بر روی flask باشد)، شبکه خصوصی و <Link className="blue-link" href="../../details/plans/about">منابع سخت‌افزاری و بسته امکانات</Link> برنامه خود را انتخاب کنید.
    </p>
...
<img src="https://files.liara.ir/liara/docs/created-flask-app.png" alt="a ready to use nodejs app"/>
<div className="h-2" />
