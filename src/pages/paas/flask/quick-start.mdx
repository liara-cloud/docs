...
<meta property="og:description" content="مستندات مربوط استقرار سریع برنامه‌های Flask در لیارا"  />
...
.cache`}
  ...
  <>
    ...
    <div dir='ltr'>
    <Highlight className="bash">
      {`liara deploy --app=myapp --platform=flask --team-id=your-unique-team-id`}
    </Highlight>
    </div>
  </>
  )
    ...
    <>
    <video
    src="https://media.liara.ir/docs/flask-github.mp4"
    controls="controls"
    className="block w-full"
    width="100%"
    ></video>
