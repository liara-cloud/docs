...
<Layout>
<Head>
<title>مستندات رفع خطاهای رایج در NodeJS - لیارا</title>
<meta property="og:title" content="مستندات خدمات رایانش ابری لیارا" />
<meta property="og:description" content="مستندات مربوط به رفع خطاهای رایج در پلتفرم NodeJS در لیارا"  />
...
<div className="grid md:grid-cols-2 gap-4">
            {[
    { platform: 'رفع خطای CORS', link: "./cors-error/about" },
    { platform: 'رفع خطای GET query missing در GraphQL', link: "./graphql-error" },
  ].map(item =>
    <Link href={item.link}>
