...
<Alert variant="info">
<p>
پروژه و کدهای مورد استفاده در ویدیوی فوق در <a className="blue-link" href="https://github.com/liara-cloud/nodejs-getting-started/tree/prisma">اینجا</a> قابل مشاهده و دسترسی است.
</p>
</Alert>
