...
<div className="h-2" />
اگر که از <a href="../../../../dbaas/about" className="blue-link">دیتابیس لیارا</a> استفاده می‌کنید؛ توصیه می‌شود هم برنامه و هم دیتابیس را در یک <a href="../../../details/private-network" className="blue-link">شبکه خصوصی</a> قرار دهید و برای ایجاد اتصال ایمن و مطمئن از URI شبکه خصوصی دیتابیس استفاده کنید.
