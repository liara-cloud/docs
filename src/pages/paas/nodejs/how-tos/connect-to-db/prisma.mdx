...
<div className="h-2" />
همچنین باید متغیر <Important>DATABASE_URL</Important> را طبق مستندات <a href="../../../details/envs" className="text-[#2196f3] ">تنظیم متغیرهای محیطی در برنامه</a>، به برنامه خود اضافه کنید. در مثال زیر از دیتابیس PostgreSQL استفاده شده است:
<div className="h-2" />
<div dir='ltr'>
    <Highlight className="bash">
...
<div className="h-2" />
اگر که از <a href="../../../../dbaas/about" className="text-[#2196f3] ">دیتابیس لیارا</a> استفاده می‌کنید؛ توصیه می‌شود هم برنامه و هم دیتابیس را در یک <a href="../../../details/private-network" className="text-[#2196f3] ">شبکه خصوصی</a> قرار دهید و برای ایجاد اتصال ایمن و مطمئن از URI شبکه خصوصی دیتابیس استفاده کنید.

در ادامه، باید طبق <a href="../../../disks/manage/create" className="text-[#2196f3] ">مستندات مربوط به ایجاد دیسک</a>، یک دیسک به نام <Important>prisma</Important> (یا هر نام دلخواه دیگری) و اندازه موردنیاز در برنامه خود ایجاد کنید. سپس با یکی از روش‌های زیر، مراحل باقی‌مانده را پیش ببرید:
