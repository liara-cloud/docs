...
<a href="../../../../nextjs/getting-started" className="blue-link">NextJS</a> و Drizzle ORM، در
...
<Alert variant="success">
    <p>
      یک نمونه کامل از پروژه‌ فوق که آماده مستقر شدن در لیارا است را می‌توانید در <Link className="blue-link" href="https://github.com/liara-cloud/drizzle-getting-started">اینجا</Link> مشاهده کنید.
    </p>
</Alert>
</Layout>