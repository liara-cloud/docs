...
<a href="../../../../details/envs" className="text-[#2196f3] ">متغیرهای محیطی</a> به برنامه
...
در ادامه، طبق <a href="../../use-hooks" className="text-[#2196f3] ">مستندات مربوط به Hookها</a>، باید در مسیر اصلی پروژه، یک فایل به
...
<Alert variant="info">
      ...
      باید طبق مستندات مربوط به <a href="../../../../disks/about" className="text-[#2196f3] ">دیسک‌ها</a>، یک دیسک ایجاد و
