...
<meta property="og:description" content="مستندات مربوط به اتصال به دیتابیس‌ MariaDB یا MySQL در پلتفرم NodeJS در لیارا"  />
</Head>
# اتصال به دیتابیس MySQL/MariaDB در برنامه‌های NodeJS
<hr className="mb-2" />
<video
    src="https://media.liara.ir/nodejs/nodejs-mysql.mp4"
    controls="controls"
