...
<meta property="og:description" content="مستندات مربوط به اتصال به دیتابیس‌ PostgreSQL در پلتفرم NodeJS در لیارا"  />
</Head>
# اتصال به دیتابیس PostgreSQL در برنامه‌های NodeJS
<hr className="mb-2" />
<video
    src="https://media.liara.ir/nodejs/nodejs-postgres.mp4"
    controls="controls"
