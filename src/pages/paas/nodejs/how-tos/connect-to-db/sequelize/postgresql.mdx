...
پس از آن، کافیست تا طبق <a href="../../../details/envs" className="text-[#2196f3] ">مستندات تنظیم متغیرهای محیطی</a> اطلاعات مربوط به دیتابیس خود را وارد کنید. به عنوان مثال:
...
<Section id="db-logging" title="لاگ‌گیری دیتابیس" />
 ...
 با استفاده از قطعه کد زیر، لاگ‌های کامل مربوط به دیتابیس، در بخش <a href="../../../../details/observations/software" className="text-[#2196f3] ">گزارشات نرم‌افزار برنامه</a>، به شما نمایش داده می‌شود:
<div className="h-2" />
<div dir='ltr'>
    <Highlight className="js">
        {`logging: (...msg) => console.log(msg),`}
