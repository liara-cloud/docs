...
<div className="h-2" />
به عنوان مثال، اگر که از <a href="./connect-to-db/sequelize/about" className="text-[#2196f3] ">Sequelize</a> استفاده می‌کنید؛ می‌توانید در فایل <Important>liara_pre_start.sh</Important> دستورات مربوط به migrations را بنویسید تا نیازی نباشد که پس از استقرار برنامه، آن را به صورت دستی در خط فرمان برنامه خود، اجرا کنید. به عنوان مثال:
<div className="h-2" />
<div dir='ltr'>
