...
<Alert variant="info">
<p>
سورس کامل یک برنامه NodeJS WebSocket آماده استقرار در <a href="https://github.com/liara-cloud/nodejs-getting-started/tree/websocket" className="blue-link">اینجا</a> موجود است که می‌توانید از آن استفاده کنید.
</p>
</Alert>

<NextPage next="./build-and-use-es6" />
</Layout>