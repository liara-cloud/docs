...
<Tabs 
    ...
    <p>
        با اجرای دستور فوق، شما باید شناسه، شبکه خصوصی و <Link className="text-[#2196f3] " href="../../details/plans/about">منابع سخت‌افزاری و بسته امکانات</Link> برنامه خود را انتخاب کنید.
    </p>
    </>,
