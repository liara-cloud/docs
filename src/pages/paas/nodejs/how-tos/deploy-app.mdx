...
# استقرار برنامه NodeJS در لیارا
    ...
    <>
        ...
        <p>
            ...
            پس از استقرار می‌توانید <a href="../../details/events" className="text-[#2196f3] ">رویدادها</a> و <a href="../../details/observations/about" className="text-[#2196f3] ">گزارشات</a> مربوط به برنامه را بررسی کنید.
        </p>
