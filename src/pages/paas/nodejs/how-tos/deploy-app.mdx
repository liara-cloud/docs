...
<Layout>
<Head>
<title>مستندات استقرار برنامه‌های NodeJS - لیارا</title>
<meta property="og:title" content="مستندات خدمات رایانش ابری لیارا" />
<meta property="og:description" content="مستندات مربوط به نحوه استقرار برنامه در پلتفرم NodeJS در لیارا"  />
...
# استقرار برنامه NodeJS در لیارا
    ...
    <>
        ...
        <Step  steps={[
            ...
            <>
                ...
                <p> اگر که در این فایل، اسکریپت <Important>build</Important> را تعریف کرده باشید، لیارا با اجرای دستور <Important>npm run build</Important> آن را، اجرا می‌کند.</p>
            </>
            )
            },
            {
            ...
            <>
                ...
                <p> لیارا برای اجرای برنامه، از اسکریپت <Important>start</Important> استفاده می‌کند؛ پس باید حتماً این اسکریپت را در فایل <Important>package.json</Important> تعریف کنید. </p>
            </>
            )
            }
        ]}/>
        ...
        {/* <div className="h-4" />
        <img src="https://media.liara.ir/docs/build-nodejs-app-on-liara.gif" alt="build nodejs app on liara" />
        <div className="h-4" /> */}
        <p>
            ...
            پس از استقرار می‌توانید <a href="/paas/details/events" className="text-[#2196f3] ">رویدادها</a> و <a href="/paas/details/observations/about" className="text-[#2196f3] ">گزارشات</a> مربوط به برنامه را بررسی کنید.
        </p>
    ...
    <>
        ...
        <Link href="https://github.com/liara-cloud/gitignore-templates/blob/master/nodejs/.gitignore" target="_blank">
            <Card className="flex cursor-pointer w-full items-center justify-between">
                ...
                <h4>
                    نمونه فایل <Important>gitignore.</Important> برای برنامه‌های NodeJS
                </h4>
                </div>
        ...
        <div className="h-4" />
        <p>
            قطعه کد زیر، یک نمونه از فایل <Important>package.json</Important> است که در آن اسکریپت <Important>start</Important> تعریف شده است:
        </p>
        <div className="h-4" />
        <div dir='ltr'>
  ...
  "devDependencies": {
    ...
    "platform": "node",
        ...
        <div className='h-4' />
        <p>
            در قطعه کد فوق، در فیلد <Important>app</Important> باید شناسه برنامه خود را به جای <Important>my-web-app</Important> وارد کنید و در فیلد <Important>port</Important> باید پورتی را وارد کنید که برنامه‌تان در آن، به درخواست کاربران گوش می‌دهد. فیلد <Important>platform</Important> هم پلتفرم برنامه شما را که NodeJS است، مشخص می‌کند.
        </p>
        <div className="h-4" />
        <p>
    ...
    "mirror": false
        ...
        <p>
            برای تعیین نسخه NodeJS برنامه خود نیز، کافیست تا در فایل <Important>liara.json</Important> فیلد <Important>version</Important> را قرار دهید:
        </p>
        <div className="h-4" />
        <div dir='ltr'>
            <Highlight className="json">
    ...
    "version": "22"
        ...
        <div className='h-4' />
        <Alert variant='success'>همچنین بخوانید:  <a className="text-[#2196f3] " href="../choose-version">نسخه‌های قابل ارائه NodeJS در لیارا</a></Alert>
        <p>
  ...
  "devDependencies": {
    ...
    "mirror": false
        ...
        <div className='h-4' />
        <p>
        همچنین، مانند قطعه کد زیر، بایستی در فیلدی به نام <Important>port</Important> در این فایل، مشخص کنید که برنامه‌تان در چه پورتی، به درخواست کاربران listen می‌کند:
        </p>
