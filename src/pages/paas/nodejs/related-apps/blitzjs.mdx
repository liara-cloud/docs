...
برای دیپلوی برنامه‌های BlitzJS، بایستی اسکریپت <Important>build</Important> را به شکل زیر بنویسید:
...
در ادامه، مقدار داده شده را باید در متغیری به نام <Important>SESSION_SECRET_KEY</Important> بریزید و طبق <a href="../../details/envs" className="text-[#2196f3] ">مستندات تنظیم متغیرهای محیطی</a> آن را به برنامه خود اضافه کنید.
