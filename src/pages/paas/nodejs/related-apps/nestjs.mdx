...
شما می‌توانید برنامه‌های NestJS خود را با <a href="../how-tos/create-app" className="blue-link">ایجاد برنامه‌های NodeJS</a> در لیارا، مستقر کنید.

برای دیپلوی برنامه‌های NestJS باید اسکریپت <Important>start</Important> را در فایل <Important>package.json</Important> به شکل زیر، تعریف کنید:
...
<Tabs 
    ...
    <>
    <video
        src="https://files.liara.ir/liara/quick-start/nestjs/nestjs-cli.mp4"
        controls="controls"
...
<p>
یک پروژه NestJS آماده به استقرار در <a href="https://github.com/liara-cloud/nestjs-getting-started" className="blue-link">اینجا</a> وجود دارد که می‌توانید از آن، استفاده کنید.
</p>
</Alert>
<Alert variant="success">
<p>
همچنین بخوانید: <a href="../fix-common-errors/cors-error/nestjs" className="blue-link">رفع خطای CORS در فریم‌ورک NestJS</a>
</p>
</Alert>
