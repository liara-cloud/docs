...
در ادامه، باید متغیرهای محیطی مربوط به دیتابیس برنامه Strapi خود را طبق <a href="../../../details/envs" className="text-[#2196f3] ">مستندات اضافه کردن متغیرهای محیطی</a> به برنامه NodeJS اضافه کنید. به عنوان مثال:
...
<div className="h-2" />
و از آنجایی که <a href="../../../details/file-system" className="text-[#2196f3] ">فایل سیستم لیارا</a> به صورت پیش‌فرض ReadOnly است؛ پس بایستی برای ذخیره media، طبق مستندات <a href="../../../disks/about" className="text-[#2196f3] ">دیسک‌ها</a>، یک دیسک ایجاد و آن‌ را به آدرس‌ <Important>app/public/uploads/</Important> متصل کنید.
