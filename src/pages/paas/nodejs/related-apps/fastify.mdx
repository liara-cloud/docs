...
برای دیپلوی برنامه‌های Fastify باید اسکریپت <Important>start</Important> را در فایل <Important>package.json</Important> مشخص کنید؛ به عنوان مثال: 
...
در ادامه، مقدار داده شده را باید در متغیری به نام <Important>SESSION_SECRET_KEY</Important> بریزید و طبق <a href="../../details/envs" className="blue-link">مستندات تنظیم متغیرهای محیطی</a> آن را به برنامه خود اضافه کنید.
...
<p>
یک پروژه Fastify آماده به استقرار در <a href="https://github.com/liara-cloud/fastify-getting-started" className="blue-link">اینجا</a> وجود دارد که می‌توانید از آن، استفاده کنید.
</p>
</Alert>

<Alert variant="success">
<p>
همچنین بخوانید: <a href="../fix-common-errors/cors-error/fastify" className="blue-link">رفع خطای CORS در فریم‌ورک Fastify</a>
</p>
</Alert>
