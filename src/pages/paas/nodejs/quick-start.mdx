...
<meta property="og:description" content="مستندات مربوط به نحوه استقرار برنامه‌های  در پلتفرم NodeJS در لیارا"  />
  ...
  <Step  steps={[
{
  ...
  <>
   ...
   <>
    <video
    src="https://media.liara.ir/nodejs/nodejs-github.mp4"
    controls="controls"
    className="block w-full"
    width="100%"
    ></video>
...
<Alert variant="info">
<p>
اگر که در فایل <Important>package.json</Important> اسکریپت <Important>build</Important> را تعریف کرده باشید، لیارا آن را اجرا می‌کند.
</p>
</Alert>

<Alert variant="success">
<p>
همچنین بخوانید: <Link className="text-[#2196f3] " href="./how-tos/create-app">استقرار قدم به قدم برنامه‌های NodeJS در لیارا</Link>
</p>
</Alert>
</Layout>