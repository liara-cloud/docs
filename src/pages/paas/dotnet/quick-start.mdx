...
<Layout>
<Head>
<title>مستندات استقرار سریع برنامه‌های NET. - لیارا</title>
<meta property="og:title" content="مستندات خدمات رایانش ابری لیارا" />
<meta property="og:description" content="مستندات مربوط به نحوه استقرار سریع برنامه‌های دات‌نت در لیارا"  />
</Head>
# استقرار سریع برنامه‌های NET.
<hr className="mb-2" />
...
<Tabs 
  ...
  <>
  <video
  src="https://media.liara.ir/dotnet/dotnet-desktop.mp4"
  controls="controls"
  ...
  <Step  steps={[
{
  ...
  <>
    <h3>ایجاد برنامه</h3>
    <p>برنامه NET. خود را با شناسه، <Link className="text-[#2196f3] " href="../details/private-network">شبکه خصوصی</Link> و <Link className="text-[#2196f3] " href="../details/plans/about">منابع سخت‌افزاری و بسته امکانات</Link> مدنظرتان ایجاد کنید.</p>
  </>
  )
  },
  {
  ...
  <>
    ...
    <p>پوشه‌ها و فایل‌های درون پروژه که قصد ندارید در لیارا آپلود شوند (به عنوان مثال پوشه‌های nupkg و debug) را پاک کنید.</p>  
  </>
  )
  },
  {
  ...
  content: (
  <>
    <h3>بررسی وجود فایل csproj.</h3>
    <p>حتماً باید در مسیر اصلی پروژه، یک فایل با پسوند <Important>csproj.</Important> وجود داشته باشد؛
      در نظر داشته باشید که در حین ایجاد یک پروژه جدید NET. این فایل به صورت خودکار برای شما ایجاد می‌شود و نیازی نیست که شما، کار خاصی را انجام دهید.
    </p>
  </>
  )
  },
  ...
  <>
  <video
  src="https://media.liara.ir/dotnet/dotnet-cli.mp4"
  controls="controls"
  className="block w-full"
  width="100%"
  ></video>
  ...
  <Step  steps={[
{
  ...
  <>
    <h3>ایجاد برنامه</h3>
    <p>با اجرای دستور زیر، برنامه NET. خود را ایجاد کنید:</p>
    <div dir='ltr'>
    <Highlight className="bash">
      {`liara create`}
    </Highlight>
    ...
    <p>در ادامه اجرای این دستور، باید به ترتیب، شناسه، نوع پلتفرم (که باید بر روی dotnet تنظیم شود)، شبکه خصوصی و <Link className="text-[#2196f3] " href="../details/plans/about">منابع سخت‌افزاری و بسته امکانات برنامه</Link>، مشخص شوند.</p>
  </>
  )
  },
  {
...
`}
  ...
  <>
    ...
    <div dir='ltr'>
    <Highlight className="bash">
      {`liara deploy --app=myapp --platform=dotnet`}
    </Highlight>
    </div>
    <div className="h-2" />
    <p>
    ...
    <div dir='ltr'>
    <Highlight className="bash">
      {`liara deploy --app=myapp --platform=dotnet --team-id=your-unique-team-id`}
    </Highlight>
    </div>
  </>
  )
  ...
  <>
    <video
    src="https://media.liara.ir/docs/dotnet-github.mp4"
    controls="controls"
    className="block w-full"
    width="100%"
    ></video>
...
<Alert variant="info">
<p>
لیارا با اجرای دستور <Important>dotnet restore</Important> تمامی ماژول‌های موردنیاز برنامه را نصب می‌کند. پس برای نصب آن‌ها، نیازی به انجام کار خاصی نیست.
</p>
</Alert>
<div className="h-1" />
...
<Alert variant="success">
<p>
همچنین بخوانید: <Link className="text-[#2196f3] " href="./how-tos/create-app">استقرار قدم به قدم برنامه‌های NET. در لیارا</Link>
</p>
</Alert>
</Layout>