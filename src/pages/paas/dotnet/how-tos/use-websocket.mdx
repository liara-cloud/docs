...
<Alert variant="warning">
<p>
باید طبق مستندات <a href="../../details/env" className="blue-link">تنظیم متغیرهای محیطی</a>، یک متغیر محیطی به نام <Important>REDIS_URI</Important> با مقدار URI دیتابیس Redis خود به برنامه Djangoتان، اضافه کنید.
</p>
</Alert>
...
<Alert variant="info">
<p>
سورس کامل یک برنامه Django WebSocket آماده استقرار در <a href="https://github.com/liara-cloud/django-getting-started/tree/asgi" className="blue-link">اینجا</a> موجود است که می‌توانید از آن استفاده کنید.
</p>
</Alert>

<NextPage next="./use-asgi" />
</Layout>