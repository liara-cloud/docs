...
<Alert variant="info">
<p>
سورس کامل یک برنامه NET. وب‌سوکت آماده استقرار در <a href="https://github.com/liara-cloud/dotnet-getting-started/tree/websocket" className="blue-link">اینجا</a> موجود است که می‌توانید از آن استفاده کنید.
</p>
</Alert>
