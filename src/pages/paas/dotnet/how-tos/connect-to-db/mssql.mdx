...
<p>
یک پروژه آماده استقرار در <a href="https://github.com/liara-cloud/dotnet-getting-started/tree/ef-core" className="blue-link">گیت‌هاب لیارا</a> وجود دارد که می‌توانید از آن، استفاده کنید.
