...
در ادامه، بایستی طبق مستندات <a href="../../../details/envs" className="blue-link">تنظیم متغیرهای محیطی</a>، متغیر مربوط به دیتابیس خود را، به برنامه، اضافه کنید؛ به عنوان مثال:
<div className="h-2" />
    <div dir='ltr'>
    <Highlight className="bash">
