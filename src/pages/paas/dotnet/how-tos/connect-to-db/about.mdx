...
حال از آنجایی که مستندات رسمی پلتفرم NET. نیز، استفاده از <a href="https://learn.microsoft.com/en-us/ef/" className="blue-link">Entity Framework ORM</a> را، به شدت توصیه می‌کند؛ در ادامه، مستندات مربوط به اتصال به دیتابیس با استفاده از این ORM برای شما، قرار گرفته است:
...
<div className="grid grid-cols-2 gap-4">
    ...
    // { alt: 'mssql', platform: 'MSSQL', link: "./mssql" },
    { alt: 'netcore', platform: 'SQLite', link: "./sqlite" },
  ].map(item =>
    <Link href={item.link}>
