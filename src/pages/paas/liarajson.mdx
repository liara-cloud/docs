...
<Section id="set-envs-on-liarajson" title="تنظیم متغیرهای محیطی در فایل liara.json" />

شما می‌توانید در آبجکتی به نام <Important>envs</Important> تمامی متغیرهای محیطی را در فایل <Important>liara.json</Important> خود، مانند شکل زیر، تعریف و مقداردهی کنید: 
...
<p>
در نظر داشته باشید که با انجام این کار، <b>تمامی متغیرهای قبلی ذخیره‌شده به همراه مقادیرشان</b> در برنامه‌تان، از بین خواهند رفت 
و متغیرهای تعریفی شما در این فایل، جایگزین قبلی‌ها، خواهند شد.
</p>
</Alert>
<Alert variant="warning">
<p>
در صورتی که پروژه‌تان شامل git است و متغیرهای تعریفی‌تان در این فایل حساس هستند؛ بهتر است اسم این فایل را در <Important>gitignore.</Important> قرار دهید تا مقادیر متغیرهای حساس، در git ذخیره و commit نشوند.
</p>
</Alert>
...
<Tabs 
  tabs={["Laravel", "Django", "Flask", ".NET", "React", "Angular", "Docker","NextJS"]} 
  content={[
  <>
<div dir="ltr">
<Highlight className="json">
...
<div className="h-4" />
<img src="https://media.liara.ir/docs/paas-default-liarajson.png" alt="paas-default-liarajson" />
<div className="h-4" />
