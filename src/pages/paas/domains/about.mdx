...
<p>
    همچنین بخوانید: <a href="/paas/docker/related-apps/nginx" className="blue-link">تنظیم reverse proxy با Nginx</a>
</p>
</Alert>
...
<Alert variant="success">
<p>
    همچنین بخوانید: <a href="/dns-management-system/about" className="blue-link">سرویس مدیریت دامنه لیارا</a>
</p>
</Alert>
