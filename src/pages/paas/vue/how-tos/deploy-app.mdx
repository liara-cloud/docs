...
توجه داشته باشید؛ تنها برنامه‌هایی که با <Important>Vite</Important> و یا <Important>vue-cli</Important> ساخته شده باشند، در پلتفرم Vue لیارا قابل اجرا خواهند بود.
  ...
  "devDependencies": {
    ...
    <div className="h-2" />
        <p>
            قطعه کد زیر نیز، یک نمونه از فایل <Important>package.json</Important> استاندارد برای برنامه‌های Vue است که با استفاده از دستور <Important>vue-cli</Important> ساخته شده‌اند:
        </p>        <div className="h-4" />
        <div dir='ltr'>
            <Highlight className="json">
                {`{
