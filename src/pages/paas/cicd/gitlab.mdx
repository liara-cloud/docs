...
<div className='h-1' />
در صورتی که از <a href="/references/team/about" className="text-[#2196f3] ">تیم‌ها</a> در لیارا استفاده می‌کنید و می‌خواهید برنامه را در یک تیم خاص مستقر کنید، باید پارامتر <Important>"team-id="your-team-id--</Important> را هم به دستور <Important>liara deploy</Important> اضافه کنید و مقدار <Important>your-team-id</Important> را با شناسه‌ی تیم خود جایگزین نمایید.
