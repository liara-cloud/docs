...
<hr className="mb-2" />
    ...
    content={[
        ...
        <p>
            ...
            و در ادامه، برنامه‌تان در سرورهای لیارا build می‌شود و image نهایی در <a href="../../details/private-registry" className="text-[#2196f3] ">رجیستری خصوصی</a> شما، در لیارا، ذخیره خواهد شد.
