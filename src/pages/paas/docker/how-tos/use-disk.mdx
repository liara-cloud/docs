...
برای استفاده از <a href="/paas/disks/about" className="text-[#2196f3] ">دیسک‌ها</a> در برنامه‌های Docker در ابتدا باید طبق مستندات <a href="../../disks/create" className="text-[#2196f3] ">ساخت دیسک</a>، دیسک‌های مدنظر خود را بسازید؛ در ادامه، می‌توانید طبق مستندات <a href="../../disks/route" className="text-[#2196f3] ">تعریف مسیر برای دیسک</a>، دیسک‌های خود را به دایرکتوری‌های مدنظرتان، متصل کنید.
<div className='h-2' />
