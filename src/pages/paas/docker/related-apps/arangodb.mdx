...
<div className="h-2" />
سپس، طبق <a href="../../disks/create" className="text-[#2196f3] ">مستندات ساخت دیسک</a>، دو دیسک با نام‌های <Important>arangodb-data</Important> و <Important>arangodb-config</Important>  با میزان فضای مورد نیاز، ایجاد کنید. 
