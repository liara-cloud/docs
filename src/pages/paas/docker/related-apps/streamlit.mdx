...
<div className="h-2" />
سپس، بایستی در برنامه داکری که ایجاد کرده‌اید، طبق <a href="../../disks/create" className="text-[#2196f3] ">مستندات ساخت دیسک</a>، یک دیسک به نام <Important>data</Important> با حداقل فضای 2GB، ایجاد کنید. در نهایت نیز، کافیست تا دستور زیر را اجرا کنید تا برنامه‌تان در لیارا، مستقر شود:
