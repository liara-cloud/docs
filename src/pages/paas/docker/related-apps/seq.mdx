...
در ادامه، طبق <a href="../../details/envs" className="blue-link">مستندات تنظیم متغیرهای محیطی</a>، متغیر محیطی زیر را به برنامه داکر خود، اضافه کنید:
...
<div className="h-2" />
سپس، طبق <a href="../../disks/create" className="blue-link">مستندات ساخت دیسک</a>، یک دیسک به نام <Important>data</Important> با میزان فضای مورد نیاز، ایجاد کنید. 
