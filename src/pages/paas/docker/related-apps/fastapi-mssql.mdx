...
<a href="https://fastapi.tiangolo.com/" className="blue-link">FastAPI</a> یک فریم‌ورک وب سریع و مدرن برای ساخت APIهای وب با استفاده از زبان برنامه‌نویسی Python است. این فریم‌ورک بر پایه استانداردهای OpenAPI و JSON Schema ساخته و بهینه‌سازی شده است تا همزمان با حفظ عملکرد بالا، نوشتن کدهای سریع و ساده را ممکن سازد.
...
شما می‌توانید برنامه‌های FastAPI خود را با <a href="../how-tos/create-app" className="blue-link">ایجاد برنامه‌های Docker</a> در لیارا، مستقر کنید.
