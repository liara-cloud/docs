...
<meta property="og:description" content="مستندات مربوط به نحوه استقرار سریع برنامه‌های مبتنی بر داکر یا داکرایز شده در لیارا"  />
</Head>
  ...
  <Step  steps={[
{
  ...
  <>
    ...
    <p>
      در مسیر اصلی پروژه، یک فایل به نام <Important>Dockerfile</Important> ایجاد کنید و بنا به نیازهای پروژه خود، دستورات مرتبط را درون این فایل، قرار دهید تا پروژه‌تان Dockerize شود. به عنوان مثال، اگر که برنامه‌تان مبتنی بر فریم‌ورک go است، می‌توانید قطعه کد زیر را در <Important>Dockerfile</Important>، قرار دهید:    
    </p>
    <div className="h-2" />
    <div dir='ltr'>
...
CMD ["./main"]`}
  ...
  <>
    <video
    src="https://media.liara.ir/docs/docker-github.mp4"
    controls="controls"
    className="block w-full"
    width="100%"
    ></video>
