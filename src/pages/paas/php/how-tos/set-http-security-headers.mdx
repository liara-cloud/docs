...
<Layout>
<Head>
<title>مستندات تنظیم هدرهای امنیتی در PHP - لیارا</title>
</Head>
...
شما می‌توانید هدرهای امنیتی را مانند قطعه کد مثال زیر، در فایل <Important>htaccess.</Important> تنظیم کرده و نحوه‌ی برقراری ارتباط با سایت را، برای مرورگرها، تعیین کنید:
<div className="h-2" />
<div dir='ltr'>
