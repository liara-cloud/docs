...
<Tabs 
    ...
    <div className="h-2" />
    <p>
        برای ساخت برنامه در لیارا باید در ابتدا با اجرای دستور زیر، ابزار <Link href="../../../../references/liara-cli/about" className="text-[#2196f3] ">Liara CLI</Link> را بر روی سیستم‌عامل خود، نصب کنید:
    </p>
    <div dir='ltr'>
    ...
    <p>
        با اجرای دستور فوق، شما باید شناسه، نوع پلتفرم (که باید بر روی php باشد)، شبکه خصوصی و <Link className="text-[#2196f3] " href="../../details/plans/about">منابع سخت‌افزاری و بسته امکانات</Link> برنامه خود را انتخاب کنید.
    </p>
    </>,
...
<p>
    در واقع، این همان <a className="text-[#2196f3] " href="../../domains/default-subdomain">زیر دامنه پیش‌فرضی</a> است که لیارا به صورت رایگان در اختیار شما قرار می‌دهد.
