...
برای مشاهده وضعیت صف‌های تعریف شده در supervisor، کافیست تا در <a href="../../details/console-shell" className='text-[#2196f3] '>خط فرمان برنامه</a> دستور زیر را وارد کنید:
