...
در ابتدا، بایستی طبق مستندات <a href="../../../details/envs" className="text-[#2196f3] ">تنظیم متغیرهای محیطی</a>، متغیرهای مربوط به دیتابیس خود را به برنامه اضافه کنید؛ به عنوان مثال:
...
در ادامه، بایستی طبق مستندات <a href="../use-hooks" className="text-[#2196f3] ">هوک‌ها</a> در مسیر اصلی پروژه، یک فایل به نام <Important>liara_pre_build.sh</Important> ایجاد کنید و قطعه کد زیر را در آن قرار دهید:
<div className="h-2" />
    <div dir='ltr'>
