...
برای اتصال به دیتابیس Redis نیاز به انجام کار خاصی نیست؛ چرا که اکستنشن <Important>redis</Important> از قبل نصب شده است و فقط کافیست تا شما طبق <a href="../../../details/envs" className="text-[#2196f3] ">مستندات تنظیم متغیرهای محیطی</a>، متغیرهای مربوط به دیتابیس خود را به برنامه اضافه کنید؛ برای نمونه:
<div className="h-2" />
    <div dir='ltr'>
