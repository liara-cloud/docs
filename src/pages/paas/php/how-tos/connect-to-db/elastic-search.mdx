...
در ادامه، بایستی طبق مستندات <a href="../../../details/envs" className="blue-link">تنظیم متغیرهای محیطی</a>، متغیرهای محیطی مربوط به دیتابیس خود را به برنامه، در لیارا، اضافه کنید؛ به عنوان مثال:
