...
بایستی از <a href="../use-hooks" className="blue-link">هوک‌ها</a> استفاده کنید.

در ابتدا، بایستی تا طبق مستندات <a href="../../../details/envs" className="blue-link">تنظیم متغیرهای محیطی</a>، متغیرهای مربوط به دیتابیس MongoDB را به برنامه خود، اضافه کنید. به عنوان مثال:
