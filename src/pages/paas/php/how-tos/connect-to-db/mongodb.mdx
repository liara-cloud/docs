...
بایستی از <a href="../use-hooks" className="text-[#2196f3] ">هوک‌ها</a> استفاده کنید.

در ابتدا، بایستی تا طبق مستندات <a href="../../../details/envs" className="text-[#2196f3] ">تنظیم متغیرهای محیطی</a>، متغیرهای مربوط به دیتابیس MongoDB را به برنامه خود، اضافه کنید. به عنوان مثال:
