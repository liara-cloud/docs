...
<Layout>
<Head>
<title>مستندات اتصال به دیتابیس PostgreSQL در PHP - لیارا</title>
</Head>
# اتصال به دیتابیس PostgreSQL در برنامه‌های PHP
<hr className="mb-2" />

برای اتصال به دیتابیس PostgreSQL نیاز به انجام کار خاصی نیست؛ چرا که اکستنشن‌های مربوط به آن، مانند <Important>PDO</Important> و <Important>pgsql</Important> از قبل، توسط لیارا، نصب شده است. فقط کافیست تا طبق <a href="../../../details/envs" className="blue-link">مستندات تنظیم متغیرهای محیطی</a>، متغیرهای مربوط به دیتابیس خود را به برنامه اضافه کنید؛ برای نمونه:
<div className="h-2" />
    <div dir='ltr'>
