...
<Layout>
<Head>
<title>مستندات رفع خطاهای رایج در PHP - لیارا</title>
<meta property="og:title" content="مستندات خدمات رایانش ابری لیارا" />
<meta property="og:description" content="مستندات مربوط به رفع خطاهای رایج در پلتفرم PHP در لیارا"  />
<meta property="og:image" content="https://files.liara.ir/liara/logos/liara-poster.jpg" />
</Head>
# رفع خطاهای رایج در استقرار برنامه‌های PHP
<hr className="mb-2" />
