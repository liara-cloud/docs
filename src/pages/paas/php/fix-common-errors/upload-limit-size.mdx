...
علی‌رغم <a className="blue-link" href="../../details/file-system">فایل سیستم پیش‌فرض برنامه‌های PHP در لیارا</a>، که ReadOnly است؛ دایرکتوری <Important>tmp/</Important> قابل نوشتن است، اما محدودی 100 مگابایتی دارد.
