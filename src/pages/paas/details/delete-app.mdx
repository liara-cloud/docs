...
<div className="h-4" />
<img src="https://media.liara.ir/docs/app-three-dots.png" alt="app three dots"/>
<div className="h-4" />
سپس؛ بر روی گزینه **حذف برنامه** کلیک کنید:
<div className="h-4" />
<img src="https://media.liara.ir/docs/delete-an-app-option.png" alt="delete app option"/>
<div className="h-4" />
...
<div className="h-4" />
<img src="https://media.liara.ir/docs/delete-app.png" alt="delete app"/>
<div className="h-4" />
