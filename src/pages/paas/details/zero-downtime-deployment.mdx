...
برای تشخیص پایدار بودن وضعیت استقرار جدید، لیارا قابلیتی را به نام <a href="./health-check" className="blue-link">بررسی وضعیت سلامت برنامه</a> فراهم کرده است. در صورتی که وضعیت برنامه طبق آخرین <a href="./events" className="blue-link">رویداد</a>، مشکلی نداشته باشد، استقرار جدید، به عنوان نسخه‌ی جدید برنامه تایید می‌شود و ترافیک به روی آن منتقل می‌گردد. در غیر این‌صورت،‌ عملیات استقرار لغو می‌شود.
