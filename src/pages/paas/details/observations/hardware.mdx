...
<p>
همچنین بخوانید: <a href="/paas/disks/decrease-value" className="blue-link">کاهش فضای یک دیسک</a>
</p>
</Alert>
<div className="h-2" />
<Alert variant='success'>
<p>
همچنین بخوانید: <a href="./software" className="blue-link">مستندات مربوط به گزارشات نرم‌افزاری یک برنامه</a>
</p>
</Alert>
</Layout>