...
<Layout>
<Head>
<title>مستندات منابع سخت‌افزاری پلتفرم  - لیارا</title>

<meta property="og:title" content="مستندات خدمات رایانش ابری لیارا" />
<meta property="og:description" content="مستندات مربوط به منابع سخت‌افزاری یک پلتفرم در لیارا"  />
...
<br />
<video
src="https://files.liara.ir/liara/pricing/pricing.mp4"
controls="controls"
...
<p>
همچنین بخوانید: <a href="/paas/details/observations/hardware/#find-best-plan-by-monitoring" className="text-[#2196f3] ">انتخاب بهترین پلن برای برنامه با استفاده از گزارشات سخت‌افزاری</a>
</p>
</Alert>
<div className="h-2" />
...
<Section id='plutu' title="پلن پلوتون (اکستریم)" />
