...
<Layout>
<Head>
<title>مستندات استقرار سریع برنامه‌های NextJS - لیارا</title>
<meta property="og:title" content="مستندات خدمات رایانش ابری لیارا" />
<meta property="og:description" content="مستندات مربوط به استقرار سریع برنامه‌های NextJS در لیارا"  />
<meta property="og:image" content="https://media.liara.ir/logos/liara-poster.jpg" />
</Head>
# استقرار سریع برنامه‌های NextJS
<hr className="mb-2" />
توجه داشته باشید؛ تنها برنامه‌هایی که با دستور <Important>create-next-app</Important> ساخته شده باشند، در پلتفرم Next لیارا قابل اجرا خواهند بود.
...
<Tabs 
  ...
  <>
  <video
  src="https://media.liara.ir/nextjs/nextjs-desktop.mp4"
  controls="controls"
  ...
  <Step  steps={[
{
  ...
  <>
    <h3>ایجاد برنامه</h3>
    <p>برنامه NextJS خود را با شناسه، <Link className="text-[#2196f3] " href="../details/private-network">شبکه خصوصی</Link> و <Link className="text-[#2196f3] " href="../details/plans/about">منابع سخت‌افزاری و بسته امکانات</Link> مدنظرتان ایجاد کنید.</p>
  </>
  )
  },
  {
  ...
  content: (
  <>
    <h3>بررسی فایل <Important>package.json</Important> استاندارد</h3>
    <p>
      در نظر داشته باشید که در پروژه‌های استاندارد Angular، یک فایل به نام <Important>package.json</Important>
      وجود دارد که برای استقرار حائز اهمیت است و این فایل نباید حذف یا دستکاری شود. 
      قطعه کد زیر یک نمونه استاندارد از فایل <Important>package.json</Important> است:
    </p>  
    <div className="h-2" />
  ...
  <>
  <video
  src="https://media.liara.ir/nextjs/nextjs-cli.mp4"
  controls="controls"
  className="block w-full"
  width="100%"
  ></video>
  ...
  <Step  steps={[
{
  ...
  <>
    <h3>ایجاد برنامه</h3>
    <p>با اجرای دستور زیر، برنامه NextJS خود را ایجاد کنید:</p>
    <div dir='ltr'>
    <Highlight className="bash">
      {`liara create`}
    </Highlight>
    ...
    <p>در ادامه اجرای این دستور، باید به ترتیب، شناسه، نوع پلتفرم (که باید بر روی next تنظیم شود)، شبکه خصوصی و <Link className="text-[#2196f3] " href="../details/plans/about">منابع سخت‌افزاری و بسته امکانات برنامه</Link>، مشخص شوند.</p>
  </>
  )
  },
  {
  ...
  <>
    ...
    <div dir='ltr'>
    <Highlight className="bash">
      {`liara deploy --app=myapp --platform=next --team-id=your-unique-team-id`}
    </Highlight>
    </div>
  </>
  )
   ...
   <>
    <video
    src="https://media.liara.ir/docs/nextjs-github.mp4"
    controls="controls"
    className="block w-full"
    width="100%"
    />
    ...
    <Step  steps={[
{
  ...
  content: (
   <>
    <h3>بررسی فایل <Important>package.json</Important> استاندارد</h3>
    <p>
      در نظر داشته باشید که در پروژه‌های استاندارد NextJS، یک فایل به نام <Important>package.json</Important>
      وجود دارد که برای استقرار حائز اهمیت است و این فایل نباید حذف یا دستکاری شود. 
      قطعه کد زیر یک نمونه استاندارد از فایل <Important>package.json</Important> است:
    </p>
    <div className="h-2" />
...
<Alert variant="info">
<p>
لیارا به صورت خودکار، در فرایند استقرار برنامه‌های NextJS اسکریپت <Important>build</Important> را برای شما اجرا می‌کند.
</p>
</Alert>
<div className="h-1" />
...
<Alert variant="success">
<p>
همچنین بخوانید: <Link className="text-[#2196f3] " href="./how-tos/create-app">استقرار قدم به قدم برنامه‌های NextJS در لیارا</Link>
</p>
</Alert>
</Layout>