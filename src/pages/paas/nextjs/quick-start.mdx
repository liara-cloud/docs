  ...
  <Step  steps={[
{
  ...
  <>
    ...
    <div dir='ltr'>
    <Highlight className="bash">
      {`liara deploy --app=myapp --platform=node`}
    </Highlight>
    </div>
  </>
  )
  ...
  <Step  steps={[
{
  ...
  <>
    <h3>ایجاد برنامه</h3>
    <p>برنامه NextJS خود را با شناسه، <Link className="blue-link" href="../details/private-networks.md">شبکه خصوصی</Link> و <Link className="blue-link" href="../details/plans/about">پلن‌های نرم‌افزاری و سخت‌افزاری</Link> مدنظرتان ایجاد کنید.</p>
  </>
  )
  },
  {
...
<p>
همچنین بخوانید: <Link className="blue-link" href="./how-tos/create-app">استقرار قدم به قدم برنامه‌های NextJS در لیارا</Link>
</p>
</Alert>
</Layout>