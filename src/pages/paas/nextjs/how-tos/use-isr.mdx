...
<Tabs 
    ...
    <>
        ...
        <>
                ...
                <p>طبق مستندات <a href="../../disks/manage/route" className="blue-link">تعریف مسیر دیسک</a>، دیسک ایجاد شده را به مسیر <Important>next/server/pages.</Important> متصل کنید.</p>
        </>
        )
        },]}/>
    </>,
    ...
    <Step  steps={[
        ...
        <>
                <h3>تعریف مسیر برای دیسک</h3>
                <p>طبق مستندات <a href="../../disks/manage/route" className="blue-link">تعریف مسیر دیسک</a>، دیسک ایجاد شده را به مسیر <Important>next/server/app.</Important> متصل کنید.</p>
        </>
        )
        },]}/>
    </>
