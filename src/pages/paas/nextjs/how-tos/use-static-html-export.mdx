...
برای استقرار خروجی نهایی برنامه در لیارا، کافیست تا طبق مستندات <a href="../../static/how-tos/create-app" className="text-[#2196f3] ">ساخت برنامه‌های Static</a> یک برنامه static در لیارا ایجاد کنید. 
