...
قابلیت <a href="https://nextjs.org/docs/pages/building-your-application/deploying/static-exports" className="blue-link">Static HTML Export</a> به شما اجازه می‌دهد تا یک وب‌سایت کاملاً استاتیک ایجاد کنید که می‌تواند بدون نیاز به سرور NodeJS اجرا شود.
...
برای استقرار خروجی نهایی برنامه در لیارا، کافیست تا طبق مستندات <a href="../../static/how-tos/create-app" className="blue-link">ساخت برنامه‌های Static</a> یک برنامه static در لیارا ایجاد کنید. 
...
<NextPage next="./increase-next-cache"/>
</Layout>