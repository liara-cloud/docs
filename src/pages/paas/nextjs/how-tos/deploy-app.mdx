...
<Layout>
<Head>
<title>مستندات استقرار برنامه‌های NextJS - لیارا</title>
<meta property="og:title" content="مستندات خدمات رایانش ابری لیارا" />
<meta property="og:description" content="مستندات مربوط به نحوه استقرار برنامه NextJS در لیارا"  />
...
توجه داشته باشید؛ تنها برنامه‌هایی که با دستور <Important>create-next-app</Important> ساخته شده باشند، در پلتفرم Next لیارا قابل اجرا خواهند بود.
  ...
  "devDependencies": {
    ...
    "eslint-config-next": "14.0.4"
        ...
        {/* <div className="h-4" />
        <img src="https://media.liara.ir/docs/deploy-nextjs-app-on-liara.gif" alt="build app on liara" />
        <div className="h-4" /> */}
        <p>
  ...
  "devDependencies": {
    ...
    "platform": "next"
        ...
        <p>
            ...
            در فیلد <Important>platform</Important> باید نوع پلتفرم خود را که NextJS است، مشخص کنید.
        </p>
