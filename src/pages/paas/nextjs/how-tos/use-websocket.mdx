...
برای استقرار این برنامه در لیارا، بهتر است که از <Link href="../../nodejs/getting-started" className="blue-link">پلتفرم NodeJS</Link> برای استقرار برنامه NextJS مبتنی بر وب‌سوکت استفاده شود.
برای این کار کافیست تا طبق مستندات <Link href="../../nodejs/how-tos/create-app" className="blue-link">ساخت برنامه NodeJS</Link> یک برنامه NodeJS ایجاد کنید و اسکریپت <Important>start</Important> درون فایل <Important>package.json</Important> خود را به شکل زیر، تغییر دهید: 
<div className="h-2" />
<div dir='ltr'>
...
<Alert variant="info">
<p>
سورس کامل یک برنامه NextJS WebSocket آماده استقرار در <a href="https://github.com/liara-cloud/nextjs-getting-started/tree/websocket" className="blue-link">اینجا</a> موجود است که می‌توانید از آن استفاده کنید.
</p>
</Alert>

<NextPage next="./use-type-script" />
</Layout>