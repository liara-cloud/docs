...
<Layout>
<Head>
<title>مستندات استقرار سریع برنامه‌های Static - لیارا</title>
</Head>
  ...
  <Step  steps={[
{
  ...
  <>
    <h3>ایجاد برنامه</h3>
    <p>برنامه Static خود را با شناسه، <Link className="text-[#2196f3] " href="../details/private-network">شبکه خصوصی</Link> و <Link className="text-[#2196f3] " href="../details/plans/about">منابع سخت‌افزاری و بسته امکانات</Link> مدنظرتان ایجاد کنید.</p>
  </>
  )
  },
  {
  ...
  <>
    ...
    <p>پوشه‌ها و فایل‌های درون پروژه که قصد ندارید در لیارا آپلود شوند (به عنوان مثال پوشه node_modules در صورت وجود) را پاک کنید.</p>  
  </>
  )
  },
  {
  ...
  <>
  <video
  src="https://files.liara.ir/liara/quick-start/static/static-cli.mp4"
  controls="controls"
  className="block w-full"
  width="100%"
  ></video>
  ...
  <Step  steps={[
{
  ...
  <>
    <h3>ایجاد برنامه</h3>
    <p>با اجرای دستور زیر، برنامه Static خود را ایجاد کنید:</p>
    <div dir='ltr'>
    <Highlight className="bash">
      {`liara create`}
    </Highlight>
    ...
    <p>در ادامه اجرای این دستور، باید به ترتیب، شناسه، نوع پلتفرم (که باید بر روی static تنظیم شود)، شبکه خصوصی و <Link className="text-[#2196f3] " href="../details/plans/about">منابع سخت‌افزاری و بسته امکانات برنامه</Link>، مشخص شوند.</p>
  </>
  )
  },
  {
...
<p>
همچنین بخوانید: <Link className="text-[#2196f3] " href="./how-tos/create-app">استقرار قدم به قدم برنامه‌های Static در لیارا</Link>
</p>
</Alert>
</Layout>