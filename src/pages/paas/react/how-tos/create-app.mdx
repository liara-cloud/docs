...
<Tabs 
    ...
    <>
        ...
        {/* <img src="https://files.liara.ir/liara/docs/create-react-app-using-console.gif" alt="create app using console" />
        <div className="h-4" /> */}
    </>,
...
<img src="https://files.liara.ir/liara/docs/created-react-app.png" alt="a ready to use app"/>
<div className="h-2" />
