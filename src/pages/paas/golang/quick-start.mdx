...
<meta property="og:description" content="مستندات نحوه استقرار سریع پلتفرم Golang در لیارا"  />
<meta property="og:image" content="https://files.liara.ir/liara/logos/liara-poster.jpg" />
</Head>

# استقرار سریع برنامه‌های Golang
<hr className="mb-2" />
...
<Tabs 
  ...
  <>
  <video
  src="https://files.liara.ir/liara/golang/golang-desktop.mp4"
  controls="control/s"
  ...
  <Step  steps={[
{
  ...
  <>
    <h3>ایجاد برنامه</h3>
    <p>برنامه Golang خود را با شناسه، <Link className="text-[#2196f3] " href="../details/private-network">شبکه خصوصی</Link> و <Link className="text-[#2196f3] " href="../details/plans/about">منابع سخت‌افزاری و بسته امکانات</Link> مدنظرتان ایجاد کنید.</p>
  </>
  )
  },
  {
  ...
  <>
    ...
    <p>پوشه‌ها و فایل‌های درون پروژه که قصد ندارید در لیارا آپلود شوند (به عنوان مثال پوشه‌ vendor و فایل‌های باینری با پسوند exe.) را پاک کنید.</p>  
  </>
  )
  },
  {
  ...
  <>
    ...
    <p>در صورتی که از کتابخانه یا پکیج خاصی استفاده می‌کنید که به صورت built-in (پیش‌فرض) در Golang وجود ندارد، حتماً باید در مسیر اصلی پروژه، فایل <Important>go.mod</Important> 
    وجود داشته باشد؛
    ...
    <Alert variant="info">
    <p>
      به جای عبارت <Important>&lt;module_or_project_name&gt;</Important>، کافیست تا نام ماژول یا نام پروژه برنامه‌تان را وارد کنید.
    </p>
    </Alert>
    <Alert variant="success">
    <p>
        توصیه می‌شود که برای اصلاح پکیج‌های مورد استفاده ذکر شده در فایل <Important>go.mod</Important>، قبل از استقرار برنامه، دستور <Important>go mod tidy</Important> را اجرا کنید.
    </p>
    </Alert>
  </>
  )
  ...
  <>
  <video
  src="https://files.liara.ir/liara/golang/golang-cli.mp4"
  controls="controls"
  className="block w-full"
  width="100%"
  ></video>  
  ...
  <Step  steps={[
{
  ...
  <>
    <h3>ایجاد برنامه</h3>
    <p>با اجرای دستور زیر، برنامه Golang خود را ایجاد کنید:</p>
    <div dir='ltr'>
    <Highlight className="bash">
      {`liara create`}
    </Highlight>
    ...
    <p>در ادامه اجرای این دستور، باید به ترتیب، شناسه، نوع پلتفرم (که باید بر روی golang تنظیم شود)، شبکه خصوصی و <Link className="text-[#2196f3] " href="../details/plans/about">منابع سخت‌افزاری و بسته امکانات برنامه</Link>، مشخص شوند.</p>
  </>
  )
  },
  {
...
vendor/`}
  ...
  <>
    ...
    <div dir='ltr'>
    <Highlight className="bash">
      {`liara deploy --app=myapp --port=8080 --platform=golang`}
    </Highlight>
    </div>
  </>
  )
  ...
  <>
    <video
    src="https://files.liara.ir/liara/docs/Golang-github.mp4"
    controls="controls"
    className="block w-full"
    width="100%"
    ></video>
...
<Alert variant="success">
<p>
همچنین بخوانید: <Link className="text-[#2196f3] " href="./how-tos/create-app">استقرار قدم به قدم برنامه‌های Golang در لیارا</Link>
</p>
</Alert>
