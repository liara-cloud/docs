...
<div className="grid md:grid-cols-4 gap-4">
            {[
    { alt: 'https://files.liara.ir/liara/golang/go-gin.ico', platform: 'Gin', link: "/paas/golang/related-apps/gin/" },
    { alt: 'https://files.liara.ir/liara/golang/beego.ico', platform: 'BeeGo', link: "/paas/golang/related-apps/beego/" },
    { alt: 'https://files.liara.ir/liara/golang/echo-icon.png', platform: 'Echo', link: "/paas/golang/related-apps/echo/" },
    { alt: 'https://files.liara.ir/liara/golang/fiber-icon.ico', platform: 'Fiber', link: "/paas/golang/related-apps/fiber/" },
  ].map(item =>
              <Link href={item.link}>
                <Card className="flex cursor-pointer w-full items-center justify-between">
                  <div className="flex items-center gap-3">
