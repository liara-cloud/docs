...
<Layout>
<Head>
<title>مستندات تنظیم Cron Job در Python - لیارا</title>

<meta property="og:title" content="مستندات خدمات رایانش ابری لیارا" />
<meta property="og:description" content="مستندات نحوه تنظیم Cron Job در پلتفرم Python در لیارا"  />
...
<Tabs 
    ...
    <>
      ...
      <div className="h-4" />
      <img src="https://files.liara.ir/liara/docs/python-cronjob.png" alt="set cron jobs on liara" />
