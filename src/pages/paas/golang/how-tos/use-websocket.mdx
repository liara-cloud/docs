...
پروژه‌ در پیش‌رو، یک چت‌روم تحت وب در  Golang است که کاربران می‌توانند در آن به صورت Realtime (با تکیه بر WebSocket) به گفتگو بپردازند.
در ابتدا، بایستی با اجرای دستور زیر، یک پروژه جدید Golang را، ایجاد کنید:
