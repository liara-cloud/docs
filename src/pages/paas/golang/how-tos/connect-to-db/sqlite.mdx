...
همچنین، طبق مستندات مربوط به <a href="/paas/golang/how-tos/use-cgo" className="text-[#2196f3]">قابلیت Cgo</a>، این قابلیت را بایستی با قرار دادن قطعه کد زیر در فایل <Important>liara.json</Important> یا اعمال در کنسول در حین استقرار، در پروژه خود، فعال کنید: 
