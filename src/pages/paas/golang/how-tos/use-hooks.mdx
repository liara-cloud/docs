...
<Layout>
<Head>
<title>مستندات استفاده از Hooks در Golang - لیارا</title>

<meta property="og:title" content="مستندات خدمات رایانش ابری لیارا" />
<meta property="og:description" content="مستندات نحوه استفاده از Hookها در پلتفرم Golang در لیارا"  />
<meta property="og:image" content="https://files.liara.ir/liara/logos/liara-poster.jpg" />
</Head>
# استفاده از Hooks در برنامه‌های Golang
<hr className="mb-2" />
...
<p>
توجه داشته باشید که در <a href="../choose-version" className="text-[#2196f3] ">نسخه‌های بدون به‌روزرسانی Golang</a>، این قابلیت پشتیبانی نمی‌شود.
