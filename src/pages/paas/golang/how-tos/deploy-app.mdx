...
`}
        ...
        {/* <div className="h-4" />
        <img src="https://files.liara.ir/liara/docs/deploy-Golang-app-using-console.gif" alt="build app on liara" />
        <div className="h-4" /> */}
        <p>
    ...
    <>
        ...
        <div className="h-2" />
        <Link href="https://github.com/liara-cloud/gitignore-templates/blob/master/golang/.gitignore" target="_blank">
...
{/* 
  ...
  "go": {
    ...
    "timezone": "America/Los_Angeles"
        ...
        <Alert variant='success'>همچنین بخوانید: <a className="text-[#2196f3] " href="/paas/golang/how-tos/use-cgo">استفاده از قابلیت Cgo در برنامه</a></Alert>
        <p>
