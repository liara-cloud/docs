...
<meta property="og:description" content="مستندات نحوه استقرار برنامه‌های Golang در لیارا"  />
<meta property="og:image" content="https://files.liara.ir/liara/logos/liara-poster.jpg" />
</Head>

# استقرار برنامه Golang در لیارا
<hr className="mb-2" />
    ...
    content={[
        ...
        <p>
            همچنین،
            اگر از کتابخانه یا پکیج خاصی در پروژه خود، استفاده می‌کنید که به صورت built-in یا پیش‌فرض در نسخه Golang مدنظرتان وجود ندارد، 
            ...
            قطعه کد زیر، می‌تواند یک نمونه از فایل <Important>go.mod</Important> برای برنامه‌های Golang باشد:
        </p>
        <div className="h-4" />
        <div dir='ltr'>
...
`}
        ...
        <p>
            ...
            قطعه کد زیر، می‌تواند یک نمونه از فایل <Important>go.sum</Important> برای برنامه‌های Golang باشد:
        </p> 
        <div className="h-2" />  
        <div dir='ltr'>
        <Highlight className="bash">
    ...
    <>
        ...
        <Link href="https://github.com/liara-cloud/gitignore-templates/blob/master/golang/.gitignore" target="_blank">
            <Card className="flex cursor-pointer w-full items-center justify-between">
                ...
                <h4>
                    نمونه فایل <Important>gitignore.</Important> برای برنامه‌های Golang
                </h4>
                </div>
...
`}
    ...
    "port": 8000
        ...
        <div className='h-4' />
        <p>
            در قطعه کد فوق، در فیلد <Important>app</Important> باید شناسه برنامه خود را به جای <Important>my-golang-app</Important> وارد کنید.
            در فیلد <Important>platform</Important> باید نوع پلتفرم خود را که golang است، مشخص کنید. 
  ...
  "golang": {
    "mirror": false
        ...
        <p>
            برای تعیین نسخه Golang برنامه خود نیز، کافیست تا در فایل <Important>liara.json</Important> فیلد <Important>version</Important> را قرار دهید:
        </p>
        <div className="h-4" />
        <div dir='ltr'>
            <Highlight className="json">
  ...
  "golang": {
    "version": "1.22"
        ...
        <Alert variant='success'>همچنین بخوانید:  <a className="text-[#2196f3] " href="../choose-version">نسخه‌های قابل ارائه Golang در لیارا</a></Alert>
    ...
    <>  
       <p>
        ...
        <p>
            ...
            قطعه کد زیر، یک نمونه از فایل <Important>requirements.txt</Important> برای برنامه‌های Golang است:
        </p>
        <div className="h-4" />
        <div dir='ltr'>
            <Highlight className="txt">
