  ...
  <Step  steps={[
{
  ...
  <>
    ...
    <p>در فایل <Important>package.json</Important> موجود در مسیر اصلی پروژه، باید حتماً اسکریپت <Important>start</Important> تعریف شده باشد؛  به عنوان مثال، فایل <Important>package.json</Important> می‌تواند به شکل زیر باشد:</p>
    <div className="h-2" />
    <div dir='ltr'>
  ...
  <>
  <video
  src="https://files.liara.ir/liara/quick-start/angular/angular-cli.mp4"
  controls="controls"
  className="block w-full"
  width="100%"
  ></video>
...
<p>
همچنین بخوانید: <Link className="text-[#2196f3] " href="./how-tos/create-app">استقرار قدم به قدم برنامه‌های Angular در لیارا</Link>
</p>
</Alert>
</Layout>