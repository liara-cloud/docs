...
توجه داشته باشید؛ تنها برنامه‌هایی که با <Important>Angular CLI</Important> ساخته شده باشند، در پلتفرم Angular لیارا قابل اجرا خواهند بود.
    ...
    <>
        ...
        <div className="h-4" />
        <p>
            قطعه کد زیر یک نمونه استاندارد، یک نمونه از فایل <Important>package.json</Important> استاندارد برای برنامه‌های Angular است:
        </p>
        <div className="h-4" />
        <div dir='ltr'>
  ...
  "devDependencies": {
    ...
    "typescript": "~4.5.2"
        ...
        {/* <div className="h-4" />
        <img src="https://media.liara.ir/docs/deploy-angular-app-using-console.gif" alt="build app on liara" />
        <div className="h-4" /> */}
        <p>
