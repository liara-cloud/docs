...
توجه داشته باشید؛ تنها برنامه‌هایی که با <Important>Angular CLI</Important> ساخته شده باشند، در پلتفرم Angular لیارا قابل اجرا خواهند بود.
  ...
  "devDependencies": {
    ...
    <>
        ...
        <div className="h-4" />
        <p>
            قطعه کد زیر، یک نمونه از فایل <Important>package.json</Important> استاندارد برای برنامه‌های Angular است که با استفاده از <Important>Vite</Important> ساخته شده‌اند:
        </p>
        <div className="h-4" />
        <div dir='ltr'>
            <Highlight className="json">
  ...
  "devDependencies": {
    ...
    <div className="h-2" />
        <p>
            قطعه کد زیر نیز، یک نمونه از فایل <Important>package.json</Important> استاندارد برای برنامه‌های Angular است که با استفاده از دستور <Important>create-react-app</Important> ساخته شده‌اند:
        </p>        <div className="h-4" />
        <div dir='ltr'>
            <Highlight className="json">
                {`{
