...
<Tabs 
  ...
  <>
  <video
  src="https://media.liara.ir/python/python-desktop.mp4"
  controls="control/s"
  ...
  <Step  steps={[
{
  ...
  <>
  <video
  src="https://media.liara.ir/python/python-cli.mp4"
  controls="controls"
  className="block w-full"
  width="100%"
  ></video>
...
.cache`}
  ...
  <>
    <video
    src="https://media.liara.ir/docs/python-github.mp4"
    controls="controls"
    className="block w-full"
    width="100%"
    ></video>
...
<br/> 
    ...
    "args": [ "python3 app.py" ]
        ...
        <Alert variant="error">
         <p>
         در حال حاضر، امکان تعیین دستور اجرا در روش Liara Console وجود ندارد و در این روش، به صورت پیش‌فرض، دستور <Important>python3 main.py</Important> اجرا خواهد شد.
         </p>
        </Alert>
