...
<Layout>
<Head>
<title>مستندات تنظیم Cron Job در go - لیارا</title>

<meta property="og:title" content="مستندات خدمات رایانش ابری لیارا" />
<meta property="og:description" content="مستندات نحوه تنظیم Cron Job در پلتفرم go در لیارا"  />
...
<Tabs 
    ...
    <>
      ...
      <div className="h-4" />
      <img src="https://media.liara.ir/go/set-cron-job-in-go-using-console.png" alt="set cron jobs on liara" />
