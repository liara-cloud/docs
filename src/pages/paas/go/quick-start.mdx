...
<meta property="og:description" content="مستندات نحوه استقرار سریع پلتفرم Go در لیارا"  />
</Head>
...
<Tabs 
  ...
  <>
  <video
  src="https://media.liara.ir/go/go-desktop.mp4"
  controls="control/s"
  ...
  <Step  steps={[
{
  ...
  <>
  <video
  src="https://media.liara.ir/go/go-cli.mp4"
  controls="controls"
  className="block w-full"
  width="100%"
  ></video>  
  ...
  <Step  steps={[
{
  ...
  <>
    <h3>ایجاد برنامه</h3>
    <p>با اجرای دستور زیر، برنامه go خود را ایجاد کنید:</p>
    <div dir='ltr'>
    <Highlight className="bash">
      {`liara create`}
    </Highlight>
    ...
    <p>در ادامه اجرای این دستور، باید به ترتیب، شناسه، نوع پلتفرم (که باید بر روی go تنظیم شود)، شبکه خصوصی و <Link className="text-[#2196f3] " href="../details/plans/about">منابع سخت‌افزاری و بسته امکانات برنامه</Link>، مشخص شوند.</p>
  </>
  )
  },
  {
...
vendor/`}
  ...
  <>
    <video
    src="https://media.liara.ir/docs/go-github.mp4"
    controls="controls"
    className="block w-full"
    width="100%"
    ></video>
...
<Alert variant="success">
<p>
همچنین بخوانید: <Link className="text-[#2196f3] " href="./how-tos/create-app">استقرار قدم به قدم برنامه‌های go در لیارا</Link>
</p>
</Alert>
