...
<div className="grid md:grid-cols-4 gap-4">
            {[
    { alt: 'https://media.liara.ir/go/go-gin.ico', platform: 'Gin', link: "/paas/go/related-apps/gin/" },
    { alt: 'https://media.liara.ir/go/beego.ico', platform: 'BeeGo', link: "/paas/go/related-apps/beego/" },
    { alt: 'https://media.liara.ir/go/echo-icon.png', platform: 'Echo', link: "/paas/go/related-apps/echo/" },
    { alt: 'https://media.liara.ir/go/fiber-icon.ico', platform: 'Fiber', link: "/paas/go/related-apps/fiber/" },
  ].map(item =>
              <Link href={item.link}>
                <Card className="flex cursor-pointer w-full items-center justify-between">
                  <div className="flex items-center gap-3">
