...
طبق <a href="https://docs.celeryproject.org/en/stable/django/first-steps-with-django.html" className="blue-link">مستندات شروع به کار با Celery در برنامه‌های Django</a>، فرض می‌شود که شما برنامه‌ای با ساختار زیر دارید:
<div className="h-2" />
<div dir='ltr'>
