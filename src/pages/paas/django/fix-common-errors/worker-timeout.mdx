...
<meta property="og:description" content="مستندات مربوط به رفع خطای Worker Timeout در پلتفرم Django در لیارا"  />
...
<div className="h-2" />
<img src="https://files.liara.ir/liara/old/django/add-gunicorn-timeout-variable-to-django-app.gif" alt="set gunicorn timeout env" />
