...
در صورتی که در برنا‌مه‌ی Django خود نیاز به ری‌استارت WORKER THREAD بعد از تعداد مشخصی Request دارید، می‌توانید طبق مستندات <a href="../../details/envs" className="text-[#2196f3] ">تنظیم متغیرهای محیطی</a>، متغیر محیطی <Important>GUNICORN_MAX_REQUESTS</Important> را با مقدار 1000 به برنامه Django خود، اضافه کنید.
