...
<Layout>
<Head>
<title>مستندات اتصال به دیتابیس‌ MySQL و MariaDB در Django - لیارا</title>

<meta property="og:title" content="مستندات خدمات رایانش ابری لیارا" />
<meta property="og:description" content="مستندات مربوط به اتصال به دیتابیس MySQL یا MariaDB در پلتفرم Django در لیارا"  />
