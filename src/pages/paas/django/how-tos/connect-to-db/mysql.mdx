...
<Layout>
<Head>
<title>مستندات اتصال به دیتابیس‌ MySQL MariaDB در Django - لیارا</title>
</Head>
...
<div className="h-2" />
اکنون می‌توانید برنامه‌تان را در لیارا مستقر کرده و در صفحه <Important>mysql/</Important> وضعیت اتصال به دیتابیس خود را بررسی کنید.
