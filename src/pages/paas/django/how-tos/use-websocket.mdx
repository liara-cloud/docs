...
<Alert variant="warning">
<p>
باید طبق مستندات <a href="../../details/env" className="text-[#2196f3] ">تنظیم متغیرهای محیطی</a>، یک متغیر محیطی به نام <Important>REDIS_URI</Important> با مقدار URI دیتابیس Redis خود به برنامه Djangoتان، اضافه کنید.
</p>
</Alert>
