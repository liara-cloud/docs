...
برای تنظیم تعداد Workerهای Gunicorn کافیست تا طبق مستندات <a href="../../details/envs" className="text-[#2196f3] ">تنظیم متغیرهای محیطی</a>، یک متغیر محیطی به نام <Important>GUNICORN_WORKERS</Important>
