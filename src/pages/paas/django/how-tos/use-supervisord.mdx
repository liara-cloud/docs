...
شما می‌توانید در مسیر اصلی پروژه، یک فایل به نام <Important>supervisor.conf</Important> ایجاد کنید و درون این فایل، Workerهای خود را برای اجرای background jobها، تعریف کنید. به عنوان مثال، برای ایجاد یک Worker در یک برنامه <a href="../related-apps/celery" className="text-[#2196f3] ">celery</a>، می‌توانید از قطعه کد زیر استفاده کنید:
