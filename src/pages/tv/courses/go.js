        ...
        links={[
          {
            ...
            link:
              "https://media.liara.ir/go/course/e00-intro-to-project.mp4"
          },
          {
            videoTitle: "جلسه 1: اتصال به دیتابیس لیارا از Local",
            link:
              "https://media.liara.ir/go/course/e01-connect-to-db.mp4"
          },
          {
            videoTitle: "جلسه 2: اتصال برنامه به سرویس‌های Email و DNS لیارا",
            link:
              "https://media.liara.ir/go/course/e02-email-and-dns.mp4"
          },
          {
            videoTitle: "جلسه 3: اتصال برنامه به باکت در لیارا",
            link:
              "https://media.liara.ir/go/course/e03-upload-using-bucket.mp4"
          },
          {
            videoTitle: "جلسه 4: استقرار کامل برنامه در لیارا",
            link:
              "https://media.liara.ir/go/course/e04-deploy-in-liara.mp4"
          },
          {
            videoTitle: "جلسه 5: استفاده از دیسک‌ها در برنامه",
            link: "https://media.liara.ir/go/course/e05-use-disks.mp4"
          },
          {
            videoTitle: "جلسه 6: مدیریت دیسک‌ها با دسترسی FTP",
            link:
              "https://media.liara.ir/go/course/e06-manage-disks-using-ftp.mp4"
          },
          {
            videoTitle: "جلسه 7: بازیابی دیتابیس در لیارا",
            link:
              "https://media.liara.ir/go/course/e07-restore-db.mp4"
          },
          {
            videoTitle: "جلسه 8: فعال‌سازی باکت و ایمیل‌سرور",
            link:
              "https://media.liara.ir/go/course/e08-enable-bucket-and-email.mp4"
          },
          {
            videoTitle: "جلسه 9: اتصال دامنه به برنامه در لیارا",
            link:
              "https://media.liara.ir/go/course/e09-connect-domain-to-app.mp4"
          },
          {
            videoTitle: "جلسه 10: راه‌اندازی CI/CD در برنامه",
            link: "https://media.liara.ir/go/course/e10-cicd.mp4"
          }
        ]}
      />
      <br />
