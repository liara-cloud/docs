        ...
        links={[
          {
            ...
            link: "https://media.liara.ir/php/course/php-e0.mp4"
          },
          {
            videoTitle: "جلسه 1: راه‌اندازی دیتابیس در لیارا",
            link: "https://media.liara.ir/php/course/php-e1.mp4"
          },
          {
            videoTitle: "جلسه 2: بازیابی دیتابیس حذف‌شده",
            link: "https://media.liara.ir/php/course/php-e2.mp4"
          },
          {
            videoTitle: "جلسه 3: راه‌اندازی DNS و Email Server",
            link: "https://media.liara.ir/php/course/php-e3.mp4"
          },
          {
            videoTitle: "جلسه 4: استقرار برنامه در لیارا",
            link: "https://media.liara.ir/php/course/php-e4.mp4"
          },
          {
            videoTitle: "جلسه 5: رفع خطاهای اجرای برنامه",
            link: "https://media.liara.ir/php/course/php-e5.mp4"
          },
          {
            videoTitle: "جلسه 6: منوهای برنامه در لیارا",
            link: "https://media.liara.ir/php/course/php-e6.mp4"
          },
          {
            videoTitle: "جلسه 7: استفاده از دیسک‌ها در برنامه",
            link: "https://media.liara.ir/php/course/php-e7.mp4"
          },
          {
            videoTitle: "جلسه 8: دسترسی به دیسک با  FTP",
            link: "https://media.liara.ir/php/course/php-e8.mp4"
          },
          {
            videoTitle: "جلسه 9: اتصال به Object Storage",
            link: "https://media.liara.ir/php/course/php-e9.mp4"
          },
          {
            videoTitle: "جلسه 10: اتصال دامنه به برنامه",
            link: "https://media.liara.ir/php/course/php-e10.mp4"
          },
          {
            videoTitle: "جلسه 11: راه‌اندازی CI/CD",
            link: "https://media.liara.ir/php/course/php-e11.mp4"
          }
        ]}
      />
      <br />
