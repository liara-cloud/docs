        ...
        links={[
          {
            ...
            link:
              "https://media.liara.ir/laravel/cource/e00-intro-to-project.mp4"
          },
          {
            videoTitle: "جلسه 1: اتصال به دیتابیس لیارا از Local",
            link:
              "https://media.liara.ir/laravel/cource/e01-connect-to-liara-db.mp4"
          },
          {
            videoTitle: "جلسه 2: بازیابی دیتابیس در لیارا",
            link:
              "https://media.liara.ir/laravel/cource/e02-restoring-liara-database.mp4"
          },
          {
            videoTitle: "جلسه 3:اتصال به DNS و Email Server",
            link:
              "https://media.liara.ir/laravel/cource/e03-connect-to-emailserver.mp4"
          },
          {
            videoTitle: "جلسه 4: استقرار پروژه در لیارا",
            link:
              "https://media.liara.ir/laravel/cource/e04-deployment-in-liara.mp4"
          },
          {
            videoTitle: "جلسه 5: استفاده از Diskها در پروژه ",
            link:
              "https://media.liara.ir/laravel/cource/e05-using-disks-in-liara.mp4"
          },
          {
            videoTitle: "جلسه 6: استفاده از باکت لیارا به جای دیسک‌ها",
            link:
              "https://media.liara.ir/laravel/cource/e06-using-buckets-in-liara.mp4"
          },
          {
            videoTitle: "جلسه 7: اتصال دامنه به برنامه در لیارا",
            link:
              "https://media.liara.ir/laravel/cource/e07-domains-and-more-options.mp4"
          },
          {
            videoTitle: "جلسه 8: راه‌اندازی CI/CD در برنامه",
            link:
              "https://media.liara.ir/laravel/cource/e08-cicd-feature-in-liara.mp4"
          }
        ]}
      />
      <br />
