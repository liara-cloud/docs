...
<Layout>
<Head>
<title>مستندات شروع به کار با هوش مصنوعی MiniMax - لیارا</title>

<meta property="og:title" content="مستندات خدمات رایانش ابری لیارا" />
<meta property="og:description" content="مستندات شروع به کار با هوش مصنوعی MiniMax در لیارا"  />
</Head>
# شروع به کار با هوش مصنوعی MiniMax
<hr className="mb-2" />

<a href="https://www.minimax.io/" target='_blank' className="text-[#2196f3]">MiniMax</a> یک پلتفرم و پیشرو در توسعه مدل‌های بنیادین هوش مصنوعی است که هدفش پیشبرد مرزهای هوش مصنوعی عمومی (AGI) و ارائه قابلیت‌های هوشمند در گستره‌ای از داده‌ها است. 
...
پس از <a href="/ai/quick-start" className="text-[#2196f3] " >ایجاد سرویس هوش مصنوعی</a> و دریافت <Important>baseUrl</Important> و <a href="/ai/details/keys/#create" className="text-[#2196f3]" >ساخت کلید</a>، می‌توانید از مدل‌های MiniMax استفاده کنید.
