...
<Layout>
<Head>
<title>مستندات شروع به کار با هوش مصنوعی AION Labs - لیارا</title>

<meta property="og:title" content="مستندات خدمات رایانش ابری لیارا" />
<meta property="og:description" content="مستندات شروع به کار با هوش مصنوعی AION Labs در لیارا"  />
</Head>
# شروع به کار با هوش مصنوعی AION Labs
<hr className="mb-2" />

<a href="https://aionlabs.ai" target='_blank' className="text-[#2196f3]">AION Labs</a> پلتفرمی است که مدل‌های زبانی آماده برای استفاده در کاربردهای عملی و سازمانی ارائه می‌دهد. 
...
<div className="h-2" />
<ul className="pr-4">
  {models["aion-labs"].map((item, index) => (
    <li
      key={index}
      style={{
...
پس از <a href="/ai/quick-start" className="text-[#2196f3] " >ایجاد سرویس هوش مصنوعی</a> و دریافت <Important>baseUrl</Important> و <a href="/ai/details/keys/#create" className="text-[#2196f3]" >ساخت کلید</a>، می‌توانید از مدل‌های aion-labs استفاده کنید.
