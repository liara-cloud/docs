...
<Layout>
<Head>
<title>مستندات شروع به کار با هوش مصنوعی Grok - لیارا</title>

<meta property="og:title" content="مستندات خدمات رایانش ابری لیارا" />
<meta property="og:description" content="مستندات شروع به کار با هوش مصنوعی x-AI Grok در لیارا"  />
<meta property="og:image" content="https://media.liara.ir/logos/liara-poster.jpg" />
</Head>
# شروع به کار با هوش مصنوعی X-AI/Grok
<hr className="mb-2" />

<a href="https://grok.com" target='_blank' className="text-[#2196f3] " >Grok</a> یک مدل هوش مصنوعی گفت‌وگومحور است که توسط شرکت xAI، به رهبری ایلان ماسک، توسعه داده شده و با پلتفرم X (توییتر سابق) ادغام شده است. Grok با الهام از شخصیت‌های طناز و جسور طراحی شده و هدفش ارائه پاسخ‌هایی دقیق، گاهی با لحن شوخ‌طبع، و درک بهتر سوالات پیچیده کاربران است. این مدل تلاش می‌کند تا علاوه بر پاسخ‌دهی مبتنی بر داده‌های زنده از شبکه X، تعامل انسانی‌تری با کاربران برقرار کند و رقیبی برای مدل‌هایی مانند GPT و Gemini باشد.
...
پس از <a href="/ai/quick-start" className="text-[#2196f3] " >ایجاد سرویس هوش مصنوعی</a> و دریافت <Important>baseUrl</Important> و <a href="/references/api/about/" className="text-[#2196f3]" >کلید API</a>، می‌توانید از مدل‌های Grok استفاده کنید.
