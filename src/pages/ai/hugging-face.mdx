...
<Layout>
<Head>
<title>مستندات شروع به کار با هوش مصنوعی های موجود در Hugging Face - لیارا</title>

<meta property="og:title" content="مستندات خدمات رایانش ابری لیارا" />
<meta property="og:description" content="مستندات شروع به کار با هوش مصنوعی های موجود در Hugging Face در لیارا"  />
</Head>
# شروع به کار با مدل‌های موجود در Hugging Face
<hr className="mb-2" />

<a href="https://huggingface.co" target='_blank' className="text-[#2196f3]">Hugging Face</a> یکی از شناخته‌شده‌ترین پلتفرم‌های متن‌باز در حوزه هوش مصنوعی است که بستری برای توسعه، اشتراک‌گذاری و استفاده از مدل‌های مختلف را فراهم می‌کند. 
...
<div className="h-2" />
<ul className="pr-4">
  {models["intfloat"].map((item, index) => (
    <li
      key={index}
      style={{
...
پس از <a href="/ai/quick-start" className="text-[#2196f3] " >ایجاد سرویس هوش مصنوعی</a> و دریافت <Important>baseUrl</Important> و <a href="/ai/details/keys/#create" className="text-[#2196f3]" >ساخت کلید</a>، می‌توانید از مدل‌های Hugging Face استفاده کنید.
