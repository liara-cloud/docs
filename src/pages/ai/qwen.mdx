...
<ul className="pr-4">
  {[
    {text: <Important>qwen/qwen-turbo</Important>,},
    {text: <Important>qwen/qwen-2.5-72b-instruct</Important>,},
    {text: <Important>qwen/qwen-plus</Important>,},
    {text: <Important>qwen/qwen-max</Important>,},
    {text: <Important>qwen/qwen3-235b-a22b-thinking-2507</Important>,},
    {text: <Important>qwen/qwen3-32b</Important>,},
    {text: <Important>qwen/qwen3-coder</Important>,},
  ].map((item, index) => (
    <li
      key={index}
      style={{
