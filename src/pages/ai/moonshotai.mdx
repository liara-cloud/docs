...
<Layout>
<Head>
<title>مستندات شروع به کار با هوش مصنوعی MoonshotAI/Kimi - لیارا</title>

<meta property="og:title" content="مستندات خدمات رایانش ابری لیارا" />
<meta property="og:description" content="مستندات شروع به کار با هوش مصنوعی MoonshotAI/Kimi در لیارا"  />
</Head>
# شروع به کار با هوش مصنوعی MoonshotAI/Kimi
<hr className="mb-2" />

<a href="https://www.moonshot.ai" target='_blank' className="text-[#2196f3] " >MoonshotAI/Kimi</a> یک مدل زبانی بزرگ با معماری Mixture of Experts (MoE) از شرکت Moonshot AI است که مجموعاً ۱ تریلیون پارامتر دارد، ولی در هر اجرا تنها حدود ۳۲ میلیارد پارامتر فعال می‌شوند.
...
<div className="h-2" />
<ul className="pr-4">
  {models.moonshotai.map((item, index) => (
    <li
      key={index}
      style={{
...
پس از <a href="/ai/quick-start" className="text-[#2196f3] " >ایجاد سرویس هوش مصنوعی</a> و دریافت <Important>baseUrl</Important> و <a href="/ai/details/keys/#create" className="text-[#2196f3]" >ساخت کلید</a>، می‌توانید از مدل MoonshotAI/Kimi استفاده کنید.
