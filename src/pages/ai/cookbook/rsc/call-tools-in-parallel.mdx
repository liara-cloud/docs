...
client side rendering و هوک‌ها استفاده کنید؛ می‌توانید به <a href="/ai/cookbook/nextjs/call-tools-in-parallel" className="text-[#2196f3]">این مستندات</a> مراجعه کنید. 
</p>
</Alert>
<div className="h-2" />
...
بیایید یک Tool به نام <Important>getWeather</Important> را برای چندین شهر، به‌صورت موازی، فراخوانی کنیم.
...
اکنون، بیایید تابع <Important>getWeather</Important> را تعریف کنیم.
...
<p>
پروژه فوق را می‌توانید به‌صورت کامل در <a href="https://github.com/liara-cloud/ai-sdk-examples/tree/master/RSC/call-tools-in-parallel" className="text-[#2196f3]">گیت‌هاب لیارا</a>، مشاهده کنید. 
</p>
</Alert>
