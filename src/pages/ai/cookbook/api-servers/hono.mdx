...
import Head from "next/head";
 ...
 <Layout>
<Head>
<title>مستندات اتصال به AI در فریم‌ورک Hono - لیارا</title>
<meta property="og:title" content="مستندات خدمات رایانش ابری لیارا" />
<meta property="og:description" content="مستندات مربوط به آشنایی با نحوه اتصال به سرویس هوش مصنوعی لیارا در فریم‌ورک Hono"  />
</Head>
...
می‌توانید با استفاده از متد <Important>toTextStreamResponse</Important>، یک استریم متنی به کلاینت ارسال کنید.
...
<p>
پروژه فوق را می‌توانید به‌صورت کامل در <a href="https://github.com/liara-cloud/ai-sdk-examples/tree/master/API-Servers/hono" className="text-[#2196f3]">گیت‌هاب لیارا</a>، مشاهده کنید. 
</p>
</Alert>
