...
برای ساده‌تر کردن این آموزش، از یک <a href="https://github.com/liara-cloud/ai-sdk-examples/tree/master/rag-agent-completed" className="text-[#2196f3]">ریپازیتوری آماده</a> استفاده می‌کنیم که برخی از تنظیمات اولیه را از قبل دارد:
<div className="h-2" />
<ul>
...
<Section id='add-resource-tool' title='افزودن resource tool' />
