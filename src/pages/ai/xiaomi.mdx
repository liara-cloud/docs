...
<Layout>
<Head>
<title>مستندات شروع به کار با هوش مصنوعی Xiaomi - لیارا</title>

<meta property="og:title" content="مستندات خدمات رایانش ابری لیارا" />
<meta property="og:description" content="مستندات شروع به کار با هوش مصنوعی Xiaomi در لیارا"  />
</Head>
# شروع به کار با هوش مصنوعی Xiaomi
<hr className="mb-2" />

<a href="https://mimo.xiaomi.com/" target='_blank' className="text-[#2196f3]">Xiaomi MiMo</a> یک LLM توسعه‌یافته است که برای درک و تولید متن، پاسخ‌گویی به سوالات، برنامه‌نویسی، استدلال و انجام taskهای مختلف طراحی شده است. 
...
پس از <a href="/ai/quick-start" className="text-[#2196f3] " >ایجاد سرویس هوش مصنوعی</a> و دریافت <Important>baseUrl</Important> و <a href="/ai/details/keys/#create" className="text-[#2196f3]" >ساخت کلید</a>، می‌توانید از مدل‌های Xiaomi استفاده کنید.
