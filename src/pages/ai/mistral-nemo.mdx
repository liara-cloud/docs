...
<Layout>
<Head>
<title>مستندات شروع به کار با هوش مصنوعی Mistral/NeMo - لیارا</title>

<meta property="og:title" content="مستندات خدمات رایانش ابری لیارا" />
<meta property="og:description" content="مستندات شروع به کار با هوش مصنوعی Mistral/NeMo در لیارا"  />
<meta property="og:image" content="https://media.liara.ir/logos/liara-poster.jpg" />
</Head>
# شروع به کار با هوش مصنوعی NeMo
<hr className="mb-2" />

مدل <a href="https://mistral.ai/news/mistral-nemo" target='_blank' className="text-[#2196f3] " >Mistral NeMo</a> یک مدل زبان پیشرفته با ۱۲ میلیارد پارامتر است که حاصل همکاری شرکت فرانسوی Mistral AI و شرکت NVIDIA می‌باشد. این مدل در ژوئیه ۲۰۲۴ معرفی شد و به‌عنوان یک مدل منبع‌باز تحت مجوز Apache 2.0 منتشر شده است.
...
<ul className="pr-4">
  {[
    {text: <Important>mistralai/mistral-nemo</Important>,},
...
پس از <a href="/ai/quick-start" className="text-[#2196f3] " >ایجاد سرویس هوش مصنوعی</a> و دریافت <Important>baseUrl</Important> و <a href="/references/api/about/" className="text-[#2196f3]" >کلید API</a>، می‌توانید از مدل NeMo استفاده کنید.
