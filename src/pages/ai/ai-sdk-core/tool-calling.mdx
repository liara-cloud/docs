...
<Section id='extracting-tools' title='استخراج Toolها' />
...
تنها کافیست تا یک دایرکتوری برای toolهای خود به نام <Important>tools</Important> ایجاد کنید، درون آن یک فایل به نام 
<Important>weather-tool.ts</Important> بسازید و کدی مشابه قطعه کد زیر را، درون آن 
قرار دهید: 
