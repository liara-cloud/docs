...
<Layout>
<Head>
<title>مستندات شروع به کار با هوش مصنوعی Anthropic/Claude - لیارا</title>

<meta property="og:title" content="مستندات خدمات رایانش ابری لیارا" />
<meta property="og:description" content="مستندات شروع به کار با هوش مصنوعی Anthropic/Claude در لیارا"  />
<meta property="og:image" content="https://media.liara.ir/logos/liara-poster.jpg" />
</Head>
# شروع به کار با هوش مصنوعی Claude
<hr className="mb-2" />

مدل <a href="https://claude.ai/" target='_blank' className="text-[#2196f3] " >Claude</a>  توسط شرکت Anthropic توسعه یافته که توسط تعدادی از اعضای پیشین OpenAI تأسیس شده است. Claude با هدف ایمنی، اخلاق‌مداری و تعامل طبیعی با کاربران طراحی شده و رقیبی جدی برای مدل‌هایی مانند GPT و Gemini به شمار می‌رود. این مدل بر پایه فلسفه "قابلیت کنترل" توسعه یافته است، به این معنا که رفتار مدل با دقت بیشتری قابل هدایت و پیش‌بینی است. Claude در نسخه‌های مختلفی منتشر شده و به دلیل تمرکز ویژه بر ایمنی، در محیط‌های حساس و سازمانی نیز مورد توجه قرار گرفته است.
<div className="h-4" />
...
<ul className="pr-4">
  {[
    {text: <Important>anthropic/claude-3.7-sonnet</Important>,},
    {text: <Important>anthropic/claude-3.7-sonnet:thinking</Important>,},
    {text: <Important>anthropic/claude-3.7-sonnet:beta</Important>,},
    {text: <Important>anthropic/claude-3.5-sonnet</Important>,},
    {text: <Important>anthropic/claude-opus-4</Important>,},
    {text: <Important>anthropic/claude-sonnet-4</Important>,},
...
پس از <a href="/ai/quick-start" className="text-[#2196f3] " >ایجاد سرویس هوش مصنوعی</a> و دریافت <Important>baseUrl</Important> و <a href="/references/api/about/" className="text-[#2196f3]" >کلید API</a>، می‌توانید از مدل‌های Claude استفاده کنید.
