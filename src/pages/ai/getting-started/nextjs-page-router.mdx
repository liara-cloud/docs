...
<Layout>
<Head>
<title>مستندات کار با AI SDK در NextJS Pages Router - لیارا</title>
<meta property="og:title" content="مستندات خدمات رایانش ابری لیارا" />
<meta property="og:description" content="مستندات مربوط به استفاده از AI SDK در NextJS Pages Router محصول هوش مصنوعی لیارا"  />
</Head>
...
<p>
هنگامی که از شما سوال شد، حتماً گزینه <Important>App Router</Important> را بر روی <Important>no</Important> و گزینه‌های <Important>TypeScript</Important> و <Important>Tailwind CSS</Important> را روی <Important>yes</Important> تنظیم کنید.
</p>
</Alert>
<div className="h-2" />
...
در فایل  <Important>pages/index.tsx</Important>، قطعه کد زیر را قرار دهید تا یک لیست از پیام‌های چت، نمایش داده شود و امکان ارسال پیام کاربر، فراهم گردد:
...
برای به‌روزرسانی رابط کاربری و نمایش <Important>tool invocation</Important>، باید فایل <Important>pages/index.tsx</Important> را تغییر دهید تا پیام‌هایی که شامل Tool هستند نیز، به درستی نمایش داده شوند.
...
فایل <Important>pages/index.tsx</Important> خود را ویرایش کرده تا گزینه‌ی <Important>maxSteps</Important> را به آن، اضافه کنید:
...
<p>
پروژه نهایی مورد بررسی در این آموزش، در <a href="https://github.com/liara-cloud/ai-sdk-examples/tree/master/NextJS-Pages-Router-ChatBot" className="text-[#2196f3]">گیت‌هاب لیارا</a> موجود است که می‌توانید از آن، استفاده کنید.
</p>
</Alert>
