...
<Layout>
<Head>
<title>مستندات شروع به کار با هوش مصنوعی OpenAI - لیارا</title>

<meta property="og:title" content="مستندات خدمات رایانش ابری لیارا" />
<meta property="og:description" content="مستندات شروع به کار با هوش مصنوعی OpenAI در لیارا"  />
<meta property="og:image" content="https://media.liara.ir/logos/liara-poster.jpg" />
</Head>
# شروع به کار با هوش مصنوعی OpenAI
<hr className="mb-2" />

هوش مصنوعی <a href="https://openai.com" target='_blank' className="text-[#2196f3] " >OpenAI</a> مجموعه‌ای از مدل‌های پیشرفته است که برای درک و تولید زبان طبیعی، حل مسائل پیچیده، و تعامل انسانی طراحی شده‌است. 
...
پس از <a href="/ai/quick-start" className="text-[#2196f3] " >ایجاد سرویس هوش مصنوعی</a> و دریافت <Important>baseUrl</Important> و <a href="/references/api/about/" className="text-[#2196f3]" >کلید API</a>، می‌توانید مانند دستورات و قطعه‌های کد زیر، از مدل‌های OpenAI استفاده کنید.
