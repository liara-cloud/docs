...
<ul className="pr-4">
  {[
    {text: <Important>openai/gpt-5</Important>,},
    ...
    {text: <Important>openai/o3</Important>,},
    {text: <Important>openai/o1</Important>,},
    {text: <Important>openai/gpt-5-codex</Important>,},
    {text: <Important>openai/text-embedding-ada-002</Important>,},
    {text: <Important>openai/text-embedding-3-small</Important>,},
    {text: <Important>openai/text-embedding-3-large</Important>,},
  ].map((item, index) => (
    <li
      key={index}
      style={{
...
پس از <a href="/ai/quick-start" className="text-[#2196f3] " >ایجاد سرویس هوش مصنوعی</a> و دریافت <Important>baseUrl</Important> و <a href="/ai/details/keys/#create" className="text-[#2196f3]" >ساخت کلید</a>، می‌توانید مانند دستورات و قطعه‌های کد زیر، از مدل‌های OpenAI استفاده کنید.
