...
<Section id="text-prompt-with-audio-file" title="۳. پرامپت متنی به همراه فایل صوتی" headingTag="h3" />
<div className="h-2" />
...
<Tabs 
  ...
  content={[
    <>
        ...
        (در نظر داشته باشید که باید فایل صوتی، در کنار فایل‌های کد قرار گرفته باشد یا مسیری را برای آن مشخص کرده باشد):
        <HighlightTabs
            tabs={[
                {
                label: "cURL",
    ...
    static async Task Main()
    {
        ...
        var messages = new List<ChatMessage>
        {
            new UserChatMessage(
                ...
                ChatMessageContentPart.CreateInputAudioPart(audioData, ChatInputAudioFormat.Mp3) // ✅ FIXED
            )
        };
...
<div className="h-4" />
<h3>۳. پرامپت متنی به همراه فایل صوتی</h3>
<div className="h-2" />
