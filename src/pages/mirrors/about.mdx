...
<div className="grid md:grid-cols-3 gap-4">
    ...
    { alt: 'https://media.liara.ir/logos/centos.svg', platform: 'CentOS Stream', link: "/mirrors/centos-stream" },
    ...
    { alt: 'https://media.liara.ir/logos/almalinux.png', platform: 'Alma Linux', link: "/mirrors/alma-linux" },
  ].map(item =>
              <Link href={item.link}>
