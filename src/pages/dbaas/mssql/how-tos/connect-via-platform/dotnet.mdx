...
<p>
یک پروژه نمونه در <a href="https://github.com/liara-cloud/dotnet-getting-started/tree/ef-core" className="blue-link">اینجا</a> وجود دارد که می‌توانید از آن، استفاده کنید.
