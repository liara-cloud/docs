...
<Section id="save-permanent" title="ذخیره دائمی یک کاربر" />
...
<p>
در نظر داشته باشید که تنها امکان ذخیره دائمی کاربر جدید در دیتابیس Redis نسخه <Important>8.0</Important> وجود دارد؛ در صورتی که از 
نسخه‌های دیگر استفاده می‌کنید؛ امکان ذخیره موقتی کاربر جدید تا زمان ری‌استارت شدن دیتابیس، وجود دارد. 
</p>
</Alert>
