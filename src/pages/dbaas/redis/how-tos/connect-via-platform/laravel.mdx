...
<Layout>
<Head>
<title>مستندات اتصال به Redis در Laravel - لیارا</title>
</Head>
...
<div className="h-2" />
اکنون می‌توانید برنامه‌تان را اجرا کرده و در صفحه <Important>test-redis/</Important> وضعیت اتصال به دیتابیس خود را بررسی کنید.
