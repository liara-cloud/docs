...
<p>
همچنین بخوانید: <a href="https://dev.mysql.com/doc/refman/8.4/en/create-user.html" className="text-[#2196f3]">مستندات ایجاد کاربر در ClickHouse</a>
</p>
</Alert>
