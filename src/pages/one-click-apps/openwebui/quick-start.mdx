...
<Layout>
<Head>
<title>مستندات راه‌اندازی سریع برنامه‌های Openweb UI - لیارا</title>
<meta property="og:title" content="مستندات خدمات رایانش ابری لیارا" />
<meta property="og:description" content="مستندات مربوط به نحوه راه‌اندازی سریع برنامه Openweb UI در لیارا"  />
<meta property="og:image" content="https://media.liara.ir/logos/liara-poster.jpg" />
</Head>

# راه‌اندازی سریع برنامه‌های Openweb UI
<hr className="mb-2" />



<a href="" className="text-[#2196f3] ">Openweb UI</a> یک رابط کاربری متن‌باز برای تعامل با مدل‌های هوش مصنوعی است که معمولاً به عنوان جایگزینی سبک، ساده و محلی برای ChatGPT استفاده می‌شود. این پروژه به کاربران اجازه می‌دهد تا با مدل‌های هوش مصنوعی مثل LLaMA , Mistral  و دیگر LLMها تعامل داشته باشند. رابط کاربری آن مبتنی بر وب است و با زبان‌هایی مثل Python و JavaScript توسعه داده شده است. از ویژگی‌های مهم آن می‌توان به نصب آسان، پشتیبانی از چندین مدل و چت‌های real-time اشاره کرد.
...
<p>
    بر روی منوی <b>برنامه‌های آماده</b> و سپس بر روی برنامه <b>Openwebui</b>، کلیک کنید. 
...
<Tabs 
    ...
    <>
      ...
      <Alert variant="info">
        <p>
          محتوای کامل <Important>Liara Compose</Important> برنامه در <a href="https://github.com/liara-cloud/compose-templates/blob/master/Openweb UI/liara-compose.yaml" className="text-[#2196f3]">اینجا</a>، قرار گرفته است.
        </p>
      </Alert>
    </>
    ]} 
