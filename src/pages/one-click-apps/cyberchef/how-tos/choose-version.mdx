...
<Layout>
<Head>
<title>مستندات تغییر نسخه CyberChef - لیارا</title>
<meta property="og:title" content="مستندات خدمات رایانش ابری لیارا" />
<meta property="og:description" content="مستندات مربوط به نحوه تغییر نسخه برنامه CyberChef در لیارا"  />
</Head>
...
<Tabs 
    ...
    <>
      ...
      <div className="h-4" />
      <video
        src="https://media.liara.ir/docs/update-one-click-app-version-by-liara-console.mp4"
        controls="controls"
...
<p>
  برای مشاهده تمامی تگ‌های موجود، می‌توانید به <a href="https://github.com/gchq/CyberChef/pkgs/container/cyberchef/versions?filters%5Bversion_type%5D=tagged" className="text-[#2196f3]">ghcr رسمی برنامه</a>، مراجعه کنید.
</p>
</Alert>
<Alert variant="success">
<p>
  برای اطلاعات بیشتر مربوط به پیکربندی برنامه و اطلاع از متغیرهای محیطی آن، می‌توانید به <a href="https://github.com/gchq/CyberChef?tab=readme-ov-file#cyberchef" className="text-[#2196f3]">مستندات رسمی برنامه</a>، مراجعه کنید.
</p>
</Alert>
