...
<Layout>
<Head>
<title>مستندات راه‌اندازی سریع برنامه‌های Checkcle - لیارا</title>
<meta property="og:title" content="مستندات خدمات رایانش ابری لیارا" />
<meta property="og:description" content="مستندات مربوط به نحوه راه‌اندازی سریع برنامه Checkcle در لیارا"  />
</Head>
...
{/* <div className="h-2" />
<video
src="https://media.liara.ir/docs/Checkcle.mp4"
controls="controls"
...
<p>
    بر روی منوی <b>برنامه‌های آماده</b> و سپس بر روی برنامه <b>checkcle</b>، کلیک کنید. 
...
<Tabs 
    ...
    <>
      ...
      <Alert variant="info">
        <p>
          محتوای کامل <Important>Liara Compose</Important> برنامه در <a href="https://github.com/liara-cloud/compose-templates/blob/master/checkcle/liara-compose.yaml" className="text-[#2196f3]">اینجا</a>، قرار گرفته است.
        </p>
      </Alert>
    </>
    ]} 
...
<div className='h-4' />
  ...
  <p>  
      در اولین ورود به CheckCle، نام کاربری (Email)، برابر با <Important>admin@example.com</Important> و رمزعبور (Password)، برابر با <Important>Admin123456</Important>، می‌باشد.
  </p>
