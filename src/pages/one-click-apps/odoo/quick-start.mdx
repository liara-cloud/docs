...
<meta property="og:description" content="مستندات مربوط به نحوه راه‌اندازی سریع برنامه Odoo در لیارا"  />
</Head>
...
<video
  src="https://media.liara.ir/docs/odoo.mp4"
  controls="controls"
...
<p>
    بر روی منوی <b>برنامه‌های آماده</b> و سپس بر روی برنامه <b>odoo</b>، کلیک کنید. 
...
<Tabs 
    ...
    <>
      ...
      <Alert variant="info">
        <p>
          محتوای کامل <Important>Liara Compose</Important> برنامه در <a href="https://github.com/liara-cloud/compose-templates/blob/master/odoo/liara-compose.yaml" className="text-[#2196f3]">اینجا</a>، قرار گرفته است.
        </p>
      </Alert>
    </>
    ]} 
