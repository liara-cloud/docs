...
<Layout>
<Head>
<title>مستندات راه‌اندازی سریع برنامه‌های Docmost - لیارا</title>
<meta property="og:title" content="مستندات خدمات رایانش ابری لیارا" />
<meta property="og:description" content="مستندات مربوط به راه‌اندازی سریع برنامه Docmost در لیارا"  />
</Head>
...
{/* <div className="h-4" />
<video
  src="https://media.liara.ir/docs/Docmost.mp4"
  controls="controls"
...
<p>
    بر روی منوی <b>برنامه‌های آماده</b> و سپس بر روی برنامه <b>docmost</b>، کلیک کنید. 
...
<Tabs 
    ...
    <>
      ...
      <Alert variant="info">
        <p>
          محتوای کامل <Important>Liara Compose</Important> برنامه در <a href="https://github.com/liara-cloud/compose-templates/blob/master/docmost/liara-compose.yaml" className="text-[#2196f3]">اینجا</a>، قرار گرفته است.
        </p>
      </Alert>
    </>
    ]} 
