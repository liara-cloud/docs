...
docker compose ps`}
  ...
  },
  {
    ...
    <>
      ...
      <p>
        پس از اطمینان از صحیح بودن برنامه، در مسیر فعلی (<Important>opt/appwrite/self-hosted/</Important>)
        دستور زیر را اجرا کنید: 
      </p>
      <div className="h-2" />
      <div dir='ltr'>
          <Highlight className="bash">
              {`docker compose exec web appwrite createuser`}
          </Highlight>
      </div>
      <div className="h-2" />  
      <p>
