...
<Layout>
<Head>
<title>مستندات راه‌اندازی سریع برنامه‌های moodle - لیارا</title>
<meta property="og:title" content="مستندات خدمات رایانش ابری لیارا" />
<meta property="og:description" content="مستندات مربوط به نحوه راه‌اندازی سریع برنامه moodle در لیارا"  />
...
{/* <div className="h-2" />
<video
src="https://media.liara.ir/docs/moodle.mp4"
controls="controls"
...
<p>
    بر روی منوی <b>برنامه‌های آماده</b> و سپس بر روی برنامه <b>moodle</b>، کلیک کنید. 
...
<Tabs 
    ...
    <>
      ...
      <Alert variant="info">
        <p>
          محتوای کامل <Important>Liara Compose</Important> برنامه در <a href="https://github.com/liara-cloud/compose-templates/blob/master/moodle/liara-compose.yaml" className="text-[#2196f3]">اینجا</a>، قرار گرفته است.
        </p>
      </Alert>
    </>
    ]} 
...
<Alert className="info">
  <p>
    اطلاعات ورود به حساب کاربری نظیر <Important>Username</Important> و <Important>Password</Important> در بخش <a href="/paas/details/envs" className="text-[#2196f3]">متغیرهای محیطی برنامه</a>، به نام‌های <Important>MOODLE_USERNAME</Important> و <Important>MOODLE_PASSWORD</Important> قرار گرفته‌اند که می‌توانید از آن‌ها برای ورود اولیه به حساب برنامه‌تان، استفاده کنید.
  </p>
</Alert>
<div className='h-2' />
