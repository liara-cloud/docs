...
<Layout>
<Head>
<title>مستندات تغییر نسخه Etherpad - لیارا</title>
<meta property="og:title" content="مستندات خدمات رایانش ابری لیارا" />
<meta property="og:description" content="مستندات مربوط به نحوه تغییر نسخه برنامه Etherpad در لیارا"  />
</Head>
...
<p>
  برای مشاهده تمامی تگ‌های موجود، می‌توانید به <a href="https://hub.docker.com/r/etherpad/etherpad/tags" className="text-[#2196f3]">داکرهاب رسمی برنامه</a>، مراجعه کنید.
</p>
</Alert>
<Alert variant="success">
<p>
  برای اطلاعات بیشتر مربوط به پیکربندی برنامه و اطلاع از متغیرهای محیطی آن، می‌توانید به <a href="https://etherpad.org/doc/v2.2.6/index.html#_docker" className="text-[#2196f3]">مستندات رسمی برنامه</a>، مراجعه کنید.
</p>
</Alert>
</Layout>