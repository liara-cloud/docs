...
<Layout>
<Head>
<title>مستندات راه‌اندازی سریع برنامه‌های Registry - لیارا</title>
<meta property="og:title" content="مستندات خدمات رایانش ابری لیارا" />
<meta property="og:description" content="مستندات مربوط به راه‌اندازی سریع برنامه Registry در لیارا"  />
</Head>
...
{/* <div className="h-4" />
<video
  src="https://media.liara.ir/docs/Registry.mp4"
  controls="controls"
...
<a href="https://hub.docker.com/_/registry" className="text-[#2196f3] ">Registry2</a> در واقع نسخه دوم از رجیستری رسمی داکر است که به شما اجازه می‌دهد یک رجیستری خصوصی برای مدیریت ایمیج‌های داکر راه‌اندازی کنید. با استفاده از این ایمیج، می‌توانید به‌راحتی یک محیط امن و اختصاصی برای ذخیره‌سازی، نسخه‌بندی و اشتراک‌گذاری ایمیج‌های داکر درون سازمانی ایجاد کنید؛ بدون اینکه به رجیستری‌های عمومی مانند Docker Hub وابسته باشید. 
<div className="h-4" />
...
<p>
    بر روی منوی <b>برنامه‌های آماده</b> و سپس بر روی برنامه <b>registry</b>، کلیک کنید. 
...
<Tabs 
    ...
    <>
      ...
      <Alert variant="info">
        <p>
          محتوای کامل <Important>Liara Compose</Important> برنامه در <a href="https://github.com/liara-cloud/compose-templates/blob/master/registry/liara-compose.yaml" className="text-[#2196f3]">اینجا</a>، قرار گرفته است.
        </p>
      </Alert>
    </>
    ]} 
