...
<Layout>
<Head>
<title>مستندات راه‌اندازی سریع برنامه‌های Rallly - لیارا</title>
<meta property="og:title" content="مستندات خدمات رایانش ابری لیارا" />
<meta property="og:description" content="مستندات مربوط به نحوه راه‌اندازی سریع برنامه Rallly در لیارا"  />
</Head>
...
<hr className="mb-2" />
  ...
  {/* <video
  src="https://media.liara.ir/docs/Rallly.mp4"
  controls="controls"
...
<p>
    بر روی منوی <b>برنامه‌های آماده</b> و سپس بر روی برنامه <b>rallly</b>، کلیک کنید. 
...
<Tabs 
    ...
    <>
      ...
      <Alert variant="info">
        <p>
          محتوای کامل <Important>Liara Compose</Important> برنامه در <a href="https://github.com/liara-cloud/compose-templates/blob/master/Rallly/liara-compose.yaml" className="text-[#2196f3]">اینجا</a>، قرار گرفته است.
        </p>
      </Alert>
    </>
    ]} 
...
content: (
<>
<h3>تنظیم ایمیل‌سرور</h3>   
<p>وارد بخش <Link className="text-[#2196f3]" href="/paas/details/envs/">متغیرهای محیطی برنامه</Link> شوید و متغیرهای زیر را طبق اطلاعات ایمیل‌سرور خود، مقدار دهی کنید:</p>
...
<Alert variant="info">
<p>
مقدار متغیر <Important>SUPPORT_EMAIL</Important> باید یکی از نشانی‌های ایمیل‌سرور باشد. 
</p> 
</Alert>
</>
)
...
content: (
<>
<h3>ایجاد حساب کاربری جدید در برنامه</h3>   
<p>
...
<Alert className="info">
  <p>
    اطلاعات ورود به حساب کاربری نظیر <Important>Username</Important> و <Important>Password</Important> در ورود اولیه به ترتیب برابر با <Important>admin</Important> و <Important>Rallly</Important> است.
  </p>
</Alert> */}
