...
<Layout>
<Head>
<title>مستندات تغییر نسخه Rallly - لیارا</title>
<meta property="og:title" content="مستندات خدمات رایانش ابری لیارا" />
<meta property="og:description" content="مستندات مربوط به نحوه تغییر نسخه برنامه Rallly در لیارا"  />
</Head>
...
<div dir='ltr'>
    <Highlight className="json">
      {`{
    "image": "lukevella/rallly:<your-version>",
    "port": 3000,
    "app": "<your-app-name>"
}`}
    </Highlight>
