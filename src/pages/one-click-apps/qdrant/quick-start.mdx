...
<Layout>
<Head>
<title>مستندات راه‌اندازی سریع برنامه Qdrant - لیارا</title>
<meta property="og:title" content="مستندات خدمات رایانش ابری لیارا" />
<meta property="og:description" content="مستندات مربوط به راه‌اندازی سریع برنامه Qdrant در لیارا"  />
</Head>

# راه‌اندازی سریع برنامه Qdrant
<hr className="mb-2" />

{/* <div className="h-4" />
<video
  src="https://media.liara.ir/docs/qdrant.mp4"
  controls="controls"
...
<a href="https://qdrant.tech/" className="text-[#2196f3] ">Qdrant</a> یک دیتابیس برداری (vector database) و موتور جستجوی شباهت است که برای ذخیره، مدیریت و جستجوی وکتورها/امبدینگ‌ها طراحی شده و در برنامه‌های هوش مصنوعی و یادگیری ماشین با مقیاس بزرگ به کار می‌رود. 
...
<p>
    بر روی منوی <b>برنامه‌های آماده</b> و سپس بر روی برنامه <b>qdrant</b>، کلیک کنید. 
...
<Tabs 
    ...
    <>
      ...
      <Alert variant="info">
        <p>
          محتوای کامل <Important>Liara Compose</Important> برنامه در <a href="https://github.com/liara-cloud/compose-templates/blob/master/qdrant/liara-compose.yaml" className="text-[#2196f3]">اینجا</a>، قرار گرفته است.
        </p>
      </Alert>
    </>
    ]} 
