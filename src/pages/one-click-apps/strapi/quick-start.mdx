...
<meta property="og:description" content="مستندات مربوط به نحوه راه‌اندازی سریع برنامه Strapi در لیارا"  />
</Head>
...
<hr className="mb-2" />
  ...
  <video
  src="https://media.liara.ir/docs/strapi.mp4"
  controls="controls"
...
<p>
    بر روی منوی <b>برنامه‌های آماده</b> و سپس بر روی برنامه <b>strapi</b>، کلیک کنید. 
...
<Tabs 
    ...
    <>
      ...
      <Alert variant="info">
        <p>
          محتوای کامل <Important>Liara Compose</Important> برنامه در <a href="https://github.com/liara-cloud/compose-templates/blob/master/strapi/liara-compose.yaml" className="text-[#2196f3]">اینجا</a>، قرار گرفته است.
        </p>
      </Alert>
    </>
    ]} 
...
<div className="grid md:grid-cols-1 gap-4">
            {[
      {
        ...
        link: "/one-click-apps/strapi/how-tos/choose-version"
      },
  ].map(item =>
    <Link href={item.link}>
