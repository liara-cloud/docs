...
<div className="grid md:grid-cols-4 gap-4">
            {[
    {
      ...
      {
        title: "Memos",
        alt: "https://one-click-apps.storage.iran.liara.space/memos/memos-logo.svg",
        link: "/one-click-apps/memos/quick-start"
      },
      {
        title: "Qdrant",
        alt: "https://one-click-apps.storage.iran.liara.space/qdrant/qdrant-brandmark-red.svg",
