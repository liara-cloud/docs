...
<meta property="og:description" content="مستندات مربوط به راه‌اندازی سریع برنامه Apache Answer در لیارا"  />
</Head>
# راه‌اندازی سریع برنامه‌های Apache Answer
<hr className="mb-2" />

<img src="https://media.liara.ir/old/apacheanswer/apacheanswer.gif" alt="create one-click-app" />
{/* <video
...
<p>
    بر روی منوی <b>برنامه‌های آماده</b> و سپس بر روی برنامه <b>apache answer</b>، کلیک کنید. 
...
<Tabs 
    ...
    <>
      ...
      <Alert variant="info">
        <p>
          محتوای کامل <Important>Liara Compose</Important> برنامه در <a href="https://github.com/liara-cloud/compose-templates/blob/master/apache-answer/liara-compose.yaml" className="text-[#2196f3]">اینجا</a>، قرار گرفته است.
        </p>
      </Alert>
    </>
    ]} 
