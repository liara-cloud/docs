...
<Layout>
<Head>
<title>مستندات راه‌اندازی سریع برنامه‌های wiki.js - لیارا</title>
<meta property="og:title" content="مستندات خدمات رایانش ابری لیارا" />
<meta property="og:description" content="مستندات مربوط به نحوه راه‌اندازی سریع برنامه wikijs در لیارا"  />
</Head>

# راه‌اندازی سریع برنامه‌های Wiki.JS
<hr className="mb-2" />

{/* <div className="h-2" />
<video
src="https://media.liara.ir/docs/wikijs.mp4"
controls="controls"
...
<a href="https://js.wiki/" className="text-[#2196f3] ">Wiki.js</a> یک سیستم مدیریت محتوای متن‌باز و مدرن است که برای ساخت و مدیریت اسناد و ویکی‌های آنلاین طراحی شده است. این ابزار با یک رابط کاربری زیبا، سریع و ریسپانسیو، تجربه‌ای کاربرپسند ارائه می‌دهد. Wiki.js از Markdown برای ویرایش محتوا پشتیبانی می‌کند و قابلیت‌های پیشرفته‌ای مثل کنترل نسخه، احراز هویت پیشرفته، و یکپارچه‌سازی با سرویس‌های خارجی (مانند Git و Google Drive) دارد. این پلتفرم با <a href="/paas/nodejs/getting-started" className="text-[#2196f3]">Node.js</a> ساخته شده و عملکردی سبک و کارآمد دارد، که آن را برای تیم‌های کوچک تا سازمان‌های بزرگ مناسب می‌سازد.
...
<p>
    بر روی منوی <b>برنامه‌های آماده</b> و سپس بر روی برنامه <b>wiki.js</b>، کلیک کنید. 
...
<Tabs 
    ...
    <>
      ...
      <Alert variant="info">
        <p>
          محتوای کامل <Important>Liara Compose</Important> برنامه در <a href="https://github.com/liara-cloud/compose-templates/blob/master/wikijs/liara-compose.yaml" className="text-[#2196f3]">اینجا</a>، قرار گرفته است.
        </p>
      </Alert>
    </>
    ]} 
