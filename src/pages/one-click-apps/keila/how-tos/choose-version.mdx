...
<Layout>
<Head>
<title>مستندات تغییر نسخه Keila - لیارا</title>
<meta property="og:title" content="مستندات خدمات رایانش ابری لیارا" />
<meta property="og:description" content="مستندات مربوط به نحوه تغییر نسخه برنامه Keila در لیارا"  />
</Head>
...
<div dir='ltr'>
    <Highlight className="json">
      {`{
    "image": "pentacent/keila:<your-version>",
    "port": 4000,
    "app": "<your-app-name>"
}`}
    </Highlight>
