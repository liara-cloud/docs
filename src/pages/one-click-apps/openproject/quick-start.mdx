...
<meta property="og:description" content="مستندات مربوط به نحوه راه‌اندازی سریع برنامه OpenProject در لیارا"  />
...
{/* <div className="h-2" />
<video
src="https://media.liara.ir/docs/OpenProject.mp4"
controls="controls"
...
<p>
    بر روی منوی <b>برنامه‌های آماده</b> و سپس بر روی برنامه <b>openproject</b>، کلیک کنید. 
...
<Tabs 
    ...
    <>
      ...
      <Alert variant="info">
        <p>
          محتوای کامل <Important>Liara Compose</Important> برنامه در <a href="https://github.com/liara-cloud/compose-templates/blob/master/openproject/liara-compose.yaml" className="text-[#2196f3]">اینجا</a>، قرار گرفته است.
        </p>
      </Alert>
    </>
    ]} 
...
<Alert className="info">
  <p>
    در اولین ورود به حساب کاربری برنامه‌تان، مقدار پیش‌فرض <Important>Username</Important> و <Important>Password</Important>، برابر با <Important>admin</Important> می‌باشد. 
  </p>
</Alert>
<div className='h-2' />
