...
<meta property="og:description" content="مستندات مربوط به نحوه راه‌اندازی سریع برنامه Paperless در لیارا"  />
</Head>
...
{/* <div className="h-2" />
<video
src="https://media.liara.ir/docs/Paperless.mp4"
controls="controls"
...
<p>
    بر روی منوی <b>برنامه‌های آماده</b> و سپس بر روی برنامه <b>paperless</b>، کلیک کنید. 
...
<Tabs 
    ...
    <>
      ...
      <Alert variant="info">
        <p>
          محتوای کامل <Important>Liara Compose</Important> برنامه در <a href="https://github.com/liara-cloud/compose-templates/blob/master/paperless/liara-compose.yaml" className="text-[#2196f3]">اینجا</a>، قرار گرفته است.
        </p>
      </Alert>
    </>
    ]} 
...
<Alert className="info">
  <p>
    اطلاعات ورود به حساب کاربری نظیر <Important>Username</Important> و <Important>Password</Important> در بخش <a href="/paas/details/envs" className="text-[#2196f3]">متغیرهای محیطی برنامه</a>، به نام‌های <Important>PAPERLESS_ADMIN_USER</Important> و <Important>PAPERLESS_ADMIN_PASSWORD</Important> قرار گرفته‌اند که می‌توانید از آن‌ها برای ورود اولیه به حساب برنامه‌تان، استفاده کنید.
  </p>
</Alert>
