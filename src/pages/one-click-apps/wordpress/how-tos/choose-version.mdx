...
<meta property="og:description" content="مستندات مربوط به نحوه تغییر نسخه PHP و ورژن برنامه WordPress در لیارا"  />
</Head>
...
<video
src="https://media.liara.ir/docs/change-wordpress-version.mp4"
controls="controls"
...
<p>
برای مشاهده نسخه‌های قابل ارائه WordPress و PHP به <a href="https://hub.docker.com/r/liararepo/wordpress-one-click-app/tags?page=&page_size=&name=&ordering=last_updated" className="text-[#2196f3] ">این لینک</a> مراجعه کنید.
</p>
</Alert>
