...
<Layout>
<Head>
<title>مستندات راه‌اندازی سریع برنامه‌های zitadel - لیارا</title>
<meta property="og:title" content="مستندات خدمات رایانش ابری لیارا" />
<meta property="og:description" content="مستندات مربوط به نحوه راه‌اندازی سریع برنامه zitadel در لیارا"  />
<meta property="og:image" content="https://media.liara.ir/logos/liara-poster.jpg" />
</Head>

# راه‌اندازی سریع برنامه‌های zitadel
<hr className="mb-2" />

{/* <div className="h-2" />
<video
src="https://media.liara.ir/docs/zitadel.mp4"
controls="controls"
...
<a href="https://zitadel.com/" className="text-[#2196f3] ">zitadel</a> یک پلتفرم متن‌باز برای مدیریت هویت (Identity Management) است که برای توسعه‌دهندگان طراحی شده است. این ابزار امکاناتی مثل احراز هویت و مجوزدهی، مدیریت کاربران، و ادغام با پروتکل‌هایی مانند OpenID Connect و SAML را فراهم می‌کند. از ZITADEL می‌توان برای سناریوهای B2B و B2C استفاده کرد.
<Step  steps={[
{
step: "۱",
content: (
...
<p>
    بر روی منوی <b>برنامه‌های آماده</b> و سپس بر روی برنامه <b>zitadel</b>، کلیک کنید. 
...
<Tabs 
    ...
    <>
      ...
      <Alert variant="info">
        <p>
          محتوای کامل <Important>Liara Compose</Important> برنامه در <a href="https://github.com/liara-cloud/compose-templates/blob/master/zitadel/liara-compose.yaml" className="text-[#2196f3]">اینجا</a>، قرار گرفته است.
        </p>
      </Alert>
    </>
    ]} 
...
<div className='h-4' />
  ...
  <p>  
    در نظر داشته باشید که در اولین ورود در ZITADEL، نام کاربری یا Username برابر با <Important>zitadel-admin@zitadel.your-app-name.liara.run</Important> است. 
    در واقع، اگر که به طور فرضی، نام دامنه برنامه ZITADEL شما <Important>my-good-app.liara.run</Important> باشد، Username برنامه شما <Important>zitadel-admin@zitadel.my-good-app.liara.run</Important> 
    خواهد بود.
  </p>

<div className='h-2' />
در اولین ورود، Password برنامه مقدار زیر، است: 
