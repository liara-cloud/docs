...
<Layout>
<Head>
<title>مستندات راه‌اندازی سریع برنامه‌های harness - لیارا</title>
<meta property="og:title" content="مستندات خدمات رایانش ابری لیارا" />
<meta property="og:description" content="مستندات مربوط به نحوه راه‌اندازی سریع برنامه harness در لیارا"  />
</Head>

# راه‌اندازی سریع برنامه‌های Harness
<hr className="mb-2" />

{/* <div className="h-2" />
<video
src="https://media.liara.ir/docs/harness.mp4"
controls="controls"
...
<a href="https://www.harness.io/open-source" className="text-[#2196f3] ">Harness</a> یک پلتفرم CI/CD مبتنی بر هوش مصنوعی است که فرآیندهای DevOps را خودکار کرده و به توسعه‌دهندگان کمک می‌کند تا کدهای خود را سریع‌تر، ایمن‌تر و کارآمدتر به محیط‌های مختلف مستقر کنند. این ابزار شامل قابلیت‌هایی مانند Continuous Integration (CI) و Continuous Deployment (CD)، مدیریت هزینه‌های ابری، تست‌های امنیتی خودکار و قابلیت Feature Flags برای انتشار تدریجی ویژگی‌های جدید است.

یکی از مزایای کلیدی Harness، هوش مصنوعی داخلی آن است که به‌طور خودکار مشکلات استقرار را شناسایی کرده و پیشنهادهایی برای بهینه‌سازی فرآیند ارائه می‌دهد. این پلتفرم به تیم‌های نرم‌افزاری کمک می‌کند تا پیچیدگی‌های CI/CD را کاهش داده و با سرعت بیشتری، نرم‌افزارهای باکیفیت را به کاربران نهایی برسانند.
...
<p>
    بر روی منوی <b>برنامه‌های آماده</b> و سپس بر روی برنامه <b>harness</b>، کلیک کنید. 
...
<Tabs 
    ...
    <>
      ...
      <Alert variant="info">
        <p>
          محتوای کامل <Important>Liara Compose</Important> برنامه در <a href="https://github.com/liara-cloud/compose-templates/blob/master/harness/liara-compose.yaml" className="text-[#2196f3]">اینجا</a>، قرار گرفته است.
        </p>
      </Alert>
    </>
    ]} 
...
<Alert className="info">
  <p>
    اطلاعات ورود به حساب کاربری نظیر <Important>Email</Important> و <Important>Password</Important> در بخش <a href="/paas/details/envs" className="text-[#2196f3]">متغیرهای محیطی برنامه</a>، به نام‌های <Important>GITNESS_PRINCIPAL_ADMIN_EMAIL</Important> و <Important>GITNESS_PRINCIPAL_ADMIN_PASSWORD</Important> قرار گرفته‌اند که می‌توانید از آن‌ها برای ورود اولیه به حساب برنامه‌تان، استفاده کنید.
  </p>
</Alert>
