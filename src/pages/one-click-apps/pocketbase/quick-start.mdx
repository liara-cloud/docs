...
<meta property="og:description" content="مستندات مربوط به نحوه راه‌اندازی سریع برنامه Pocketbase در لیارا"  />
</Head>
...
<video
  src="https://media.liara.ir/docs/pocketbase.mp4"
  controls="controls"
...
<p>
    بر روی منوی <b>برنامه‌های آماده</b> و سپس بر روی برنامه <b>pocketbase</b>، کلیک کنید. 
...
<Tabs 
    ...
    <>
      ...
      <Alert variant="info">
        <p>
          محتوای کامل <Important>Liara Compose</Important> برنامه در <a href="https://github.com/liara-cloud/compose-templates/blob/master/pocketbase/liara-compose.yaml" className="text-[#2196f3]">اینجا</a>، قرار گرفته است.
        </p>
      </Alert>
    </>
    ]} 
...

{
  ...
  content: (
  <>
    <h3>ایجاد superuser</h3>
    <p>
      پس از ساخت برنامه، <a href="/paas/details/observations/software/" className="text-[#2196f3]">طبق مستندات لاگ‌ها</a>، وارد بخش <b>لاگ‌ها</b> برنامه خود شوید؛ در این قسمت، می‌توانید لینکی که برنامه برای ایجاد superuser به آن اشاره می‌کند را پیدا کنید:
    </p> 
    <div className="h-4" />
    <img src="https://media.liara.ir/pocketbase/see-logs.jpg" alt="logs of pocketbase for create superuser" />
    <div className="h-4" />
    <p>
           بعد از آیپی و پورت، تمامی لینک را کپی کنید و به انتهای دامنه برنامه خود، الصاق کنید. وارد صفحه شوید و superuser خود را بسازید.
