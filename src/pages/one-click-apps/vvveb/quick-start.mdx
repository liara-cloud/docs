...
<Layout>
<Head>
<title>مستندات راه‌اندازی سریع برنامه‌های Vvveb - لیارا</title>
<meta property="og:title" content="مستندات خدمات رایانش ابری لیارا" />
<meta property="og:description" content="مستندات مربوط به نحوه راه‌اندازی سریع برنامه Vvveb در لیارا"  />
<meta property="og:image" content="https://media.liara.ir/logos/liara-poster.jpg" />
</Head>

# راه‌اندازی سریع برنامه‌های Vvveb
<hr className="mb-2" />

  {/* <video
  src="https://media.liara.ir/docs/Vvveb.mp4"
  controls="controls"
...
<a href="https://www.vvveb.com/" className="text-[#2196f3] ">Vvveb</a> یک سیستم مدیریت محتوا (CMS) متن‌باز است که یک صفحه‌ساز با قابلیت کشیدن و رها کردن (drag-and-drop) ارائه می‌دهد. این ابزار به کاربران اجازه می‌دهد وب‌سایت‌ها، وبلاگ‌ها و فروشگاه‌های آنلاین خود را بدون نیاز به کدنویسی بسازند. ویژگی‌های کلیدی Vvveb شامل ویرایش زنده WYSIWYG، امنیت پیشرفته، و پشتیبانی از چند زبان است. همچنین این پلتفرم برای توسعه‌دهندگان امکان ایجاد قالب‌های سفارشی و شخصی‌سازی طرح‌ها را فراهم می‌کند.
...
<p>
    بر روی منوی <b>برنامه‌های آماده</b> و سپس بر روی برنامه <b>vvveb</b>، کلیک کنید. 
...
<Tabs 
    ...
    <>
      ...
      <Alert variant="info">
        <p>
          محتوای کامل <Important>Liara Compose</Important> برنامه در <a href="https://github.com/liara-cloud/compose-templates/blob/master/Vvveb/liara-compose.yaml" className="text-[#2196f3]">اینجا</a>، قرار گرفته است.
        </p>
      </Alert>
    </>
    ]} 
...
<Alert className="info">
  <p>
    اطلاعات ورود به حساب کاربری نظیر <Important>Username</Important> و <Important>Password</Important> در ورود اولیه به ترتیب برابر با <Important>admin</Important> و <Important>Vvveb</Important> است.
  </p>
</Alert> */}
