...
در نهایت کافیست با استفاده از ابزار <a href="/references/liara-cli/about" className="blue-link"><Important>Liara CLI</Important></a> دستور زیر را اجرا کنید تا برنامه‌تان در لیارا، مستقر شود:
