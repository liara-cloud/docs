...
<meta property="og:description" content="مستندات مربوط به نحوه راه‌اندازی سریع برنامه Soketi در لیارا"  />
</Head>
...
<hr className="mb-2" />
  ...
  <video
  src="https://media.liara.ir/docs/soketi.mp4"
  controls="controls"
...
<a href="https://soketi.app/" className="text-[#2196f3]">Soketi</a> یک سرور WebSocket سازگار با پروتکل Pusher است که برای مدیریت ارتباطات real-time مورد استفاده قرار می‌گیرد. این ابزار برای پروژه‌هایی با مقیاس بزرگ طراحی شده و امکان استفاده از ویژگی‌هایی مانند broadcast , presence و channels را فراهم می‌کند. با استفاده از Soketi، می‌توانید ارتباطات لحظه‌ای را بدون نیاز به تغییرات بزرگ در کدهای خود، به سادگی مدیریت کنید. این ابزار به زبان <a href="/paas/nodejs/getting-started/" className="text-[#2196f3]">NodeJS</a> نوشته شده است و می‌تواند به راحتی با ابزارهای دیگر مانند Laravel Echo ترکیب شود.
...
<p>
    بر روی منوی <b>برنامه‌های آماده</b> و سپس بر روی برنامه <b>soketi</b>، کلیک کنید. 
...
<Tabs 
    ...
    <>
      ...
      <Alert variant="info">
        <p>
          محتوای کامل <Important>Liara Compose</Important> برنامه در <a href="https://github.com/liara-cloud/compose-templates/blob/master/soketi/liara-compose.yaml" className="text-[#2196f3]">اینجا</a>، قرار گرفته است.
        </p>
      </Alert>
    </>
    ]} 
