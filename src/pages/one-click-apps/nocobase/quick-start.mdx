...
<Layout>
<Head>
<title>مستندات راه‌اندازی سریع برنامه‌های nocobase - لیارا</title>
<meta property="og:title" content="مستندات خدمات رایانش ابری لیارا" />
<meta property="og:description" content="مستندات مربوط به نحوه راه‌اندازی سریع برنامه nocobase در لیارا"  />
</Head>

# راه‌اندازی سریع برنامه‌های nocobase
<hr className="mb-2" />

{/* <div className="h-2" />
<video
src="https://media.liara.ir/docs/nocobase.mp4"
controls="controls"
...
<a href="https://www.nocobase.com/" className="text-[#2196f3] ">NocoBase</a> یک پلتفرم متن‌باز و بدون کدنویسی (no-code) است که به کاربران اجازه می‌دهد برنامه‌ها و سیستم‌های مدیریتی خود را به سادگی ایجاد کنند. این ابزار بر پایه فناوری <a href="/paas/nodejs/getting-started" className="text-[#2196f3]">Node.js</a> ساخته شده و قابلیت سفارشی‌سازی و توسعه بالا را ارائه می‌دهد. با NocoBase، می‌توانید به‌راحتی داده‌ها را مدیریت، جریان‌های کاری را طراحی و پلاگین‌های مختلف را برای توسعه ویژگی‌ها اضافه کنید. هدف اصلی این پلتفرم، ساده‌سازی فرآیند توسعه نرم‌افزار برای کاربران غیر فنی است.
...
<p>
    بر روی منوی <b>برنامه‌های آماده</b> و سپس بر روی برنامه <b>nocobase</b>، کلیک کنید. 
...
<Tabs 
    ...
    <>
      ...
      <Alert variant="info">
        <p>
          محتوای کامل <Important>Liara Compose</Important> برنامه در <a href="https://github.com/liara-cloud/compose-templates/blob/master/nocobase/liara-compose.yaml" className="text-[#2196f3]">اینجا</a>، قرار گرفته است.
        </p>
      </Alert>
    </>
    ]} 
...
<Alert className="info">
  <p>
    اطلاعات ورود به حساب کاربری نظیر <Important>Email</Important> و <Important>Password</Important> در بخش <a href="/paas/details/envs" className="text-[#2196f3]">متغیرهای محیطی برنامه</a>، به نام‌های <Important>INIT_ROOT_EMAIL</Important> و <Important>INIT_ROOT_PASSWORD</Important> قرار گرفته‌اند که می‌توانید از آن‌ها برای ورود به حساب برنامه‌تان، استفاده کنید.
  </p>
</Alert>
<div className='h-2' />
