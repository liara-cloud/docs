...
<meta property="og:description" content="مستندات مربوط به راه‌اندازی سریع برنامه Ackee در لیارا"  />
<meta property="og:image" content="https://media.liara.ir/logos/liara-poster.jpg" />
</Head>

# راه‌اندازی سریع برنامه‌های Ackee
<hr className="mb-2" />
<img src="https://media.liara.ir/one-click-apps/ackee.gif" alt="create one-click-app" />
{/* <video
...
<p>
    بر روی منوی <b>برنامه‌های آماده</b> و سپس بر روی برنامه <b>ackee</b>، کلیک کنید. 
...
<Tabs 
    ...
    <>
      ...
      <Alert variant="info">
        <p>
          محتوای کامل <Important>Liara Compose</Important> برنامه در <a href="https://github.com/liara-cloud/compose-templates/blob/master/ackee/liara-compose.yaml" className="text-[#2196f3]">اینجا</a>، قرار گرفته است.
        </p>
      </Alert>
    </>
    ]} 
