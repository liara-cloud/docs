...
برای راه‌اندازی برنامه آماده مدنظر خود در لیارا، باید وارد صفحه <a href="https://console\\.liara\\.ir/one-click-apps" className="text-\\[#2196f3\\] ">برنامه‌های آماده</a> شوید؛ سپس برنامه‌ی <b>Imgproxy</b> 
