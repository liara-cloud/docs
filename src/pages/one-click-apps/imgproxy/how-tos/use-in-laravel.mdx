...
<Alert variant="info">
<p>
سورس کامل قطعه کد فوق در <a href="https://github.com/liara-cloud/imgproxy-getting-started/tree/laravel-app" className="blue-link">اینجا</a> موجود است که می‌توانید از آن استفاده کنید.
</p>
</Alert>
