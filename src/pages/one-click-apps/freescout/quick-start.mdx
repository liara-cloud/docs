...
<Layout>
<Head>
<title>مستندات راه‌اندازی سریع برنامه‌های freescout - لیارا</title>
<meta property="og:title" content="مستندات خدمات رایانش ابری لیارا" />
<meta property="og:description" content="مستندات مربوط به نحوه راه‌اندازی سریع برنامه freescout در لیارا"  />
</Head>
...
{/* <div className="h-2" />
<video
src="https://media.liara.ir/docs/freescout.mp4"
controls="controls"
...
<p>
    بر روی منوی <b>برنامه‌های آماده</b> و سپس بر روی برنامه <b>freescout</b>، کلیک کنید. 
...
<Tabs 
    ...
    <>
      ...
      <Alert variant="info">
        <p>
          محتوای کامل <Important>Liara Compose</Important> برنامه در <a href="https://github.com/liara-cloud/compose-templates/blob/master/freescout/liara-compose.yaml" className="text-[#2196f3]">اینجا</a>، قرار گرفته است.
        </p>
      </Alert>
    </>
    ]} 
...
<Alert className="info">
  <p>
    در اولین ورود به حساب کاربری برنامه‌تان، مقدار پیش‌فرض <Important>Email Address</Important> برابر با  <Important>admin@admin.com</Important> است و مقدار <Important>Password</Important> را نیز می‌توانید 
    در بخش <a href="/paas/details/envs/#see-envs" className="text-[#2196f3]">متغیرهای محیطی برنامه</a> با نام <Important>ADMIN_PASS</Important>، ببینید.
  </p>
</Alert>
<div className='h-2' />
