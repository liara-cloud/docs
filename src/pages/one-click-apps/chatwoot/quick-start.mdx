...
<Layout>
<Head>
<title>مستندات راه‌اندازی سریع برنامه‌های chatwoot - لیارا</title>
<meta property="og:title" content="مستندات خدمات رایانش ابری لیارا" />
<meta property="og:description" content="مستندات مربوط به نحوه راه‌اندازی سریع برنامه chatwoot در لیارا"  />
</Head>
...
{/* <div className="h-2" />
<video
src="https://media.liara.ir/docs/chatwoot.mp4"
controls="controls"
...
<a href="https://www.chatwoot.com/" className="text-[#2196f3] ">chatwoot</a> یک پلتفرم متن‌باز برای مدیریت ارتباط با مشتری (CRM) است که به کسب‌وکارها امکان می‌دهد مکالمات را از کانال‌های مختلف مانند ایمیل، واتساپ، تلگرام، اینستاگرام و چت زنده در یک داشبورد یکپارچه مدیریت کنند. این پلتفرم قابلیت‌هایی مانند پاسخ‌های خودکار، تگ‌گذاری مکالمات، تخصیص تیکت به تیم‌های مختلف و ادغام با ابزارهای دیگر را ارائه می‌دهد.
...
<p>
    بر روی منوی <b>برنامه‌های آماده</b> و سپس بر روی برنامه <b>chatwoot</b>، کلیک کنید. 
...
<Tabs 
    ...
    <>
      ...
      <Alert variant="info">
        <p>
          محتوای کامل <Important>Liara Compose</Important> برنامه در <a href="https://github.com/liara-cloud/compose-templates/blob/master/chatwoot/liara-compose.yaml" className="text-[#2196f3]">اینجا</a>، قرار گرفته است.
        </p>
      </Alert>
    </>
    ]} 
...
<div className='h-4' />
  ...
  <p>  
    پس از ساخت برنامه chatwoot، باید در کنسول، وارد برنامه sidekiq شوید و در <a href="/paas/details/console-shell/" className="text-[#2196f3]">بخش خط فرمان</a> برنامه، به خط فرمان متصل شوید و دستور زیر را اجرا کنید تا migrationها بر روی دیتابیس، اعمال شوند (این دستور، معمولاً چند دقیقه طول می‌کشد):
  </p>
