...
<Layout>
<Head>
<title>مستندات راه‌اندازی سریع برنامه‌های Jitsi - لیارا</title>
<meta property="og:title" content="مستندات خدمات رایانش ابری لیارا" />
<meta property="og:description" content="مستندات مربوط به نحوه راه‌اندازی سریع برنامه Jitsi در لیارا"  />
</Head>
...
<div className="h-2" />
<video
src="https://media.liara.ir/jitsi/setup.mp4"
controls="controls"
...
<p>
    بر روی منوی <b>برنامه‌های آماده</b> و سپس بر روی برنامه <b>Jitsi</b>، کلیک کنید. 
...
<Tabs 
    ...
    <>
      ...
      <Alert variant="info">
        <p>
          محتوای کامل <Important>Liara Compose</Important> برنامه در <a href="https://github.com/liara-cloud/compose-templates/blob/master/Jitsi/liara-compose.yaml" className="text-[#2196f3]">اینجا</a>، قرار گرفته است.
        </p>
      </Alert>
    </>
    ]}
...

{
  ...
  content: (
  <>
    <h3>پیکربندی Jisti</h3>
    <p>
        پس از ساخت برنامه، در بخش <b>سرور مجازی ابری</b>، برنامه jitsi خود را انتخاب کنید. وارد بخش <b>اتصال</b> شوید و طبق <a href="/iaas/debian/how-tos/connect-to-server-using-ssh" className="text-[#2196f3]">مستندات اتصال به سرور مجازی با SSH</a>، به سرور مجازی برنامه jitsi متصل شوید.
...
`}
      ...
      <div className="h-2" />  
      <p>
        سپس، دستور زیر را اجرا کنید (به جای <Important>User</Important> و <Important>YourPassword</Important>، نام کاربری و رمزعبور خود را وارد کنید).
      </p>
      <div className="h-2" />
      <div dir='ltr'>
          <Highlight className="bash">
      ...
      <div className="h-2" />  
      <p>
        در نهایت، می‌توانید در آدرس <Important>https://IP</Important> وارد برنامه Jitsi خود شوید (به جای <Important>IP</Important>، آدرس IP برنامه خود را وارد کنید)
      </p>
    <div className="h-4" />
    <Alert variant="success">
      <p>
...
<div className="grid md:grid-cols-1 gap-4">
            {[
      {
        ...
        link: "/one-click-apps/Jitsi/how-tos/choose-version"
      },
  ].map(item =>
    <Link href={item.link}>
