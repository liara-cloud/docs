...
<Layout>
<Head>
<title>مستندات استفاده از Hookها در NodeJS - لیارا</title>
<meta property="og:title" content="مستندات خدمات رایانش ابری لیارا" />
<meta property="og:description" content="مستندات مربوط به نحوه استفاده از Hookها در پلتفرم NodeJS در لیارا"  />
...
<div className="h-2" />
به عنوان مثال، اگر که از <a href="/paas/nodejs/how-tos/connect-to-db/sequelize/about" className="text-[#2196f3] ">Sequelize</a> استفاده می‌کنید؛ می‌توانید در فایل <Important>liara_pre_start.sh</Important> دستورات مربوط به migrations را بنویسید تا نیازی نباشد که پس از استقرار برنامه، آن را به صورت دستی در خط فرمان برنامه خود، اجرا کنید. به عنوان مثال:
<div className="h-2" />
<div dir='ltr'>
