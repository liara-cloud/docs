...
<Layout>
<Head>
<title>مستندات رفع خطاهای رایج در NET. - لیارا</title>
<meta property="og:title" content="مستندات خدمات رایانش ابری لیارا" />
<meta property="og:description" content="مستندات مربوط به رفع خطاهای رایج در پلتفرم دات‌نت در لیارا"  />
...
<div className="grid md:grid-cols-1 gap-4">
            {[
    { platform: 'رفع خطای 502 Bad Gateway', link: "./502-bad-gateway" },
