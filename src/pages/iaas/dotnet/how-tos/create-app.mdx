...
<Tabs 
    ...
    <>
        ...
        {/* <img src="https://files.liara.ir/liara/docs/create-dotnet-app-using-console.gif" alt="create app using console" />
        <div className="h-4" /> */}
    </>,
    <>
    {/* <video
...
<img src="https://files.liara.ir/liara/docs/created-dotnet-app.png" alt="a ready to use nodejs app"/>
<div className="h-2" />
