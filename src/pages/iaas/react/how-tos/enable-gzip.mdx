...
<Layout>
<Head>
<title>مستندات فعال‌سازی gzip و browser caching در React - لیارا</title>
<meta property="og:title" content="مستندات خدمات رایانش ابری لیارا" />
<meta property="og:description" content="مستندات مربوط به نحوه فعال‌سازی gzip و Browser Cachnig در پلتفرم React در لیارا"  />
