...
<p>
    پس از <a href="/iaas/debian/how-tos/connect-to-server-using-ssh" className="text-[#2196f3]">اتصال به سرور مجازی ابری خود با استفاده از SSH</a>، می‌توانید از دستور زیر برای ایجاد یک کاربر جدید استفاده کنید (به جای <Important>lorem</Important>، نام واقعی کاربر خود را، وارد کنید):
</p>
