...
<Layout>
<Head>
<title>مستندات اتصال به دامنه با گواهی SSL در سرور مجازی ابری Debian - لیارا</title>
        ...
        },
        {
            ...
            content: (
                <>
                    ...
                    <p>
                        پس از <a href="/iaas/Debian/how-tos/connect-to-server-using-ssh" className="text-[#2196f3]">اتصال به سرور مجازی ابری خود با استفاده از SSH</a>، کافیست تا با اجرای دستور زیر، NginX را بر روی سرور خود، نصب کنید:
                    </p>
                    <div className="h-2" />
                    <div dir='ltr'>
        ...
        },
        {
            ...
            content: (
                <>
                    ...
                    <p>
                        پس از <a href="/iaas/Debian/how-tos/connect-to-server-using-ssh" className="text-[#2196f3]">اتصال به سرور مجازی ابری خود با استفاده از SSH</a>، کافیست تا با اجرای دستور زیر، Apache را بر روی سرور خود، نصب کنید:
                    </p>
                    <div className="h-2" />
                    <div dir='ltr'>
                        <Highlight className="bash">
