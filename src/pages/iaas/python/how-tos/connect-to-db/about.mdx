...
<Layout>
<Head>
<title>مستندات اتصال به دیتابیس‌ها در Python - لیارا</title>

<meta property="og:title" content="مستندات خدمات رایانش ابری لیارا" />
<meta property="og:description" content="مستندات مربوط به اتصال به دیتابیس‌ها در پلتفرم Python در لیارا"  />
...
برای اجرای migrationها در برنامه خود، می‌توانید طبق <a href="../../use-hooks" className="text-[#2196f3] ">مستندات Hookها</a>، قبل از استقرار و در مسیر اصلی پروژه، یک فایل به نام <Important>liara_pre_start.sh</Important> ایجاد کنید و قطعه کدی مشابه قطعه کد زیر را، درون آن، قرار دهید:
<div className='h-2' />
<div dir='ltr'>
