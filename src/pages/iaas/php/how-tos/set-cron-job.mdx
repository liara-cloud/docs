...
<Layout>
<Head>
<title>مستندات تنظیم Cron Job در PHP - لیارا</title>
<meta property="og:title" content="مستندات خدمات رایانش ابری لیارا" />
<meta property="og:description" content="مستندات مربوط به نحوه تنظیم کرون‌جاب یا Cron Job در پلتفرم PHP در لیارا"  />
...
<Tabs 
    ...
    <>
      ...
      <div className="h-4" />
      <img src="https://files.liara.ir/liara/docs/php-cronjob.png" alt="set cron jobs on liara" />
