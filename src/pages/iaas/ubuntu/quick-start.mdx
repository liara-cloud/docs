...
<Layout>
<Head>
<title>مستندات راه‌اندازی سریع سرور ابری Ubuntu اوبونتو - لیارا</title>
<meta property="og:title" content="مستندات خدمات رایانش ابری لیارا" />
<meta property="og:description" content="مستندات مربوط به نحوه راه‌اندازی سریع سرور مجازی اوبونتو Ubuntu در لیارا"  />
<meta property="og:image" content="https://files.liara.ir/liara/logos/liara-poster.jpg" />
</Head>

# راه‌اندازی سریع سرور ابری Ubuntu 
  ...
  <Step  steps={[
{
  ...
  <>
    ...
    <p>وارد تب <b>سرور ابری</b> شوید، سپس بر روی گزینه <b>ایجاد سرور ابری</b> کلیک کنید و سرور Ubuntu خود را با نسخه، شناسه، <Link className="text-[#2196f3] " href="/iaas/details/ssh-keys">کلید SSH عمومی</Link> و <Link className="text-[#2196f3] " href="/iaas/details/hardware-plans">منابع سخت‌افزاری</Link> مدنظرتان ایجاد کنید.</p>

    <div className="h-2" />
    <video
      src="https://files.liara.ir/liara/vps/create-ubuntu-vm-using-console.mp4"
      controls="controls"
      className="block w-full"
      width="100%"
    ></video>
  ...
  <>
    ...
    <div className="h-2" />
    <video
      src="https://files.liara.ir/liara/vps/turning-a-ubuntu-vm-on-by-sending-signal.mp4"
      controls="controls"
      className="block w-full"
      width="100%"
    ></video>
    ...
    <Tabs 
      ...
      content={[
        <>
          ...
          <Tabs 
            tabs={["Debian", "Ubuntu", "Rocky Linux", "CentOS", "RHEL", "AlmaLinux", "Arch Linux", "Manjaro"]} 
            content={[
            <>
              <p>
...
# sudo dnf install openssh-clients -y # برای نسخه‌های جدیدتر`}
    ...
    <Asciinema id="connect-to-ubuntu-server-using-ssh" />
    <div className="h-2" />
    <p>
  ...
  <Step  steps={[
{
  ...
  <>
    ...
    <Asciinema id="start-vm-using-cli" />
    <Alert variant="info">
      <p>
