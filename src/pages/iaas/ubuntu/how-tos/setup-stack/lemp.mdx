...
},
{
  ...
  <>
    ...
    <p>
        ...
        برای اینکه Nginx بتواند ترافیک HTTP و HTTPS را مدیریت کند، باید قوانین مناسب را در فایروا با اجرای دستورات زیر اضافه کنید:
    </p>
    <div dir='ltr'>
        <Highlight className="bash">
