...
<Tabs 
    ...
    <>
        ...
        {/* <img src="https://files.liara.ir/liara/docs/create-laravel-app.gif" alt="create app using console" /> */}
        <div className="h-4" />
    </>,
...
<img src="https://files.liara.ir/liara/docs/created-laravel-app.png" alt="a ready to use nodejs app"/>
<div className="h-2" />
