...
<Layout>
<Head>
<title>مستندات تنظیم Cron Job در Flask - لیارا</title>
<meta property="og:title" content="مستندات خدمات رایانش ابری لیارا" />
<meta property="og:description" content="مستندات مربوط به نحوه تنظیم و پیکربندی Cron Job یا کرون جاب در فریم‌ورک Flask در لیارا"  />
...
<Tabs 
    ...
    <>
      ...
      <div className="h-4" />
      <img src="https://files.liara.ir/liara/docs/flask-cronjob.png" alt="set cron jobs on liara" />
      
    </>,

    <>
برای تنظیم یک Cron Job در Flask
