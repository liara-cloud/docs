...
<Layout>
<Head>
<title>مستندات فعال‌سازی قابلیت gzip در Flask - لیارا</title>
<meta property="og:title" content="مستندات خدمات رایانش ابری لیارا" />
<meta property="og:description" content="مستندات مربوط به نحوه فعال‌سازی قابلیت gzip در فریم‌ورک Flask در لیارا"  />
