...
<Layout>
<Head>
<title>مستندات رفع خطاهای رایج در Flask - لیارا</title>
<meta property="og:title" content="مستندات خدمات رایانش ابری لیارا" />
<meta property="og:description" content="مستندات مربوط به رفع خطاهای رایج در پلتفرم Flask در لیارا"  />
<meta property="og:image" content="https://files.liara.ir/liara/logos/liara-poster.jpg" />
</Head>
# رفع خطاهای رایج در استقرار برنامه‌های Flask
<hr className="mb-2" />
...
<div className="grid md:grid-cols-1 gap-4">
    ...
    { platform: 'رفع خطای ModuleNotFoundError', link: "./module-not-found" },
  ].map(item =>
    <Link href={item.link}>
