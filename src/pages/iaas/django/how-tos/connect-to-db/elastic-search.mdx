...
<Layout>
<Head>
<title>مستندات اتصال به دیتابیس‌ ElasticSearch در Django - لیارا</title>

<meta property="og:title" content="مستندات خدمات رایانش ابری لیارا" />
<meta property="og:description" content="مستندات مربوط به اتصال به دیتابیس ElasticSearch در پلتفرم Django در لیارا"  />
