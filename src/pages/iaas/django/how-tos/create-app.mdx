...
<Tabs 
    ...
    <>
        ...
        {/* <img src="https://files.liara.ir/liara/docs/create-django-app-using-console.gif" alt="create app using console" /> */}
        {/* <div className="h-4" /> */}
    </>,
    <>
    {/* <video
...
<img src="https://files.liara.ir/liara/docs/created-django-app.png" alt="a ready to use nodejs app"/>
<div className="h-2" />
