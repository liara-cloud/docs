...
<Layout>
<Head>
<title>مستندات تنظیم هدرهای امنیتی در Vue - لیارا</title>
<meta property="og:title" content="مستندات خدمات رایانش ابری لیارا" />
<meta property="og:description" content="مستندات مربوط به نحوه تنظیم هدرهای امنیتی در پلتفرم Vue یا VueJS در لیارا"  />
